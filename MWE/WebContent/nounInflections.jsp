...
import="lexicon.ShowNounInflections"
 %>
<%@ page 
...
dual =  s.getDual();
MasculineSingularConstruct =  s.getMasculineSingularConstruct();
MasculinePluralConstruct =  s.getMasculinePluralConstruct();
FeminineSingularConstruct =  s.getFeminineSingularConstruct();
FemininePluralConstruct =  s.getFemininePluralConstruct();
PGNMasculineSingular =  s.getPGNMasculineSingular();
PGNFeminineSingular =  s.getPGNFeminineSingular();
PGNMasculinePlural =  s.getPGNMasculinePlural();
PGNFemininePlural =  s.getPGNFemininePlural();
...
<%} if (!dual.equals("")){ %>
<table align="center" cellpadding="2" cellspacing="2" border="1" width="80%" >
<tr><th bgcolor="#E0E0E0">זוגי  -  נפרד/נסמך</th>
<tr><td align="center" bgcolor="#FFFFCC"><%=dual  %></td>
</tr>
</table>
