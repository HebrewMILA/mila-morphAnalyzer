...
<div id="Section">
	...
	<center>
		<h3> פלט המנתח המורפולוגי לביטויים בעברית - תצוגה מקוצרת</h3> 
	...
	<tr>
		<td align="center" >
				...
				<xsl:for-each select="sentence">
					...
					<xsl:if test="($pId=$inputpId and  $sId=$inputsId)">
						...
						<xsl:for-each select="token">
							...
							<xsl:variable name="url"><xsl:value-of select="@surface"/></xsl:variable>
						...
						<xsl:variable name="pmax"><xsl:value-of select="count(//corpus/article/paragraph)"/></xsl:variable>
						<xsl:variable name="smax"><xsl:value-of select="count(//corpus/article/paragraph[@id=$pId]/sentence)"/></xsl:variable>
						<p>
							<input type="button" onClick="location='http://yeda.cs.technion.ac.il:8088/MWE/index.html'"  value="התחל"></input>
							<xsl:text >            </xsl:text>
							<input type="button" onClick="location='limitedPrevNextSentence.jsp?action=prev|{$pId}|{$sId}|{$pmax}|{$smax}'"  value="הקודם"></input>
							<xsl:text >            </xsl:text>
							<input type="button" onClick="location='limitedPrevNextSentence.jsp?action=next|{$pId}|{$sId}|{$pmax}|{$smax}'"  value="הבא"></input>
							<xsl:text >            </xsl:text>
							<input type="button" onClick="location='showAll.jsp'"  value="הכל"></input>
							<xsl:text >            </xsl:text>
							<input type="button" onClick="location='http://yeda.cs.technion.ac.il:8088/MWE/showSentenceDetailed.jsp?pid={$pId}|{$sId}'"  value="מפורט"></input>
						</p>
					</xsl:if>
				</xsl:for-each>
			</xsl:for-each>
			...
			<xsl:for-each select="corpus/article/paragraph">
				<xsl:variable name="pId"><xsl:value-of select="@id"/></xsl:variable>
				<xsl:for-each select="sentence">
					<xsl:variable name="sId"><xsl:value-of select="@id"/></xsl:variable>
					<xsl:if test="$pId=$inputpId  and $sId=$inputsId">
						<p>
							<xsl:for-each select="token">
								<xsl:variable name="tId"><xsl:value-of select="@id"/></xsl:variable>
								...
								<xsl:choose>
									...
									<xsl:otherwise>
										<font size="5%"> <B><a name="#{$tId}"><xsl:value-of select="@surface"/></a></B></font>
										<xsl:text >            </xsl:text>
												...
												<tr>
														...
														<xsl:when test="prefix">
															...
															<xsl:choose>
																<xsl:when test="base/MWE">
																	<xsl:choose>
																		<xsl:when test="base/MWE/@type='person'">
																			<td  align="right" BGCOLOR="#ADFF2F"><b>
																				<xsl:for-each select="prefix">
																					<xsl:value-of select="concat(@surface,'')"/>
																					<xsl:element name="BR"/>
																				</xsl:for-each></b>
																			</td>
																			<td align="right" BGCOLOR="#ADFF2F">
																				<xsl:value-of select="base/@lexiconItem"/> 
																				<xsl:element name="BR"/>(<xsl:value-of select="base/MWE/@multiWord"/>)
																			</td>
																		</xsl:when>
																		<xsl:otherwise>
																			<td  align="right" BGCOLOR="#ADFF2F"><b>
																				<xsl:for-each select="prefix">
																					<xsl:value-of select="concat(@surface,'')"/>
																					<xsl:element name="BR"/>
																				</xsl:for-each></b></td><td align="right" BGCOLOR="#ADFF2F">
																				<xsl:value-of select="base/@lexiconItem"/> 
																				<xsl:element name="BR"/>
																			</td>
																		</xsl:otherwise>
																...
																<xsl:when test="base/preposition/@expansion and  base/@lexiconItem">
																	<td  align="right" BGCOLOR="#FFCCFF"><b>
																		<xsl:for-each select="prefix">
																			<xsl:value-of select="concat(@surface,'')"/>
																			<xsl:element name="BR"/>
																		</xsl:for-each></b>
																	...
																	<td align="right" BGCOLOR="#FFFFCC">
																		<xsl:value-of select="base/@lexiconItem"/> 
																		<xsl:element name="BR"/>(<xsl:value-of select="base/preposition/@expansion"/>)
																	</td>
																</xsl:when>
																<xsl:when test="base/title/@expansion and  base/@lexiconItem">
																	...
																	<td align="right" BGCOLOR="#FFFFCC">
																		<xsl:value-of select="base/@lexiconItem"/> 
																		<xsl:element name="BR"/>(<xsl:value-of select="base/title/@expansion"/>)
																	</td>
																</xsl:when>
																<xsl:when test="base/adverb/@expansion and  base/@lexiconItem">
																	...
																	<td align="right" BGCOLOR="#FFFFCC">
																		<xsl:value-of select="base/@lexiconItem"/> 
																		<xsl:element name="BR"/>(<xsl:value-of select="base/adverb/@expansion"/>)
																	</td>
																</xsl:when>
																<xsl:when test="base/adjective/@expansion and  base/@lexiconItem">
																	...
																	<td align="right" BGCOLOR="#FFFFCC">
																		<xsl:value-of select="base/@lexiconItem"/> 
																		<xsl:element name="BR"/>(<xsl:value-of select="base/adjective/@expansion"/>)
																	</td>
																</xsl:when>
																<xsl:when test="base/noun/@expansion and  base/@lexiconItem">
																	...
																	<td align="right" BGCOLOR="#FFFFCC">
																		<xsl:value-of select="base/@lexiconItem"/> 
																		<xsl:element name="BR"/>(<xsl:value-of select="base/noun/@expansion"/>)
																	</td>
																</xsl:when>
																<xsl:when test="base/conjunction/@expansion and  base/@lexiconItem">
																	...
																	<td align="right" BGCOLOR="#FFFFCC">
																		<xsl:value-of select="base/@lexiconItem"/> 
																		<xsl:element name="BR"/>(<xsl:value-of select="base/conjunction/@expansion"/>)
																	</td>
																</xsl:when>
																<xsl:when test="base/@lexiconItem">
																	<td  align="center" BGCOLOR="#FFCCFF"><b>
																		<xsl:choose> 
																			<xsl:when test="prefix/@multiWord='true'">ביטוי 2
																				<xsl:element name="BR"/>
																				<xsl:element name="BR"/>
																			</xsl:when>
																			<xsl:otherwise>
													...
													<xsl:choose>
														<xsl:when test="base/@lexiconPointer!='0'">
															<xsl:variable name="lexiconPointer" select="base/@lexiconPointer"></xsl:variable>
															<xsl:choose>
														...
														<xsl:when test="not(base/numeral) and not(base/numberExpression) and (base/@lexiconPointer='0')">
															<td  align="center">לא		<xsl:element name="BR"/>בלקסיקון
															</td>
														</xsl:when>
														<xsl:when test=" base/MWE">
															<td  align="center">
													...
													<xsl:if test="base/MWE">
														<xsl:choose>
															<xsl:when test="base/@lexiconPointer"></xsl:when>		
														</xsl:choose>
														<td align="center" bgcolor="#ADFF2F">
															<b>
																ביטוי<xsl:element name="BR"/>
																<xsl:value-of select="base/MWE/@id"/>
																<xsl:element name="BR"/>
																<xsl:choose>
														...
														<xsl:choose>
															<xsl:when  test="base/noun/@status">
																<xsl:choose>
																	...
																	<xsl:when test="base/noun/@status='absolute'">
													...
													<xsl:if test="base/adjective">
														<td align="center"  bgcolor="#99CCFF">
															<b>שם<xsl:element name="BR"/> תואר</b>
														</td>
														<xsl:choose>
													...
													<xsl:if test="base/verb"> <!-- 954 -->
														...
														<xsl:choose>
															...
															<xsl:when test="contains(base/verb/@binyan,'Hitpa')">
																<td align="center" >הִתְפַּעֵל</td>
															</xsl:when>
															<xsl:when test="contains(base/verb/@binyan,'Hif')">
																<td align="center" ><i>הִפְעִיל</i></td>
															</xsl:when>
															<xsl:when test="contains(base/verb/@binyan,'Huf')">
																<td align="center" >הֻפְעַל</td>
															</xsl:when>
															<xsl:otherwise>
																<td align="center"><xsl:text >-</xsl:text></td>
															</xsl:otherwise>
													...
													<xsl:if test="base/numeral">
														<td align="center"  bgcolor="#99CC99">
															<b>שם<xsl:element name="BR"/> מספר</b>
														</td>
														<xsl:choose>
													...
													<xsl:if test="base/participle">
														<xsl:choose>
															<xsl:when test="base/participle/@mood">
																<td  BGCOLOR="#33CCCC" align="center"><b>בינוני<xsl:element name="BR"/> פעול</b>
																<xsl:element name="BR"/>
																<xsl:choose>
																<xsl:when test="base/participle/@type='noun'">
																(שם<xsl:element name="BR"/> עצם)
																</xsl:when>
																<xsl:when test="base/participle/@type='verb'">
																(פועל)
																</xsl:when>
																<xsl:when test="base/participle/@type='adjective'">
																(שם<xsl:element name="BR"/> תואר)
																</xsl:when>
																</xsl:choose>
																</td>
															...
															<xsl:otherwise>
																<td  BGCOLOR="#33CCCC" align="center"><b>בינוני </b>
																	<xsl:element name="BR"/>
																	<xsl:choose>
																	<xsl:when test="base/participle/@type='noun'">
																	(שם<xsl:element name="BR"/> עצם)
														...
														<xsl:choose>
															<xsl:when test="base/participle/@type='verb'">
																<xsl:if test="base/participle/@subcoordinating='true'">
																<td align="center" >ה' <xsl:element name="BR"/>השיעבוד</td>
																</xsl:if>
															</xsl:when>
															<xsl:otherwise>
																<xsl:choose>
													...
													<xsl:if test="base/pronoun">
														<td align="center" bgcolor="#FFFF66">
															<b >כינוי<xsl:element name="BR"/> גוף</b>
														</td>
														<xsl:choose>
													...
													<xsl:if test="base/adverb">
														<td align="center" bgcolor="#FFCC33">
															<b>תואר <xsl:element name="BR"/>הפועל</b>
														</td>
														<td align="center"><xsl:text >-</xsl:text></td>
														<td align="center"><xsl:text >-</xsl:text></td>
														<td align="center"><xsl:text >-</xsl:text></td>
													...
													<xsl:if test="base/numberExpression">
														<td align="center"  bgcolor="#996600">
															<b>ביטוי<xsl:element name="BR"/> מספרי</b>
														</td>
														<td align="center"><xsl:text >-</xsl:text></td>
														<td align="center"><xsl:text >-</xsl:text></td>
														<td align="center"><xsl:text >-</xsl:text></td>
													...
													<xsl:if test="base/negation">
														<td align="center"  bgcolor="#00FFCC">
															<b>מילת <xsl:element name="BR"/>שלילה</b>
														</td>
														<xsl:choose>
														...
														<xsl:choose>
															...
															<xsl:when test="base/negation/@definiteness='false'">
																<td align="center" >לא  <xsl:element name="BR"/>מיודע</td>
															</xsl:when>
															<xsl:otherwise>
													...
													<xsl:if test="base/wPrefix">
														<td align="center" bgcolor="#CC33CC">
															<b>מילת<xsl:element name="BR"/>תחילית</b>
														</td>
														<td align="center"><xsl:text >-</xsl:text></td>
														<td align="center"><xsl:text >-</xsl:text></td>
														<td align="center"><xsl:text >-</xsl:text></td>
													...
													<xsl:if test="base/conjunction">
														<td align="center" bgcolor="#CC6699">
															<b>מילת<xsl:element name="BR"/> חיבור</b>
														</td>
														<td align="center"><xsl:text >-</xsl:text></td>
														<td align="center"><xsl:text >-</xsl:text></td>
														<td align="center"><xsl:text >-</xsl:text></td>
													...
													<xsl:if test="base/interjection">
														<td align="center" bgcolor="#CC6666">
															<b>מילת <xsl:element name="BR"/>קריאה</b>
														</td>
														<xsl:choose>
													...
													<xsl:if test="base/interrogative">
														<td align="center" bgcolor="#CC3366">
															<b>מילת<xsl:element name="BR"/> שאלה</b>
														</td>
														<td align="center"><xsl:text >-</xsl:text></td>
														<td align="center"><xsl:text >-</xsl:text></td>
														<td align="center"><xsl:text >-</xsl:text></td>
													...
													<xsl:if test="base/preposition">
														<td align="center" bgcolor="#C6DEFF">
															<b>מילת<xsl:element name="BR"/> יחס</b>
														</td>
														<td align="center"><xsl:text >-</xsl:text></td>
														<td align="center"><xsl:text >-</xsl:text></td>
														<td align="center"><xsl:text >-</xsl:text></td>
													...
													<xsl:if test="base/properName">
														<td align="center" bgcolor="#CCCCCC">
															<b>שם<xsl:element name="BR"/> פרטי</b>
														</td>
														<xsl:choose>
															...
															<td align="center" >זכר <xsl:element name="BR"/>וגם
															<xsl:element name="BR"/> נקבה</td>
															</xsl:when>
															<xsl:otherwise>
															<td align="center"><xsl:text >-</xsl:text></td>
															</xsl:otherwise>
													...
													<xsl:if test="base/existential">
														<td align="center" bgcolor="#EBDDE2">
															<b>כמת<xsl:element name="BR"/> יישי</b>
														</td>
														<xsl:choose>
														...
														<td align="center"><xsl:text >- </xsl:text></td>	
														 <xsl:choose>
															<xsl:when test="string-length (base/existential/@root)='3'">
															<td align="center">
															 <xsl:value-of select="substring(base/existential/@root,1,1)"/>
															 <xsl:value-of select="substring(base/existential/@root,2,1)"/>
															  <xsl:value-of select="substring(base/existential/@root,3,1)"/>
															</td>
															</xsl:when>
															<xsl:when test="string-length (base/existential/@root)='4'">
															<td align="center">
															 <xsl:value-of select="substring(base/existential/@root,1,1)"/>
															 <xsl:value-of select="substring(base/existential/@root,2,1)"/>
															 <xsl:value-of select="substring(base/existential/@root,3,1)"/>
															 <xsl:value-of select="substring(base/existential/@root,4,1)"/>
															</td>
															</xsl:when>
															<xsl:otherwise>
															<td align="center"><xsl:text >-</xsl:text></td>
						...
						<p>
							...
							<input type="button" onClick="location='showAll.jsp'"  value="הכל"></input>
							<xsl:text >            </xsl:text>
							<input type="button" onClick="location='http://yeda.cs.technion.ac.il:8088/MWE/showSentenceDetailed.jsp?pid=1|1'"  value="מפורט"></input>
						</p>
					</xsl:if>
				</xsl:for-each>
			</xsl:for-each>
