...
public class Data implements Constants {
	...
	public static lexicon.utils.Prefixes prefixes = null;;

	/** holds inflections data when uploaded to memory */
	public static lexicon.utils.Inflections inflections = null;

	/** holds mwinflections data when uploaded to memory */
	public static lexicon.utils.MWinflections mwinflections = null;

	/** holds mwe1 records data when uploaded to memory */
	public static lexicon.utils.MWE1records mwe1 = null;

	/** holds mwe1 records data when uploaded to memory */
	public static lexicon.utils.MWErecords mwe2 = null;

	/** holds mwe1 records data when uploaded to memory */
	public static lexicon.utils.MWErecords mwe3 = null;

	/** holds mwe1 records data when uploaded to memory */
	public static lexicon.utils.MWErecords mwe4 = null;

	/** holds gimatria data when uploaded to memory */
	public static lexicon.utils.Gimatria gimatrias = null;
