...
public final class Constants {
	...
	public static enum ENUM_BINYAN {
	...
	public static enum ENUM_HATTRIBUTE {
	...
	public static enum ENUM_HMMPOS {
	...
	public static enum ENUM_PARTICIPLE_TYPE {
		NOUN, ADJECTIVE, VERB, UNSPECIFIED
	}

	public static enum ENUM_POS {
	...
	public static enum ENUM_PREFIX_FUNCTION {
		DEFINITEARTICLE
	}

	public static enum ENUM_PROPERNAME_TYPE {
		LOCATION, PERSON, ORGANIZATION, DATETIME, OTHER, PRODUCT, COUNTRY, SYMBOL, LANGUAGE, TOWN, ART, UNSPECIFIED
	}

	public static enum ENUM_REGISTER {
		FORMAL, ARCHAIC, INFORMAL, UNSPECIFIED
	}

	public static enum ENUM_SPELLING {
		STANDARD, IRREGULAR, UNSPECIFIED
	}

	public static enum ENUM_STATUS {
		CONSTRUCT_TRUE, CONSTRUCT_FALSE, UNSPECIFIED
	}

	public static enum ENUM_SUFFIX_FUNCTION {
	...
	public final static int PREFIX_ARRAY_SIZE = 112;

	public final static String TRUE = "true";
	public final static String FALSE = "false";
	public final static String PRONOMIAL = "pronomial";
	public final static String ACCUSATIVE_OR_NOMINATIVE = "accusative or nominative";
	public final static String POSSESSIVE = "possessive";
	public final static String UNSPECIFED = "unspecified";
	public final static String DEFINITE_ARTICLE = "definiteArticle";
	public final static String NOUN = "noun";

	public final static int PARTICIPLE_TYPE_ADJECTIVE = 2;
	public final static int PARTICIPLE_TYPE_NOUN = 1;
	public final static int PARTICIPLE_TYPE_VERB = 3;

	public static final int QUANTIFIER_TYPE_AMOUNT = 1;
	public static final int QUANTIFIER_TYPE_PARTITIVE = 2;
	public static final int QUANTIFIER_TYPE_DETERMINER = 3;

	public static final int INTERROGATIVE_TYPE_PRONOUN = 1;

	public final static String JAXB_PACKAGE = "mila.generated";

	public final static String ALEFBAIT = "[אבגדהוזחטיכלמנסעפצקרשת]";

	// //////////////////////////////////////////////////////////////////////////////

	public static final String[] prefixArray = { "b", "bk", "e", "eb", "ebk", "eh", "ek", "eke", "ekeb", "ekeh", "ekek",
			"ekel", "ekem", "el", "elk", "elke", "elkeb", "elkeh", "elkek", "elkel", "elkem", "em", "eme", "emeb",
			"emeh", "emek", "emel", "emem", "emk", "k", "ke", "keb", "keh", "kek", "kel", "kem", "l", "lk", "lke",
			"lkeb", "lkeh", "lkek", "lkel", "lkem", "m", "me", "meb", "meh", "mek", "mel", "mem", "mh", "mk", "mlk",
			"w", "wh", "wb", "wbk", "we", "web", "webk", "weh", "wek", "wek", "weke", "wekeb", "wekeh", "wekek",
			"wekel", "wekem", "wel", "welk", "welke", "welkeb", "welkeh", "welkek", "welkel", "welkem", "wem", "weme",
			"wemeb", "wemeh", "wemek", "wemel", "wemem", "wemk", "wk", "wke", "wkeb", "wkeh", "wkek", "wkel", "wkem",
			"wl", "wlk", "wlke", "wlkeb", "wlkeh", "wlkek", "wlkel", "wlkem", "wm", "wme", "wmeb", "wmeh", "wmek",
