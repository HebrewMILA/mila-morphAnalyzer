...
public class Str2Num implements Constants {
	...
	if (baseConjunctionType.equals("coordinating")) {
	    ...
	    throw new Exception(
		    "Str2Num:encodeBaseConjunctionType illegal value for baseConjunctionType ="
			    + baseConjunctionType);
	...
	if (PGN.equals("1p/MF/Sg"))
	    ...
	    throw new Exception("Str2Num:encodePGN illegal value for binyan ="
		    + PGN);
     ...
     * @throws Exception
     */
    public static ENUM_PROPERNAME_TYPE str2NumBaseNamedEntityType(
	    final String baseNamedEntityType, final String lexiconItem,
	...
	if (baseNamedEntityType != null && baseNamedEntityType.length() > 0) {
	    ...
	    default:
		throw new Exception(
			"Str2Num:str2NumBaseNamedEntityType illegal value "
				+ "for baseNamedEntityType ="
				+ baseNamedEntityType + " for lexiconItem: "
     ...
     * @throws Exception
     */
    public static ENUM_BINYAN str2NumBinyan(final String binyan,
	...
	if (binyan != null && binyan.length() > 0) {
		...
		if (binyan.charAt(1) == 'u')
		    ...
		    throw new Exception(
			    "Str2Num:str2NumBinyan illegal value for binyan ="
				    + binyan + " for lexiconItem: "
				    + lexiconItem + " for input token: " + word);
		}
		break;
	    case 'N':
		...
		throw new Exception(
			"Str2Num:str2NumBinyan illegal value for binyan ="
				+ binyan + " for lexiconItem: " + lexiconItem
     ...
     * @throws Exception
     */
    public static ENUM_STATUS str2NumConstruct(final String construct,
	    final String lexiconItem, final String word) throws Exception {
	...
	if (construct == null || construct.length() == 0)
	    ...
	    default:
		throw new Exception(
			"Str2Num:str2NumConstruct illegal value for construct ="
				+ construct + " for lexiconItem: "
				+ lexiconItem + " for input token: " + word);
     ...
     * @throws Exception
     */
    public static ENUM_GENDER str2NumGender(final String gender,
	    final String lexiconItem, final String word) throws Exception {
	...
	if (gender != null && gender.length() > 0) {
	    ...
	    default:
		throw new Exception(
			"Str2Num:str2NumGender illegal value for gender ="
				+ gender + " for lexiconItem: " + lexiconItem
				+ " for input token: " + word);
	    }
	}
	return genderi;
     ...
     * @throws Exception
     */
    public static ENUM_HATTRIBUTE str2NumHAttribute(final String hAttribute,
	    final String lexiconItem, final String word) throws Exception {
	...
	if (hAttribute != null && hAttribute.length() > 0) {
	    ...
	    default:
		throw new Exception(
			"Str2Num:str2NumHAttribute illegal value for hAttribute ="
				+ hAttribute + " for lexiconItem: "
				+ lexiconItem + " for input token: " + word);
	    }
	}
	return hAttributei;
     ...
     * @throws Exception
     */
    public static ENUM_HMMPOS str2numHMMPOS(final String hmmPos,
	...
	if (hmmPos != null && hmmPosLen > 0) {
	    ...
	    case 'p':
		hmmPosLen = hmmPos.length();
		if (hmmPosLen >= 4 && hmmPos.charAt(2) == 'e'
			&& hmmPos.charAt(3) == 'p')
     ...
     * @throws Exception
     */
    public static ENUM_NUMERAL_TYPE str2NumNumaralType(final String type,
	    final String lexiconItem, final String word) throws Exception {
	...
	if (type != null && type.length() > 0) {
		...
		default:
		    throw new Exception(
			    "Str2Num:str2NumNumaralType illegal value "
				    + "for type=" + type + " for lexiconItem: "
				    + lexiconItem + " for input token: " + word);
		}
	    }
     ...
     * @throws Exception
     */
    public static ENUM_NUMBER str2NumNumber(final String number,
	    final String lexiconItem, final String word) throws Exception {
	...
	if (number != null && number.length() > 0) {
	    ...
	    default:
		throw new Exception(
			"Str2Num:str2NumNumber illegal value for number ="
				+ number + " for lexiconItem: " + lexiconItem
				+ " for input token: " + word);
	    }
	}
	return numberi;
     ...
     * @throws Exception
     */
    public static ENUM_NUMBER_EXPRESSION str2NumNumberExpression(
	...
	if (type != null && type.length() > 0) {
	    ...
	    default:
		throw new Exception(
			"Str2Num:str2NumNumberExpression illegal value for type ="
				+ type);
     ...
     * @throws Exception
     */
    public static ENUM_OUTPUT_PATTERN str2NumOutputPattern(
	    final String outputPattern, final String lexiconItem,
	    final String word) throws Exception {
	...
	if (outputPattern != null && outputPattern.length() > 0) {
		...
		if (outputPattern.charAt(2) == 'v')
		    ...
		    throw new Exception(
			    "Str2Num:str2NumOutputPattern illegal value for outputPattern ="
				    + outputPattern + " for lexiconItem: "
				    + lexiconItem + " for input token: " + word);
		...
		break;
	    case 'p':
		if (outputPattern.charAt(2) == 'e'
			&& outputPattern.charAt(3) == 'p')
     ...
     * @throws Exception
     */
    public static ENUM_POS str2NumPos(final String pos_in,
	    final String lexiconItem, final String word) throws Exception {
	ENUM_POS posi = null;
	if (pos_in != null && pos_in.length() > 0) {
		...
		if (Character.toLowerCase(pos.charAt(2)) == 'v')
		    ...
		    throw new Exception(
			    "Str2Num:str2NumPos illegal value for pos =" + pos
				    + " for lexiconItem: " + lexiconItem
				    + " for input token: " + word);
		}
		break;
     ...
     * @throws Exception
     */
    public static ENUM_REGISTER str2NumRegister(final String register,
	    final String lexiconItem, final String word) throws Exception {
	...
	if (register != null && register.length() > 0) {
	    ...
	    default:
		throw new Exception(
			"Str2Num:str2NumRegister illegal value for register ="
				+ register + " for lexiconItem: " + lexiconItem
				+ " for input token: " + word);
	    }
	}
	return registeri;
     ...
     * @throws Exception
     */
    public static ENUM_SPELLING str2NumSpelling(final String spelling,
	    final String lexiconItem, final String word) throws Exception {
	...
	if (spelling != null && spelling.length() > 0) {
	    ...
	    default:
		throw new Exception(
			"Str2Num:str2NumSpelling illegal value for spelling ="
				+ spelling + " for lexiconItem: " + lexiconItem
				+ " for input token: " + word);
	    }
	}
	return spellingi;
     ...
     * @throws Exception
     */
    public static int str2NumStrInterrogativeType(final String type,
	    final String lexiconItem, final String word) throws Exception {
     ...
     * @throws Exception
     */
    public static int str2NumStrParticipleType(final String type,
	    final String lexiconItem, final String word) throws Exception {
	...
	if (type != null && type.length() > 0) {
	    ...
	    default:
		throw new Exception(
			"Str2Num:str2NumStrParticipleType illegal value "
				+ "for type=" + type + " for lexiconItem: "
				+ lexiconItem + " for input token: " + word);
	    }
	}
     ...
     * @throws Exception
     */
    public static int str2NumStrQuantifierType(final String type,
	    final String lexiconItem, final String word) throws Exception {
	...
	if (type != null && type.length() > 0) {
	    ...
	    default:
		throw new Exception(
			"Str2Num:str2NumStrQuantifierType illegal value "
				+ "for type=" + type + " for lexiconItem: "
				+ lexiconItem + " for input token: " + word);
	    }
	}
     ...
     * @throws Exception
     */
    public static ENUM_SUFFIX_FUNCTION str2NumSuffixFunction(
	    final String suffixFunction, final String lexiconItem,
	    final String word) throws Exception {
	...
	if (suffixFunction != null && suffixFunction.length() > 0) {
	    ...
	    default:
		throw new Exception(
			"Str2Num:str2NumSuffixFunction illegal value "
				+ "for suffixFunction =" + suffixFunction
				+ " for lexiconItem: " + lexiconItem
				+ " for input token: " + word);
	    }
	}
     ...
     * @throws Exception
     */
    public static ENUM_TENSE str2NumTense(final String tense,
	    final String lexiconItem, final String word) throws Exception {
	...
	if (tense != null && tense.length() > 0) {
		...
		default:
		    throw new Exception(
			    "Str2Num:str2NumTense illegal value for tense ="
				    + tense + " for lexiconItem: "
				    + lexiconItem + " for input token: " + word);
		}
	    }
	}
