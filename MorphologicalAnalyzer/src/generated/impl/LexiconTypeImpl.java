...
public class LexiconTypeImpl implements generated.LexiconType,
					...
					if (("dotted" == ___local) && ("" == ___uri)) {
						_getItem().add(
								spawnChildFromEnterAttribute(
										(generated.impl.ItemTypeImpl.class), 5,
			...
			outer: while (true) {
				...
				case 1:
					if (("name" == ___local) && ("" == ___uri)) {
						_Metadata = ((generated.impl.MetadataTypeImpl) spawnChildFromEnterElement(
								(generated.impl.MetadataTypeImpl.class), 2,
	...
	public generated.impl.runtime.UnmarshallingEventHandler createUnmarshaller(
			generated.impl.runtime.UnmarshallingContext context) {
		return new generated.impl.LexiconTypeImpl.Unmarshaller(context);
	}
	...
	@Override
	public generated.MetadataType getMetadata() {
		return _Metadata;
	}
	...
	@Override
	public void setMetadata(generated.MetadataType value) {
		_Metadata = value;
	}
