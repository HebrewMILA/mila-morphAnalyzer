...
public class SenseTypeImpl implements generated.SenseType,
	...
	public class Unmarshaller extends
			...
			outer: while (true) {
					...
					if (("id" == ___local) && ("" == ___uri)) {
						_getEnglish().add(
								spawnChildFromEnterAttribute(
										(generated.impl.EnglishTypeImpl.class),
				...
				case 13:
					if (("id" == ___local) && ("" == ___uri)) {
						_getSynset().add(
								spawnChildFromEnterAttribute(
										(generated.impl.SynsetTypeImpl.class),
				...
				case 16:
					if (("id" == ___local) && ("" == ___uri)) {
						_getExample().add(
								spawnChildFromEnterAttribute(
										(generated.impl.ExampleTypeImpl.class),
		...
		public java.lang.Object owner() {
			return generated.impl.SenseTypeImpl.this;
		}
	...
	private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
		return (generated.SenseType.class);
	}
	...
	public generated.impl.runtime.UnmarshallingEventHandler createUnmarshaller(
			generated.impl.runtime.UnmarshallingContext context) {
		return new generated.impl.SenseTypeImpl.Unmarshaller(context);
	}
