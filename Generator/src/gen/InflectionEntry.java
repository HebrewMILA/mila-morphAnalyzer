...
public class InflectionEntry {
	...
	// ------------------------------------------------------------------------------
	public InflectionEntry(Inflections inflection) { // basicly inflectionEntry
		// is the same as
		// inflection but the
		// inflectionEntry is for
		// the table editInflecion
		// insted of table
		// inflection
		// the table purpose is to
		// provide a way of
		// altering individual
		// inflections - either
	...
	// ------------------------------------------------------------------------------
	public InflectionEntry(String _baseLexiconPointer, String _transliterated, String _baseNumber, String _baseGender,
			String _basePerson, String _PGN, String _suffixFunction, String _suffixStatus, String _binyan, String _tense,
			String _baseDefinitness, String _register, String _spelling, String _polarity, String _prefix, String _type,
	...
	public boolean CheckIfInflectionRemoved() {
		...
		try {
			...
			// DriverManager.getConnection(lexiconPURL,"lexiconUser", "!adgj?");
	...
	public String GetEntryMatchString() {
		String result = " baseLexiconPointer='" + baseLexiconPointer + "' and " + "transliterated='" + transliterated
				+ "' and " + "baseNumber='" + baseNumber + "' and " + "baseGender='" + baseGender + "' and "
				+ "basePerson='" + basePerson + "' and " + "PGN='" + PGN + "' and " + "suffixFunction='" + suffixFunction
				+ "' and " + "suffixStatus='" + suffixStatus + "' and " + "binyan='" + binyan + "' and " + "tense='" + tense
				+ "' and " + "baseDefinitness='" + baseDefinitness + "' and " + "register='" + register + "' and "
				+ "spelling='" + spelling + "' and " + "polarity='" + polarity + "' and " + "prefix='" + prefix + "' and "
				+ "type='" + type + "' and " + "surface='" + surface + "' and " + "basePos='" + basePos + "' and "
				+ "baseTransliteratedLItem='" + baseTransliteratedLItem + "' and " + "baseUndottedLItem='"
				+ baseUndottedLItem + "' and " + "root='" + root + "' and " + "dottedLexiconItem='" + dottedLexiconItem
				+ "' and " + "value='" + value + "' and " + "hebForeign='" + hebForeign + "' ";
	...
	public String GetInsertQueryDetails() {
		String result = "(baseLexiconPointer, transliterated, baseNumber, baseGender, basePerson, PGN, suffixFunction, suffixStatus,"
				...
				+ " VALUES('" + baseLexiconPointer + "','" + transliterated + "','" + baseNumber + "','" + baseGender
				+ "','" + basePerson + "','" + PGN + "'," + "'" + suffixFunction + "','" + suffixStatus + "','" + binyan
				+ "','" + tense + "','" + baseDefinitness + "','" + register + "'," + "'" + spelling + "','" + polarity
				+ "','" + prefix + "','" + type + "','" + surface + "','" + basePos + "','" + baseTransliteratedLItem
				+ "','" + baseUndottedLItem + "'," + "'" + root + "','" + dottedLexiconItem + "','" + value + "','"
				+ hebForeign + "','remove')";
	...
	public String GetFormButton(String url, String action) {// http://yeda.cs.technion.ac.il:8088/generatorViewer/testGeneration.jsp?lexiconId="+lexiconId+
		String result = "<form name='myform' action='" + url + "' method='POST'>"
				...
				+ "<input type='hidden' name='binyan' value='" + binyan + "'>" + "<input type='hidden' name='tense' value='"
				+ tense + "'>" + "<input type='hidden' name='baseDefinitness' value='" + baseDefinitness + "'>"
				+ "<input type='hidden' name='register' value='" + register + "'>"
				+ "<input type='hidden' name='spelling' value='" + spelling + "'>"
				+ "<input type='hidden' name='polarity' value='" + polarity + "'>"
				+ "<input type='hidden' name='prefix' value='" + prefix + "'>" + "<input type='hidden' name='type' value='"
				+ type + "'>" + "<input type='hidden' name='id' value='" + id + "'>"
				...
				+ "<input type='hidden' name='hebForeign' value='" + hebForeign + "'>" + "<input type='Submit' value='"
				+ action + "'>" + "</form>";
		return result;
	}
}
