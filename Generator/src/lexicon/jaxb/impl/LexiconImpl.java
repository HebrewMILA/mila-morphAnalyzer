...
public class LexiconImpl
    extends lexicon.jaxb.impl.LexiconTypeImpl
    implements lexicon.jaxb.Lexicon, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, lexicon.jaxb.impl.runtime.UnmarshallableObject, lexicon.jaxb.impl.runtime.XMLSerializable, lexicon.jaxb.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (lexicon.jaxb.Lexicon.class);
    }
    ...
    public lexicon.jaxb.impl.runtime.UnmarshallingEventHandler createUnmarshaller(lexicon.jaxb.impl.runtime.UnmarshallingContext context) {
        return new lexicon.jaxb.impl.LexiconImpl.Unmarshaller(context);
    }
...
+"namespaceURIq\u0000~\u0000!xq\u0000~\u0000\u001ct\u0000\u0019lexicon.jaxb.MetadataTypet\u0000+http:/"
...
+"gPair\u00d0t\u001ejB\u008f\u008d\u00a0\u0002\u0000\u0002L\u0000\tlocalNameq\u0000~\u0000!L\u0000\fnamespaceURIq\u0000~\u0000!xpq\u0000~\u00002"
+"q\u0000~\u00001sq\u0000~\u0000 t\u0000\u0004typet\u0000)http://www.w3.org/2001/XMLSchema-instan"
+"ceq\u0000~\u0000\u001fsq\u0000~\u0000 t\u0000\bmetadatat\u0000\u0000q\u0000~\u0000\u001fsq\u0000~\u0000\u000bppsq\u0000~\u0000\u0013q\u0000~\u0000\u000fpsq\u0000~\u0000\u0000q\u0000"
+"~\u0000\u000fp\u0000sq\u0000~\u0000\u0007ppsq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000\u000bppsq\u0000~\u0000\u0013q\u0000~\u0000\u000fpsq\u0000~\u0000\u0016q\u0000~\u0000\u000fpq\u0000~\u0000\u0019q"
+"\u0000~\u0000\u001dq\u0000~\u0000\u001fsq\u0000~\u0000 t\u0000\u0015lexicon.jaxb.ItemTypeq\u0000~\u0000$sq\u0000~\u0000\u000bppsq\u0000~\u0000\u0016q\u0000"
+"~\u0000\u000fpq\u0000~\u0000*q\u0000~\u0000:q\u0000~\u0000\u001fsq\u0000~\u0000 t\u0000\u0004itemq\u0000~\u0000?q\u0000~\u0000\u001fsq\u0000~\u0000\u000bppsq\u0000~\u0000\u0016q\u0000~\u0000"
+"\u000fpq\u0000~\u0000*q\u0000~\u0000:q\u0000~\u0000\u001fsq\u0000~\u0000 t\u0000\u0007lexiconq\u0000~\u0000?sr\u0000\"com.sun.msv.gramma"
...
+"x"));
        ...
        extends lexicon.jaxb.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return lexicon.jaxb.impl.LexiconImpl.this;
        }
                ...
                switch (state) {
                    case  1 :
                        if (("metadata" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterElement((((lexicon.jaxb.impl.LexiconTypeImpl)lexicon.jaxb.impl.LexiconImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        spawnHandlerFromLeaveElement((((lexicon.jaxb.impl.LexiconTypeImpl)lexicon.jaxb.impl.LexiconImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        spawnHandlerFromEnterAttribute((((lexicon.jaxb.impl.LexiconTypeImpl)lexicon.jaxb.impl.LexiconImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        spawnHandlerFromLeaveAttribute((((lexicon.jaxb.impl.LexiconTypeImpl)lexicon.jaxb.impl.LexiconImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                try {
                    switch (state) {
                        case  1 :
                            spawnHandlerFromText((((lexicon.jaxb.impl.LexiconTypeImpl)lexicon.jaxb.impl.LexiconImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                        case  3 :
