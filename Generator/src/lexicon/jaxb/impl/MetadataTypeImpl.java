...
public class MetadataTypeImpl implements lexicon.jaxb.MetadataType, com.sun.xml.bind.JAXBObject, lexicon.jaxb.impl.runtime.UnmarshallableObject, lexicon.jaxb.impl.runtime.XMLSerializable, lexicon.jaxb.impl.runtime.ValidatableObject
{
        ...
        throws org.xml.sax.SAXException
    {
        ...
        context.endAttributes();
        try {
            context.text(javax.xml.bind.DatatypeConverter.printFloat(((float) _Version)), "Version");
        } catch (java.lang.Exception e) {
            lexicon.jaxb.impl.runtime.Util.handlePrintConversionException(this, e, context);
        }
        context.endElement();
        ...
        while (idx8 != len8) {
            ...
            int idx_12 = idx8;
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _Source.get(idx_12 ++)), "Source");
            context.endNamespaceDecls();
            int idx_13 = idx8;
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _Source.get(idx_13 ++)), "Source");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _Source.get(idx8 ++)), "Source");
            context.endElement();
        }
        ...
        context.childAsURIs(((com.sun.xml.bind.JAXBObject) _Transliteration), "Transliteration");
        context.endNamespaceDecls();
        context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _Transliteration), "Transliteration");
        context.endAttributes();
        context.childAsBody(((com.sun.xml.bind.JAXBObject) _Transliteration), "Transliteration");
        context.endElement();
        if (_Comment!= null) {
...
+"ionPool;xp\u0000\u0000\u0000#\u0001pq\u0000~\u0000\u000bq\u0000~\u0000iq\u0000~\u0000\u0086q\u0000~\u0000\u0007q\u0000~\u0000\nq\u0000~\u0000hq\u0000~\u0000\u0085q\u0000~\u0000\u0005q\u0000~\u0000"
+"\rq\u0000~\u0000\u0006q\u0000~\u0000?q\u0000~\u0000\bq\u0000~\u0000\u0012q\u0000~\u0000Kq\u0000~\u0000Qq\u0000~\u0000Wq\u0000~\u0000]q\u0000~\u0000wq\u0000~\u0000\u0090q\u0000~\u0000\u008eq\u0000~\u0000"
+")q\u0000~\u0000Fq\u0000~\u0000Lq\u0000~\u0000Rq\u0000~\u0000Xq\u0000~\u0000^q\u0000~\u0000\tq\u0000~\u0000rq\u0000~\u0000fq\u0000~\u0000dq\u0000~\u0000~q\u0000~\u0000\u008aq\u0000~\u0000"
+"\u0083q\u0000~\u0000\u0091q\u0000~\u0000\fx"));
        }
        ...
        extends lexicon.jaxb.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    ...
                    case  19 :
                        if (("name" == ___local)&&("" == ___uri)) {
                            _getSource().add(((lexicon.jaxb.impl.SourceTypeImpl) spawnChildFromEnterAttribute((lexicon.jaxb.impl.SourceTypeImpl.class), 20, ___uri, ___local, ___qname)));
                            return ;
                        }
                        break;
                    case  25 :
                        if (("from" == ___local)&&("" == ___uri)) {
                            _Transliteration = ((lexicon.jaxb.impl.TransliterationTypeImpl) spawnChildFromEnterAttribute((lexicon.jaxb.impl.TransliterationTypeImpl.class), 26, ___uri, ___local, ___qname));
                            return ;
                        }
                        break;
                }
        ...
        {
            try {
                _Revision = com.sun.xml.bind.WhiteSpaceProcessor.collapse(value);
            } catch (java.lang.Exception e) {
        ...
        {
            try {
                _Maintainer = com.sun.xml.bind.WhiteSpaceProcessor.collapse(value);
            } catch (java.lang.Exception e) {
                handleParseConversionException(e);
            }
        }
