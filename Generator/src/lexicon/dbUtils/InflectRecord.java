...
public class InflectRecord {
	...
	/**
	 * @param accusativeNominativeGender
	 *           The accusativeNominativeGender to set.
	 */
	...
	/**
	 * @param accusativeNominativeNumber
	 *           The accusativeNominativeNumber to set.
	 */
	...
	/**
	 * @param accusativeNominativePerson
	 *           The accusativeNominativePerson to set.
	 */
	...
	/**
	 * @param accusativeNominativePGN
	 *           The accusativeNominativePGN to set.
	 */
