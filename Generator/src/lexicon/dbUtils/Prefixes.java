...
public class Prefixes extends ConnectedGenerator {
	...
	private void preparePrefixesData() {
		...
		try {
			...
			description = "'[+conjunction]" + URLEncoder.encode("ו", "UTF-8")
					+ "[+relativizer/subordinatingConjunction]"
					+ URLEncoder.encode("ש", "UTF-8") + "[+temporalSubConj]"
					+ URLEncoder.encode("כש", "UTF-8") + "'";
			definiteArticleTag = false;
			defArtHE = false;
			relHE = false;
			...
			prefix = "'eb'";
			description = "'[+relativizer/subordinatingConjunction]"
					+ URLEncoder.encode("ש", "UTF-8") + "[+preposition]"
			...
			prefix = "'keb'";
			description = "'[+temporalSubConj]"
					+ URLEncoder.encode("כש", "UTF-8") + "[+preposition]"
					+ URLEncoder.encode("ב", "UTF-8") + "'";
			definiteArticleTag = false;
			defArtHE = false;
			relHE = false;
			...
			prefix = "'meb'";
			description = "'[+temporalSubConj]"
					+ URLEncoder.encode("מש", "UTF-8") + "[+preposition]"
					+ URLEncoder.encode("ב", "UTF-8") + "'";
			definiteArticleTag = false;
			defArtHE = false;
			relHE = false;
			...
			prefix = "'lkeb'";
			description = "'[+temporalSubConj]"
					+ URLEncoder.encode("לכש", "UTF-8") + "[+preposition]"
					+ URLEncoder.encode("ב", "UTF-8") + "'";
			definiteArticleTag = false;
			defArtHE = false;
			relHE = false;
			...
			description = "'[+relativizer/subordinatingConjunction]"
					+ URLEncoder.encode("ש", "UTF-8") + "[+temporalSubConj]"
					+ URLEncoder.encode("בכש", "UTF-8") + "[+preposition]"
					+ URLEncoder.encode("ל", "UTF-8") + "'";
			definiteArticleTag = false;
			defArtHE = false;
			relHE = false;
			...
			///////////////////////////////////////////////////////////////
			prefix = "'wemem'";
			description = "'[+conjunction]" + URLEncoder.encode("ב", "UTF-8")
					+ "[+relativizer/subordinatingConjunction]"
					+ URLEncoder.encode("ש", "UTF-8") + "[+temporalSubConj]"
					+ URLEncoder.encode("מש", "UTF-8") + "[+preposition]"
					+ URLEncoder.encode("מ", "UTF-8") + "'";
...
//					prepKAF, prepLAMED, prepMEM,prepositionTag,conjunctionTag);
			...
			prefix = "'eh'";
			description = "'[+relativizer/subordinatingConjunction]"
					+ URLEncoder.encode("ש", "UTF-8") + "[+definiteArticle]"
					+ URLEncoder.encode("ה", "UTF-8") + "'";
			definiteArticleTag = true;
			defArtHE = true;
			relHE = false;
...
//			///////////////////////////////////////////////////////////////
			prefix = "'keh'";
			description = "'[+temporalSubConj]"
					+ URLEncoder.encode("כש", "UTF-8") + "[+definiteArticle]"
					+ URLEncoder.encode("ה", "UTF-8") + "'";
			definiteArticleTag = true;
			defArtHE = true;
			relHE = false;
...
//			///////////////////////////////////////////////////////////////
			prefix = "'meh'";
			description = "'[+temporalSubConj]"
					+ URLEncoder.encode("מש", "UTF-8") + "[+definiteArticle]"
					+ URLEncoder.encode("ה", "UTF-8") + "'";
			definiteArticleTag = true;
			defArtHE = true;
			relHE = false;
...
//			///////////////////////////////////////////////////////////////
			prefix = "'lkeh'";
			description = "'[+temporalSubConj]"
					+ URLEncoder.encode("לכש", "UTF-8") + "[+definiteArticle]"
					+ URLEncoder.encode("ה", "UTF-8") + "'";
			definiteArticleTag = true;
			defArtHE = true;
			relHE = false;
...
//			///////////////////////////////////////////////////////////////
			...
			prefix = "'wk'";
			description = "'[+conjunction]" + URLEncoder.encode("ו", "UTF-8")
					+ "[+adverb]" + URLEncoder.encode("כ", "UTF-8") + "'";
			definiteArticleTag = false;
			defArtHE = false;
			relHE = false;
			/////////////////
			...
			prefix = "'ek'";
			description = "'[+relativizer/subordinatingConjunction]"
					+ URLEncoder.encode("ש", "UTF-8") + "[+adverb]"
					+ URLEncoder.encode("כ", "UTF-8") + "'";
			definiteArticleTag = false;
			defArtHE = false;
			relHE = false;
			...
			prefix = "'kek'";
			description = "'[+temporalSubConj]"
					+ URLEncoder.encode("כש", "UTF-8") + "[+adverb]"
					+ URLEncoder.encode("כ", "UTF-8") + "'";
			definiteArticleTag = false;
			defArtHE = false;
			relHE = false;
			...
			prefix = "'mek'";
			description = "'[+temporalSubConj]"
					+ URLEncoder.encode("מש", "UTF-8") + "[+adverb]"
					+ URLEncoder.encode("כ", "UTF-8") + "'";
			definiteArticleTag = false;
			defArtHE = false;
			relHE = false;
