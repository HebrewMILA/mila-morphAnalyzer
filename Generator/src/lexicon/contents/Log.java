...
public class Log extends EmptyContent {
	 ...
	 * Databse INSERT statements. The following formatting is supported: "YYYY-MM-DD
	 * HH:MM:SS. The method takes the date, adds 1 to the month digit (in the Date
	 * object, the months start from 0), render the date according to the SQL
	 * scheme, and returns it as a string.<br>
	 * Example: <br>
	 * <code>QUtil.formatDate(new java.util.Date());</code> Notice that this method
	 * is static.
	 * 
