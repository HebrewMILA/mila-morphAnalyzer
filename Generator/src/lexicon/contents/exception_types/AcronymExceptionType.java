 ...
 *         Window - Preferences - Java - Code Style - Code Templates
 */
public class AcronymExceptionType extends Content implements lexicon.jaxb.AcronymExceptionType {
	protected lexicon.jaxb.AcronymExceptionType content;

	public AcronymExceptionType(lexicon.jaxb.AcronymExceptionType content) {
		this.content = content;
		TABLE = "acronym_exception_type";
		IDNAME = "aid";
	}

	public AcronymExceptionType() {
		content = new lexicon.jaxb.impl.AcronymExceptionTypeImpl();
		TABLE = "acronym_exception_type";
		IDNAME = "aid";
	}

	public lexicon.jaxb.impl.AcronymExceptionTypeImpl getImpl() {
		return (lexicon.jaxb.impl.AcronymExceptionTypeImpl) content;
	}
