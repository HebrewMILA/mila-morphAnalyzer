...
//		System.out.println(sql);
	 ...
	 */
	public java.lang.String getPolarity() { return content.getPolarity(); }
	 ...
	 *     {@link java.lang.String}
	 */
	public void setPolarity(java.lang.String value) { content.setPolarity(value); }
	...
	protected int addActions(int id) {
		...
		for (int i=0; i< getAddOrReplaceOrRemove().size(); i++) {
			WprefixExceptionType exceptionType = new WprefixExceptionType((lexicon.jaxb.WprefixExceptionType)getAddOrReplaceOrRemove().get(i));
