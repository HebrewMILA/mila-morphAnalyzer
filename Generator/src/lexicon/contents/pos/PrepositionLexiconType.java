 ...
 * this java content object. (defined at file:/C:/hebrew_lexicon.xsd line 888)
 * <p>
 * 
 * <pre>
...
public class PrepositionLexiconType extends Content implements lexicon.jaxb.PrepositionLexiconType {
	...
	public int addActions(int id) {
		...
		for (int i = 0; i < getAddOrReplaceOrRemove().size(); i++) {
			PrepositionExceptionType exceptionType = new PrepositionExceptionType(
					(lexicon.jaxb.PrepositionExceptionType) getAddOrReplaceOrRemove().get(i));
