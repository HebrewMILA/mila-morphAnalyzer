 ...
 * <p>The following schema fragment specifies the expected content contained within this java content object. (defined at file:/C:/hebrew_lexicon.xsd line 888)
 * <p>
 * <pre>
 ...
 * 
 */
public class PrepositionLexiconType extends Content implements lexicon.jaxb.PrepositionLexiconType{
	lexicon.jaxb.PrepositionLexiconType content;
	
	public PrepositionLexiconType(lexicon.jaxb.PrepositionLexiconType content) {
		this.content = content;
		TABLE = "preposition";
		IDNAME = "id"; 
	}
	public PrepositionLexiconType() {
		content = new lexicon.jaxb.impl.PrepositionLexiconTypeImpl();
		TABLE = "preposition";
		IDNAME = "id"; 
	}
	public lexicon.jaxb.impl.PrepositionLexiconTypeImpl getImpl() {
		return (lexicon.jaxb.impl.PrepositionLexiconTypeImpl)content;
	}
	public int add() {
		return 0;
	}
	...
	*/
	...
	public int addActions(int id) {
		int result = 0;
		for (int i=0; i< getAddOrReplaceOrRemove().size(); i++) {
			PrepositionExceptionType exceptionType = new PrepositionExceptionType((lexicon.jaxb.PrepositionExceptionType)getAddOrReplaceOrRemove().get(i));
	...
	protected int removeActions(int id) {
		return removeContents("preposition_exception_type", "id", "aid", id); 
	}
	public int remove() {
		removeActions(id);
	...
	public void load() {
		...
		setCase(getString("case"));
		setInflectionBase(getString("inflectionBase")); 
	}
	public java.util.List getActions() {
		List actions = getContents("preposition_exception_type", "id", id);
     ...
     * 
     */
    public class Add extends PrepositionExceptionType implements lexicon.jaxb.PrepositionLexiconType.Add  {
    	public Add() {
    		super ();
    		content = new lexicon.jaxb.impl.PrepositionLexiconTypeImpl.AddImpl();
    	}
    	public Add(lexicon.jaxb.PrepositionExceptionType content) {
    		super (content);
    	}
    	public lexicon.jaxb.impl.PrepositionLexiconTypeImpl.AddImpl getActionImpl() {
    		return (lexicon.jaxb.impl.PrepositionLexiconTypeImpl.AddImpl)content;
    	}
    }
     ...
     * 
     */
    public class Remove extends PrepositionExceptionType implements lexicon.jaxb.PrepositionLexiconType.Remove  {
    	public Remove(lexicon.jaxb.PrepositionExceptionType content) {
    		super (content);
    	}
    	public Remove() {
    		super ();
    		content = new lexicon.jaxb.impl.PrepositionLexiconTypeImpl.RemoveImpl();
    	}
    	public lexicon.jaxb.impl.PrepositionLexiconTypeImpl.RemoveImpl getActionImpl() {
    		return (lexicon.jaxb.impl.PrepositionLexiconTypeImpl.RemoveImpl)content;
    	}
    }
     ...
     * 
     */
    public class Replace extends PrepositionExceptionType implements lexicon.jaxb.PrepositionLexiconType.Replace  {
    	public Replace(lexicon.jaxb.PrepositionExceptionType content) {
    		super (content);
    	}
    	public Replace() {
    		super ();
    		content = new lexicon.jaxb.impl.PrepositionLexiconTypeImpl.ReplaceImpl();
    	}
    	public lexicon.jaxb.impl.PrepositionLexiconTypeImpl.ReplaceImpl getActionImpl() {
    		return (lexicon.jaxb.impl.PrepositionLexiconTypeImpl.ReplaceImpl)content;
    	}
    }
