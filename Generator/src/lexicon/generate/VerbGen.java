...
public class VerbGen extends ItemGen {
	...
	private void setGenInflection() {
		...
		vgIP.setTable(inflectionsTable); // set table to either inflections or to tempInflection for the
													// multiwordverbPhrase
	...
	private void inflectPattern1() throws Exception {
		...
		vgIP.generateBeinoniPassive(
				(new StringBuffer().append(root.substring(0, 2)).append("w").append(root.substring(2, 3))).toString());
	}
	...
	private void inflectPattern2() throws Exception {
		...
		} else if (root.charAt(1) == 'a' || root.charAt(1) == 'h' || root.charAt(1) == 'x' || root.charAt(1) == 'y'
				|| root.charAt(2) == 'a' || root.charAt(2) == 'h' || root.charAt(2) == 'x' || root.charAt(2) == 'y'
				|| root.charAt(0) == 'a' || root.charAt(0) == 'h' || root.charAt(0) == 'x' || root.charAt(0) == 'y') {
			vgIP.generateBareInfinitive("", "w", 0, 2, 2, 3, "");
			vgIP.generateInfinitive("", "w", 0, 1, 1, 3, "");
			vgIP.generatePast("", "ti,t,t,-,h,nw,tm,tn,w", "", 0, 3, 3, 3);
			vgIP.generatePresent("", "-,t,im,wt", "w,w,w,w", 0, 1, 1, 3);
	...
	private void inflectPattern3() throws Exception {
		...
		if (root.charAt(1) == 'i') {
			vgIP.generatePast("", "ti,t,t,-,h,nw,tm,tn,w", "i,i,i,i,i,i,i,i,i", 0, 2, 2, len);
		} else
		...
		vgIP.generateBeinoniPassive(
				(new StringBuffer().append(root.substring(0, len - 1)).append("w").append(root.substring(len - 1, len)))
						.toString());
	}
	...
	private void inflectPattern11() throws Exception {
		...
		if (root.charAt(1) == 'w') {
			...
			vgIP.generateFuture("a,t,t,i,t,n,t,t,i,t", "h,h,i,h,h,h,ww,inh,ww,inh", "-,-,-,-,-,-,-,-,-,-", 0, len - 1, len,
					len);
			...
			vgIP.generatePast("", "ti,t,t,h,th,nw,tm,tn,w", "i,i,i,-,-,i,i,i,-", 0, len - 1, len, len);
			vgIP.generatePresent("", "h,h,im,wt", "w,w,w,w", 0, len - 2, len - 2, len - 1);
			vgIP.generateFuture("a,t,t,i,t,n,t,t,i,t", "h,h,i,h,h,h,w,inh,w,inh", "-,-,-,-,-,-,-,-,-,-", 0, len - 1, len,
					len);
	...
	private void inflectPattern23() throws Exception {
		...
		if (root.charAt(0) == 'i') {
			...
			if (len == 3) {
				...
				String totAppendedTemp = appendedTemp + appendedTemp + appendedTemp + appendedTemp + appendedTemp
			...
			if (root.charAt(len - 1) == 'n')
				vgIP.generateFuture("a,t,t,i,t,n,t,t,i,t", "-,-,i,-,-,-,w,h,w,h", "i,i,i,i,i,i,i,i,i,i", 0, index + 1,
						index + 1, len);
			else
				vgIP.generateFuture("a,t,t,i,t,n,t,t,i,t", "-,-,i,-,-,-,w,nh,w,nh", "i,i,i,i,i,i,i,i,i,i", 0, index + 1,
						index + 1, len);
	...
	private void inflectPattern25() throws Exception {
		...
		if (root.charAt(1) == 'w') {
			...
			String inside2 = inside1 + inside1 + inside1 + "i" + root.charAt(1) + "," + "i" + root.charAt(1) + ","
					+ inside1 + inside1 + inside1 + ",i" + root.charAt(1) + ",i" + root.charAt(1);
			...
			inside2 = inside1 + inside1 + inside1 + root.charAt(1) + "," + root.charAt(1) + "," + inside1 + inside1
					+ inside1 + "," + root.charAt(1) + "," + root.charAt(1);
			vgIP.generatePast("", "ti,t,t,h,th,nw,tm,tn,w", inside2, 0, 1, 3, 3);
	...
	private void inflectPattern31() throws Exception {
		...
		String suffix2 = "";
		if (root.charAt(2) == 't') {
			suffix2 = suffix1 + "i," + suffix1 + "," + suffix1 + "," + suffix1 + "," + suffix1 + "h," + suffix1 + "nw,"
					+ suffix1 + "m," + suffix1 + "n," + suffix1 + "w";
			vgIP.generatePast("", suffix2, "w,w,w,w,w,w,w,w,w", 0, 1, 2, 3);
		} else if (root.charAt(2) == 'n') {
			suffix2 = suffix1 + "ti," + suffix1 + "t," + suffix1 + "t," + suffix1 + "," + suffix1 + "h," + suffix1 + "w,"
					+ suffix1 + "tm," + suffix1 + "tn," + suffix1 + "w";
			vgIP.generatePast("", suffix2, "w,w,w,w,w,w,w,w,w", 0, 1, 2, 3);
		} else {
			suffix2 = suffix1 + "ti," + suffix1 + "t," + suffix1 + "t," + suffix1 + "," + suffix1 + "h," + suffix1 + "nw,"
					+ suffix1 + "tm," + suffix1 + "tn," + suffix1 + "w";
			vgIP.generatePast("", suffix2, "w,w,w,w,w,w,w,w,w", 0, 1, 2, 3);
		}
		// כפולים
	...
	private void inflectPattern36() throws Exception {
		...
		if ((root.charAt(len - 1) == 'h') || (root.charAt(len - 1) == 'i')) {
			...
			if (root.endsWith("wh")) {
				...
				vgIP.generateFuture("a,t,t,i,t,n,t,t,i,t", "h,h,i,h,h,h,-,inh,-,inh", "w,w,w,w,w,w,w,w,w,-", 0, 1, 1,
						len - 1);
			} else {
				...
				vgIP.generateFuture("a,t,t,i,t,n,t,t,i,t", "h,h,i,h,h,h,w,inh,w,inh", "w,w,w,w,w,w,w,w,w,w", 0, 1, 1,
						len - 1);
			}
			...
			vgIP.generateFuture("a,t,t,i,t,n,t,t,i,t", "-,-,i,-,-,-,w,h,w,h", "wi,wi,wi,wi,wi,wi,wi,wi,wi,wi", 0, 1, 1,
					len);
			...
			vgIP.generatePresent("m,m,m,m", "-,t,im,wt", "wi,wi,wi,wi", 0, 1, 1, len);
			vgIP.generateFuture("a,t,t,i,t,n,t,t,i,t", "-,-,i,-,-,-,w,nh,w,nh", "wi,wi,wi,wi,wi,wi,wi,wi,wi,wi", 0, 1, 1,
					len);
			vgIP.setSpelling(originalSpelling);
			vgIP.generatePast("", "ti,t,t,-,h,nw,tm,tn,w", "w,w,w,w,w,w,w,w,w", 0, 1, 1, len);
			vgIP.generatePresent("m,m,m,m", "-,t,im,wt", "w,w,w,w", 0, 1, 1, len);
	...
	private void inflectPattern38() throws Exception {
		...
		vgIP.generateFuture("a,t,t,i,t,n,t,t,i,t", "-,-,i,-,-,-,w,nh,w,nh", "wii,wii,wii,wii,wii,wii,wii,wii,wii,wii", 0,
				1, 2, 3);
	...
	private void inflectPattern39() throws Exception {
		...
		if (root.charAt(len - 1) == 't') {
			...
			if (root.charAt(len - 2) == 'i') {
				...
				vgIP.generateFuture("a,t,t,i,t,n,t,t,i,t", "in,in,ini,in,in,in,inw,inh,inw,inh", "w,w,w,w,w,w,w,w,w,w", 0,
						1, 1, len - 1);
			} else {
				vgIP.generatePast("", "ti,t,t,-,h,w,tm,tn,w", "w,w,w,w,w,w,w,w,w", 0, 1, 1, len);
				vgIP.generatePresent("m,m,m,m", "-,t,im,wt", "w,w,w,w", 0, 1, 1, len);
	...
	private void inflectPattern42() throws Exception {
		...
		if (root.equals("rqn")) {
			...
			vgIP.generateFuture("at,tt,tt,it,tt,nt,tt,tt,it,tt", "-,-,i,-,-,-,w,h,w,h", "w,w,w,w,w,w,w,w,w,w", 0, 0, 1,
					len);
		...
		// 400
			...
			vgIP.generatePast("hi,hi,hi,hi,hi,hi,hi,hi,hi", "ti,t,t,-,h,nw,tm,tn,w", "i,i,i,i,i,i,i,i,i", 0, 2, 2,
					len - 1);
		...
		// 27 ל'ת
			...
			vgIP.generateFuture("at,tt,tt,it,tt,nt,tt,tt,it,tt", "-,-,i,-,-,-,w,nh,w,nh", "w,w,w,w,w,w,w,w,w,w", 0, 2, 2,
					len);
	...
	private void inflectPattern43() throws Exception {
		...
		// "",1,3,3,3);
		vgIP.generatePast("htww,htww,htww,htww,htww,htww,htww,htww,htww", "ti,t,t,-,h,nw,tm,tn,w", "", 1, 3, 3, 3);
		...
		// );
		vgIP.generateFuture("atww,ttww,ttww,itww,ttww,ntww,ttww,ttww,itww,ttww", "-,-,i,-,-,-,w,nh,w,nh", "", 1, 3, 3, 3);
	...
	private void inflectPattern44() throws Exception {
		...
		if (root.charAt(0) == 'z' && root.charAt(2) == 'h') {
			vgIP.generateBareInfinitive("hzd", "", 1, len - 1, len - 1, len - 1, "wt");
			vgIP.generateInfinitive("hzd", "", 1, len - 1, len - 1, len - 1, "wt");
			vgIP.generatePast("hzd,hzd,hzd,hzd,hzd,hzd,hzd,hzd,hzd", "ti,t,t,h,th,nw,tm,tn,w", "i,i,i,-,-,i,i,i,-", 1,
					len - 1, len - 1, len - 1);
			vgIP.generatePresent("mzd,mzd,mzd,mzd", "h,it,im,wt", "", 1, len - 1, len - 1, len - 1);
			vgIP.generateFuture("azd,tzd,tzd,izd,tzd,nzd,tzd,tzd,izd,tzd", "h,h,i,h,h,h,w,inh,w,inh", "", 1, len - 1,
					len - 1, len - 1);
			vgIP.generateImperative("hzd", "h,i,w,inh", "-,-,-,-", 1, len - 1, len - 1, len - 1);
		} else if (root.charAt(0) == 'z') {
			vgIP.generateBareInfinitive("hzd", "", 1, len, len, len, "wt");
			vgIP.generateInfinitive("hzd", "", 1, len, len, len, "wt");
			vgIP.generatePast("hzd,hzd,hzd,hzd,hzd,hzd,hzd,hzd,hzd", "ti,t,t,h,th,nw,tm,tn,w", "", 1, len, len, len);
			vgIP.generatePresent("mzd,mzd,mzd,mzd", "h,it,im,wt", "", 1, len, len, len);
			vgIP.generateFuture("azd,tzd,tzd,izd,tzd,nzd,tzd,tzd,izd,tzd", "h,h,i,h,h,h,w,nh,w,nh", "", 1, len, len, len);
			vgIP.generateImperative("hzd", "h,i,w,nh", "-,-,-,-", 1, len, len, len);
		} else if (root.charAt(0) == 'e' && root.charAt(1) == 'w' && root.charAt(2) == 'h') {
			vgIP.generateBareInfinitive("het", "", 1, len - 1, len - 1, len - 1, "wt");
			vgIP.generateInfinitive("het", "", 2 - 1, len - 1, len - 1, len - 1, "wt");
			vgIP.generatePast("hetw,hetw,hetw,hetw,hetw,hetw,hetw,hetw,hetw", "iti,it,it,h,th,inw,itm,itn,-", "", 1,
					len - 1, len - 1, len - 1);
			vgIP.generatePresent("metw,metw,metw,metw", "h,it,im,t", "", 1, len - 1, len - 1, len - 1);
			vgIP.generateFuture("aetw,tetw,tetw,ietw,tetw,netw,tetw,tetw,ietw,tetw", "h,h,i,h,h,h,w,inh,-,inh", "", 1,
					len - 1, len - 1, len - 1);
			vgIP.generateImperative("hetw", "h,i,-,inh", "-,-,-,-", 1, len - 1, len - 1, len - 1);
		} else if (root.charAt(0) == 'e' && root.charAt(2) == 'h') {
			vgIP.generateBareInfinitive("het", "", 1, len - 1, len - 1, len - 1, "wt");
			vgIP.generateInfinitive("het", "", 2 - 1, len - 1, len - 1, len - 1, "wt");
			vgIP.generatePast("het,het,het,het,het,het,het,het,het", "iti,it,it,h,th,inw,itm,itn,w", "", 1, len - 1,
					len - 1, len - 1);
			vgIP.generatePresent("met,met,met,met", "h,it,im,wt", "", 1, len - 1, len - 1, len - 1);
			vgIP.generateFuture("aet,tet,tet,iet,tet,net,tet,tet,iet,tet", "h,h,i,h,h,h,w,inh,w,inh", "", 1, len - 1,
					len - 1, len - 1);
			vgIP.generateImperative("het", "h,i,w,inh", "-,-,-,-", 1, len - 1, len - 1, len - 1);
		} else if (root.charAt(0) == 'e') {
			vgIP.generateBareInfinitive("het", "", 2, len, len, len, "wt");
			vgIP.generateInfinitive("het", "", 2, len, len, len, "wt");
			vgIP.generatePast("het,het,het,het,het,het,het,het,het", "ti,t,t,h,th,nw,tm,tn,w", "", 2, len, len, len);
			vgIP.generatePresent("met,met,met,met", "h,it,im,wt", "", 2, len, len, len);
			vgIP.generateFuture("aet,tet,tet,iet,tet,net,tet,tet,iet,tet", "h,h,i,h,h,h,w,nh,w,nh", "", 2, len, len, len);
			vgIP.generateImperative("het", "h,i,w,nh", "-,-,-,-", 2, len, len, len);
		} else if (root.charAt(0) == 'c' && root.charAt(1) == 'w' && root.charAt(2) == 'h') {
			vgIP.generateBareInfinitive("hcvw", "", 0, 0, 0, 0, "wt");
			vgIP.generateInfinitive("hcvw", "", 0, 0, 0, 0, "wt");
			vgIP.generatePast("hcvwwi,hcvwwi,hcvwwi,hcvww,hcvww,hcvwwi,hcvwwi,hcvwwi,hcvw", "ti,t,t,h,th,nw,tm,tn,w", "",
					0, 0, 0, 0);
			vgIP.generatePresent("mcvww,mcvww,mcvww,mcvw", "h,it,im,wt", "", 0, 0, 0, 0);
			vgIP.generateFuture("acvww,tcvww,tcvww,icvww,tcvww,ncvww,tcvww,tcvww,icvww,tcvww", "h,h,i,h,h,h,-,nh,-,nh", "",
					0, 0, 0, 0);
			...
			vgIP.generatePast("hcv,hcv,hcv,hcv,hcv,hcv,hcv,hcv,hcv", "ti,t,t,h,th,nw,tm,tn,w", "", 2, len, len, len);
			vgIP.generatePresent("mcv,mcv,mcv,mcv", "h,it,im,wt", "", 2, len, len, len);
			vgIP.generateFuture("acv,tcv,tcv,icv,tcv,ncv,tcv,tcv,icv,tcv", "h,h,i,h,h,h,w,nh,w,nh", "", 2, len, len, len);
			vgIP.generateImperative("hcv", "h,i,w,nh", "-,-,-,-", 2, len, len, len);
		} else if (root.charAt(1) == 'w') {
			vgIP.generateBareInfinitive("ht", "", 0, 2, 3, 3, "wt");
			vgIP.generateInfinitive("ht", "", 0, 2, 3, 3, "wt");
			vgIP.generatePast("ht,ht,ht,ht,ht,ht,ht,ht,ht", "ti,t,t,h,th,nw,tm,tn,w", "wi,wi,wi,w,w,wi,wi,wi,-", 0, 2, 3,
					3);
			vgIP.generatePresent("mt,mt,mt,mt", "h,h,im,wt", "w,w,w,-", 0, 1, 1, 2);
			vgIP.generateFuture("at,tt,tt,it,tt,nt,tt,tt,it,tt", "wh,wh,wi,wh,wh,wh,w,winh,w,winh", "", 0, 2, 3, 3);
			...
			vgIP.generatePast("hti,hti,hti,hti,hti,hti,hti,hti,hti", "ti,t,t,h,th,nw,tm,tn,w", "i,i,i,-,-,i,i,i,-", 0, 2,
					3, 3);
			vgIP.generatePresent("mt,mt,mt,mt", "h,h,im,wt", "i,i,i,i", 0, 1, 1, 2);
			vgIP.generateFuture("ati,tti,tti,iti,tti,nti,tti,tti,iti,tti", "h,h,i,h,h,h,w,inh,w,inh", "", 0, 2, 3, 3);
			...
			vgIP.generateBareInfinitive("ht", "", 0, 2, 3, 3, "wt");
			vgIP.generateInfinitive("ht", "", 0, 2, 3, 3, "wt");
			vgIP.generatePast("ht,ht,ht,ht,ht,ht,ht,ht,ht", "ti,t,t,h,th,nw,tm,tn,w", "i,i,i,-,-,i,i,i,-", 0, 2, 3, 3);
			vgIP.generatePresent("mt,mt,mt,mt", "h,h,im,wt", "", 0, 1, 1, 2);
			vgIP.generateFuture("at,tt,tt,it,tt,nt,tt,tt,it,tt", "h,h,i,h,h,h,w,inh,w,inh", "", 0, 2, 3, 3);
	...
	private void inflectPattern45() throws Exception {
		...
		if (root.charAt(0) == 'e') {
			...
			vgIP.generatePast("hetw,hetw,hetw,hetw,hetw,hetw,hetw,hetw,hetw", "ti,t,t,-,h,nw,tm,tn,w", "", 0, 0, 1, 3);
			vgIP.generatePresent("metw,metw,metw,metw", "-,t,im,wt", "", 0, 0, 1, 3);
			vgIP.generateFuture("aetw,tetw,tetw,ietw,tetw,netw,tetw,tetw,ietw,tetw", "-,-,i,-,-,-,w,nh,w,nh", "", 0, 0, 1,
					3);
			...
			vgIP.generatePast("hcvw,hcvw,hcvw,hcvw,hcvw,hcvw,hcvw,hcvw,hcvw", "ti,t,t,-,h,nw,tm,tn,w", "", 0, 0, 1, 3);
			vgIP.generatePresent("mcvw,mcvw,mcvw,mcvw", "-,t,im,wt", "", 0, 0, 1, 3);
			vgIP.generateFuture("acvw,tcvw,tcvw,icvw,tcvw,ncvw,tcvw,tcvw,icvw,tcvw", "-,-,i,-,-,-,w,nh,w,nh", "", 0, 0, 1,
					3);
			...
			vgIP.generatePast("hstw,hstw,hstw,hstw,hstw,hstw,hstw,hstw,hstw", "ti,t,t,-,h,nw,tm,tn,w", "", 0, 0, 1, 3);
			vgIP.generatePresent("mstw,mstw,mstw,mstw", "-,t,im,wt", "", 0, 0, 1, 3);
			vgIP.generateFuture("astw,tstw,tstw,istw,tstw,nstw,tstw,tstw,istw,tstw", "-,-,i,-,-,-,w,nh,w,nh", "", 0, 0, 1,
					3);
			...
			if (root.charAt(len - 2) == 'i' || root.charAt(len - 2) == 'w') {
				vgIP.generateBareInfinitive("ht", "w", 0, 1, 2, 3, String.valueOf(root.charAt(len - 1)));
				vgIP.generateInfinitive("ht", "w", 0, 1, 2, 3, String.valueOf(root.charAt(len - 1)));
			} else {
			...
			String suffix2 = "";
			if (root.charAt(len - 1) == 'n') {
				suffix2 = suffix1 + "ti," + suffix1 + "t," + suffix1 + "t," + suffix1 + "," + suffix1 + "h," + suffix1
						+ "w," + suffix1 + "tm," + suffix1 + "tn," + suffix1 + "w";
			} else {
				suffix2 = suffix1 + "ti," + suffix1 + "t," + suffix1 + "t," + suffix1 + "," + suffix1 + "h," + suffix1
						+ "nw," + suffix1 + "tm," + suffix1 + "tn," + suffix1 + "w";
			}
			vgIP.generatePast("ht,ht,ht,ht,ht,ht,ht,ht,ht", suffix2, "w,w,w,w,w,w,w,w,w", 0, 1, 3, 3);

			if (root.charAt(len - 2) == 'i' || root.charAt(len - 2) == 'w') {
				String suffix3 = suffix1 + "," + suffix1 + "t," + suffix1 + "im," + suffix1 + "wt,";
				vgIP.generatePresent("mt,mt,mt,mt", suffix3, "w,w,w,w", 0, 1, 3, 3);

				String suffix4 = "";
				String suffix5 = "";
				if (root.charAt(len - 1) == 'n') {
					suffix4 = suffix1 + "," + suffix1 + "," + suffix1 + "i," + suffix1 + "," + suffix1 + "," + suffix1 + ","
							+ suffix1 + "w," + suffix1 + "h," + suffix1 + "w," + suffix1 + "h,";
					suffix5 = suffix1 + "," + suffix1 + "i," + suffix1 + "w," + suffix1 + "h,";
				} else {
					suffix4 = suffix1 + "," + suffix1 + "," + suffix1 + "i," + suffix1 + "," + suffix1 + "," + suffix1 + ","
							+ suffix1 + "w," + suffix1 + "nh," + suffix1 + "w," + suffix1 + "nh,";
					suffix5 = suffix1 + "," + suffix1 + "i," + suffix1 + "w," + suffix1 + "nh,";
				}
				vgIP.generateFuture("at,tt,tt,it,tt,nt,tt,tt,it,tt", suffix4, "w,w,w,w,w,w,w,w,w,w", 0, 1, 3, 3);
				vgIP.generateImperative("ht", suffix5, "w,w,w,w", 0, 1, 3, 3);

			} else {
				vgIP.generatePresent("mt,mt,mt,mt", "-,t,im,wt", "w,w,w,w", 0, 1, 1, 3);
				vgIP.generateFuture("at,tt,tt,it,tt,nt,tt,tt,it,tt", "-,-,i,-,-,-,w,nh,w,nh", "w,w,w,w,w,w,w,w,w,w", 0, 1,
						1, 3);
	...
	private void inflectPattern46() throws Exception {
		...
		if (root.charAt(0) == 's') {
			...
			vgIP.generatePast("hst,hst,hst,hst,hst,hst,hst,hst,hst", "ti,t,t,-,h,nw,tm,tn,w", "ii,ii,ii,ii,ii,ii,ii,ii,ii",
					0, 0, 2, 3);
			vgIP.generatePresent("mst,mst,mst,mst", "-,t,im,wt", "ii,ii,ii,ii", 0, 0, 2, 3);
			vgIP.generateFuture("ast,tst,tst,ist,tst,nst,tst,tst,ist,tst", "-,-,i,-,-,-,w,nh,w,nh",
					"ii,ii,ii,ii,ii,ii,ii,ii,ii,ii", 0, 0, 2, 3);
			vgIP.generateImperative("hst", "-,i,w,nh", "ii,ii,ii,ii", 0, 0, 2, 3);
		} else {
			vgIP.setSpelling(IRREGULAR_SPELLING);
			vgIP.generateBareInfinitive("ht", "i", 0, 1, 2, 3, "");
			vgIP.generateInfinitive("ht", "i", 0, 1, 2, 3, "");
			vgIP.generatePast("ht,ht,ht,ht,ht,ht,ht,ht,ht", "ti,t,t,-,h,nw,tm,tn,w", "i,i,i,i,i,i,i,i,i", 0, 1, 2, 3);
			vgIP.generatePresent("mt,mt,mt,mt", "-,t,im,wt", "i,i,i,i", 0, 1, 2, 3);
			vgIP.generateFuture("at,tt,tt,it,tt,nt,tt,tt,it,tt", "-,-,i,-,-,-,w,nh,w,nh", "i,i,i,i,i,i,i,i,i,i", 0, 1, 2,
					3);
			...
			vgIP.generatePast("ht,ht,ht,ht,ht,ht,ht,ht,ht", "ti,t,t,-,h,nw,tm,tn,w", "ii,ii,ii,ii,ii,ii,ii,ii,ii", 0, 1, 2,
					3);
			vgIP.generatePresent("mt,mt,mt,mt", "-,t,im,wt", "ii,ii,ii,ii", 0, 1, 2, 3);
			vgIP.generateFuture("at,tt,tt,it,tt,nt,tt,tt,it,tt", "-,-,i,-,-,-,w,nh,w,nh", "ii,ii,ii,ii,ii,ii,ii,ii,ii,ii",
					0, 1, 2, 3);
	...
	private void inflectPattern47() throws Exception {
		...
		if (root.charAt(2) == 'n')
			vgIP.generatePast("ht,ht,ht,ht,ht,ht,ht,ht,ht", "ti,t,t,-,h, w,tm,tn,w", "ww,ww,ww,ww,ww,ww,ww,ww,ww", 0, 1, 2,
					3);
		else
			vgIP.generatePast("ht,ht,ht,ht,ht,ht,ht,ht,ht", "ti,t,t,-,nh, nw,tm,tn,w", "ww,ww,ww,ww,ww,ww,ww,ww,ww", 0, 1,
					2, 3);

		vgIP.generatePresent("mt,mt,mt,mt", "-,t,im,wt", "w,w,w,w", 0, 1, 1, 3);
		if (root.charAt(2) == 'n') {
			vgIP.generateFuture("at,tt,tt,it,tt,nt,tt,tt,it,tt", "-,-,i,-,-,-,w,h,w,h", "w,w,w,w,w,w,w,w,w,w", 0, 2, 2, 3);
	...
	private void inflectPattern48() throws Exception {
		...
		if (root.charAt(1) == 'w') {
			...
			vgIP.generatePast("h,h,h,h,h,h,h,h,h", "ti,t,t,-,h,nw,tm,tn,w", "w,w,w,wi,wi,w,w,w,wi", 0, 2, 2, 3);
			vgIP.generatePresent("m,m,m,m", "-,h,im,wt", "wi,wi,wi,wi", 0, 2, 2, 3);
			vgIP.generateFuture("a,t,t,i,t,n,t,t,i,t", "-,-,i,-,-,-,w,nh,w,nh", "wi,wi,wi,wi,wi,wi,wi,w,wi,w", 0, 2, 2, 3);
			...
			vgIP.generatePast("h,h,h,h,h,h,h,h,h", "ti,t,t,-,h,nw,tm,tn,w", "-,-,-,i,i,-,-,-,i", 0, 2, 2, 3);
			vgIP.generatePresent("m,m,m,m", "-,h,im,wt", "i,i,i,i", 0, 2, 2, 3);
			vgIP.generateFuture("a,t,t,i,t,n,t,t,i,t", "-,-,i,-,-,-,w,nh,w,nh", "i,i,i,i,i,i,i,-,i,-", 0, 2, 2, 3);
			...
			if (root.charAt(2) == 'n') {
				vgIP.generatePast("h,h,h,h,h,h,h,h,h", "ti,t,t,-,h,w,tm,tn,w", "-,-,-,i,i,-,-,-,i", 0, 2, 2, 3);

				if ((root.charAt(0) != 'a') && (root.charAt(0) != 'h') && (root.charAt(0) != 'x')
						&& (root.charAt(0) != 'y')) {
					vgIP.setSpelling(IRREGULAR_SPELLING);
					vgIP.generatePast("hi,hi,hi,hi,hi,hi,hi,hi,hi", "ti,t,t,-,h,w,tm,tn,w", "-,-,-,i,i,-,-,-,i", 0, 2, 2, 3);
					vgIP.setSpelling(originalSpelling);
				}
				vgIP.generatePresent("m,m,m,m", "-,h,im,wt", "i,i,i,i", 0, 2, 2, 3);
				vgIP.generateFuture("a,t,t,i,t,n,t,t,i,t", "-,-,i,-,-,-,w,h,w,h", "i,i,i,i,i,i,i,-,i,-", 0, 2, 2, 3);
				vgIP.generateImperative("h", "-,i,w,h", "-,i,i,-", 0, 2, 2, 3);
			} else if (root.charAt(2) == 't') {
				vgIP.generatePast("h,h,h,h,h,h,h,h,h", "i,-,-,-,h,nw,m,n,w", "-,-,-,i,i,-,-,-,i", 0, 2, 2, 3);

				if ((root.charAt(0) != 'a') && (root.charAt(0) != 'h') && (root.charAt(0) != 'x')
						&& (root.charAt(0) != 'y')) {
					vgIP.setSpelling(IRREGULAR_SPELLING);
					vgIP.generatePast("hi,hi,hi,hi,hi,hi,hi,hi,hi", "i,-,-,-,h,nw,m,n,w", "-,-,-,i,i,-,-,-,i", 0, 2, 2, 3);
					vgIP.setSpelling(originalSpelling);
				}
				vgIP.generatePresent("m,m,m,m", "-,h,im,wt", "i,i,i,i", 0, 2, 2, 3);
				vgIP.generateFuture("a,t,t,i,t,n,t,t,i,t", "-,-,i,-,-,-,w,nh,w,nh", "i,i,i,i,i,i,i,-,i,-", 0, 2, 2, 3);
				...
				vgIP.generatePast("h,h,h,h,h,h,h,h,h", "ti,t,t,-,h,nw,tm,tn,w", "-,-,-,i,i,-,-,-,i", 0, len - 1, len - 1,
						len);
				if ((root.charAt(0) != 'a') && (root.charAt(0) != 'h') && (root.charAt(0) != 'x')
						&& (root.charAt(0) != 'y')) {
					vgIP.setSpelling(IRREGULAR_SPELLING);
					vgIP.generatePast("hi,hi,hi,hi,hi,hi,hi,hi,hi", "ti,t,t,-,h,nw,tm,tn,w", "-,-,-,i,i,-,-,-,i", 0, 2, 2,
							3);
					vgIP.setSpelling(originalSpelling);
				}
				vgIP.generatePresent("m,m,m,m", "-,h,im,wt", "i,i,i,i", 0, len - 1, len - 1, len);
				vgIP.generateFuture("a,t,t,i,t,n,t,t,i,t", "-,-,i,-,-,-,w,nh,w,nh", "i,i,i,i,i,i,i,-,i,-", 0, len - 1,
						len - 1, len);
				vgIP.generateImperative("h", "-,i,w,nh", "-,i,i,-", 0, len - 1, len - 1, len);
			}
		}
	}
	...
	private void inflectPattern49() throws Exception {
		...
		vgIP.generatePast("hw,hw,hw,hw,hw,hw,hw,hw,hw", "ti,t,t,-,h,nw,tm,tn,w", "-,-,-,i,i,-,-,-,i", 1, 2, 2, 3);
		vgIP.generatePresent("mw,mw,mw,mw", "-,h,im,wt", "i,i,i,i", 1, 2, 2, 3);
		vgIP.generateFuture("aw,tw,tw,iw,tw,nw,tw,tw,iw,tw", "-,-,i,-,-,-,w,nh,w,nh", "i,i,i,i,i,i,i,-,i,-", 1, 2, 2, 3);
	...
	private void inflectPattern50() throws Exception {
		...
		vgIP.generatePast("h,h,h,h,h,h,h,h,h,", "ti,t,t,-,h,nw,tm,tn,w", "-,-,-,i,i,-,-,-,i", 1, 2, 2, 3);
		vgIP.generatePresent("m,m,m,m", "-,h,im,wt", "i,i,i,i", 1, 2, 2, 3);
		vgIP.generateFuture("a,t,t,i,t,n,t,t,i,t", "-,-,i,-,-,-,w,nh,w,nh", "i,i,i,i,i,i,i,-,i,-", 1, 2, 2, 3);
	...
	private void inflectPattern51() throws Exception {
		...
		if (root.charAt(1) == 'w') {
			...
			vgIP.generatePast("h,h,h,h,h,h,h,h,h", "ti,t,t,h,th,nw,tm,tn,w", "wi,wi,wi,w,w,wi,wi,wi,-", 0, 2, 3, 3);
			vgIP.setSpelling(IRREGULAR_SPELLING);
			vgIP.generatePast("h,h,h,h,h,h,h,h,h", "ti,t,t,h,th,nw,tm,tn,w", "i,i,i,-,-,i,i,i,-", 0, 2, 3, 3);
			vgIP.generatePast("hi,hi,hi,hi,hi,hi,hi,hi,hi", "ti,t,t,h,th,nw,tm,tn,w", "wi,wi,wi,w,w,wi,wi,wi,-", 0, 2, 3,
					3);
			vgIP.setSpelling(originalSpelling);
			vgIP.generatePresent("m,m,m,m", "wh,wh,wim,wwt", "", 0, 1, 1, 2);
			vgIP.generateFuture("a,t,t,i,t,n,t,t,i,t", "wh,wh,wi,wh,wh,wh,w,winh,w,winh", "-,-,-,-,-,-,-,-,-,-", 0, 2, 3,
					3);
			...
			vgIP.generatePast("hw,hw,hw,hw,hw,hw,hw,hw,hw", "ti,t,t,h,th,nw,tm,tn,w", "i,i,i,-,-,i,i,i,-", 1, 2, 3, 3);
			vgIP.generatePresent("mw,mw,mw,mw", "h,h,im,wt", "", 1, 2, 3, 3);
			vgIP.generateFuture("aw,tw,tw,iw,tw,nw,tw,tw,iw,tw", "h,h,i,h,h,h,w,inh,w,inh", "-,-,-,-,-,-,-,-,-,-", 1, 2, 3,
					3);
			...
			vgIP.generatePast("h,h,h,h,h,h,h,h,h", "ti,t,t,h,th,nw,tm,tn,w", "i,i,i,-,-,i,i,i,-", 0, 2, 3, 3);
			vgIP.setSpelling(IRREGULAR_SPELLING);
			vgIP.generatePast("hi,hi,hi,hi,hi,hi,hi,hi,hi", "ti,t,t,h,th,nw,tm,tn,w", "i,i,i,-,-,i,i,i,-", 0, 2, 3, 3);
			vgIP.setSpelling(originalSpelling);
			...
			vgIP.generatePast("h,h,h,h,h,h,h,h,h", "ti,t,t,h,th,nw,tm,tn,w", "i,i,i,-,-,i,i,i,-", 1, 2, 3, 3);
			vgIP.setSpelling(IRREGULAR_SPELLING);
			vgIP.generatePast("hi,hi,hi,hi,hi,hi,hi,hi,hi", "ti,t,t,h,th,nw,tm,tn,w", "i,i,i,-,-,i,i,i,-", 1, 2, 3, 3);
			vgIP.setSpelling(originalSpelling);
	...
	private void inflectPattern52() throws Exception {
		...
		if (root.charAt(2) == 'n') {
			vgIP.generatePast("h,h,h,h,h,h,h,h,h", "ti,t,t,-,h,w,tm,tn,w", "-,-,-,i,i,-,-,-,i", 0, 1, 2, 3);
			vgIP.generatePresent("m,m,m,m", "-,h,im,wt", "i,i,i,i", 0, 1, 2, 3);
			vgIP.generateFuture("a,t,t,i,t,n,t,t,i,t", "-,-,i,-,-,-,w,h,w,h", "i,i,i,i,i,i,i,-,i,-", 0, 1, 2, 3);
			vgIP.generateImperative("h", "-,i,w,h", "-,i,i,-", 0, 1, 2, 3);

		} else {

			vgIP.generatePast("h,h,h,h,h,h,h,h,h", "ti,t,t,-,h,nw,tm,tn,w", "-,-,-,i,i,-,-,-,i", 0, 1, 2, 3);
			vgIP.generatePresent("m,m,m,m", "-,h,im,wt", "i,i,i,i", 0, 1, 2, 3);
			vgIP.generateFuture("a,t,t,i,t,n,t,t,i,t", "-,-,i,-,-,-,w,nh,w,nh", "i,i,i,i,i,i,i,-,i,-", 0, 1, 2, 3);
	...
	private void inflectPattern53() throws Exception {
		...
		vgIP.generatePast("h,h,h,h,h,h,h,h,h", "ti,t,t,-,h,nw,tm,tn,w", "", 0, 1, 2, 3);
		vgIP.generatePresent("m,m,m,m", "-,h,im,wt", "", 0, 1, 2, 3);
		vgIP.generateFuture("a,t,t,i,t,n,t,t,i,t", "-,-,i,-,-,-,w,nh,w,nh", "", 0, 1, 2, 3);
	...
	private void inflectPattern54() throws Exception {
		...
		if (root.charAt(0) == 'i' && root.charAt(2) == 't') {
			vgIP.generatePast("hw,hw,hw,hw,hw,hw,hw,hw,hw", "i,-,-,-,h,nw,m,n,w", "", 1, 3, 3, 3);
			vgIP.generatePresent("mw,mw,mw,mw", "-,t,im,wt", "", 1, 2, 2, 3);
			vgIP.generateFuture("aw,tw,tw,iw,tw,nw,tw,tw,iw,tw", "-,-,i,-,-,-,w,nh,w,nh", "", 1, 2, 2, 3);
		} else if (root.charAt(0) == 'i' && root.charAt(2) != 't') {
			vgIP.generatePast("hw,hw,hw,hw,hw,hw,hw,hw,hw", "ti,t,t,-,h,nw,tm,tn,w", "", 1, 3, 3, 3);
			vgIP.generatePresent("mw,mw,mw,mw", "-,t,im,wt", "", 1, 2, 2, 3);
			vgIP.generateFuture("aw,tw,tw,iw,tw,nw,tw,tw,iw,tw", "-,-,i,-,-,-,w,nh,w,nh", "", 1, 2, 2, 3);

		} else if (root.charAt(2) == 't') {
			vgIP.generatePast("hw,hw,hw,hw,hw,hw,hw,hw,hw", "i,-,-,-,h,nw,m,n,w", "", 0, 3, 3, 3);
			vgIP.generatePresent("mw,mw,mw,mw", "-,t,im,wt", "", 0, 2, 2, 3);
			vgIP.generateFuture("aw,tw,tw,iw,tw,nw,tw,tw,iw,tw", "-,-,i,-,-,-,w,nh,w,nh", "", 0, 2, 2, 3);
		} else if (root.charAt(0) == 'n' && root.charAt(2) == 'h') {
			vgIP.generatePast("hw,hw,hw,hw,hw,hw,hw,hw,hw", "iti,it,it,h,th,inw,itm,itn,w", "", 1, 2, 2, 2);
			vgIP.generatePresent("mw,mw,mw,mw", "h,it,im,wt", "", 1, 2, 2, 2);
			vgIP.generateFuture("aw,tw,tw,iw,tw,nw,tw,tw,iw,tw", "h,h,i,h,h,h,w,inh,w,inh", "", 1, 2, 2, 2);
		} else if (root.charAt(0) == 'n') {
			vgIP.generatePast("hw,hw,hw,hw,hw,hw,hw,hw,hw", "ti,t,t,-,h,nw,tm,tn,w", "", 1, 3, 3, 3);
			vgIP.generatePresent("mw,mw,mw,mw", "-,t,im,wt", "", 1, 2, 2, 3);
			vgIP.generateFuture("aw,tw,tw,iw,tw,nw,tw,tw,iw,tw", "-,-,i,-,-,-,w,nh,w,nh", "", 1, 2, 2, 3);
		} else {
			vgIP.generatePast("hw,hw,hw,hw,hw,hw,hw,hw,hw", "ti,t,t,-,h,nw,tm,tn,w", "", 0, len, len, len);
			vgIP.generatePresent("mw,mw,mw,mw", "-,t,im,wt", "", 0, len - 1, len - 1, len);
			vgIP.generateFuture("aw,tw,tw,iw,tw,nw,tw,tw,iw,tw", "-,-,i,-,-,-,w,nh,w,nh", "", 0, len, len, len);
		}
	}
	...
	private void inflectPattern55() throws Exception {
		setGenInflection();
		vgIP.generatePast("hw,hw,hw,hw,hw,hw,hw,hw,hw", "ti,t,t,-,h,nw,tm,tn,w", "", 0, 2, 2, 3);
		vgIP.generatePresent("mw,mw,mw,mw", "-,t,im,wt", "", 0, 2, 2, 3);
		vgIP.generateFuture("aw,tw,tw,iw,tw,nw,tw,tw,iw,tw", "-,-,i,-,-,-,w,nh,w,nh", "", 0, 2, 2, 3);
	}
	...
	private void inflectPattern56() throws Exception {
		setGenInflection();
		if (root.charAt(1) == 'w') {
			vgIP.generatePast("hw,hw,hw,hw,hw,hw,hw,hw,hw", "ti,t,t,h,th,nw,tm,tn,w", "wi,wi,wi,w,w,wi,wi,wi,-", 0, 2, 3,
					3);
			vgIP.generatePresent("mw,mw,mw,mw", "wh,wh,wim,wt", "", 0, 2, 3, 3);
			vgIP.generateFuture("aw,tw,tw,iw,tw,nw,tw,tw,iw,tw", "wh,wh,wi,wh,wh,wh,w,nh,w,nh", "-,-,-,-,-,-,-,wi,-,wi", 0,
					2, 3, 3);
		} else {
			vgIP.generatePast("hw,hw,hw,hw,hw,hw,hw,hw,hw", "ti,t,t,h,th,nw,tm,tn,w", "i,i,i,-,-,i,i,i,-", 0, 2, 3, 3);
			vgIP.generatePresent("mw,mw,mw,mw", "h,h,im,wt", "", 0, 2, 3, 3);
			vgIP.generateFuture("aw,tw,tw,iw,tw,nw,tw,tw,iw,tw", "h,h,i,h,h,h,w,nh,w,nh", "-,-,-,-,-,-,-,i,-,i", 0, 2, 3,
					3);
		}
	}
	...
	private void inflectPattern57() throws Exception {
		setGenInflection();
		if (root.charAt(2) == 'n') {
			vgIP.generatePast("hw,hw,hw,hw,hw,hw,hw,hw,hw", "ti,t,t,-,h,w,tm,tn,w", "", 0, 1, 2, 3);
			vgIP.generatePresent("mw,mw,mw,mw", "-,t,im,wt", "", 0, 1, 2, 3);
			vgIP.generateFuture("aw,tw,tw,iw,tw,nw,tw,tw,iw,tw", "-,-,i,-,-,-,w,h,w,h", "", 0, 1, 2, 3);
		} else {
			vgIP.generatePast("hw,hw,hw,hw,hw,hw,hw,hw,hw", "ti,t,t,-,h,nw,tm,tn,w", "", 0, 1, 2, 3);
			vgIP.generatePresent("mw,mw,mw,mw", "-,t,im,wt", "", 0, 1, 2, 3);
			vgIP.generateFuture("aw,tw,tw,iw,tw,nw,tw,tw,iw,tw", "-,-,i,-,-,-,w,nh,w,nh", "", 0, 1, 2, 3);
		}
	}
	...
	private void inflectPattern58() throws Exception {
		setGenInflection();
		if (root.charAt(0) == 'i') {
			vgIP.generateBareInfinitive("hiww", "", 1, 2, 3, 3, String.valueOf(root.charAt(root.length() - 1)));
			vgIP.generateInfinitive("hiww", "", 1, 1, 3, 3, String.valueOf(root.charAt(root.length() - 1)));
			if (root.charAt(root.length() - 1) == 'n')
				vgIP.generatePast("nw,nw,nw,nw,nw,nw,nw,nw,nw", "ti,t,t,-,h,w,tm,tn,w", "", 1, 3, 3, 3);
			else if (root.charAt(root.length() - 1) == 't')
				vgIP.generatePast("nw,nw,nw,nw,nw,nw,nw,nw,nw", "i,-,-,-,h,nw,tm,n,w", "", 1, 3, 3, 3);
			else
				vgIP.generatePast("nw,nw,nw,nw,nw,nw,nw,nw,nw", "ti,t,t,-,h,nw,tm,tn,w", "", 1, 3, 3, 3);
			vgIP.generatePresent("nw,nw,nw,nw", "-,t,im,wt", "", 1, 1, 1, 3);

			if (root.charAt(root.length() - 1) == 'n')
				vgIP.generateFuture("aww,tiww,tiww,iiww,tiww,niww,tiww,tiww,iiww,tiww", "-,-,i,-,-,-,w,h,w,h", "", 1, 2, 2,
						3);
			else
				vgIP.generateFuture("aww,tiww,tiww,iiww,tiww,niww,tiww,tiww,iiww,tiww", "-,-,i,-,-,-,w,nh,w,nh", "", 1, 2,
						2, 3);
			if (root.charAt(root.length() - 1) == 'n')
			...
			if (!(newReplaceExceptionListSize > 10)) {
				...
				vgIP.generateBareInfinitive("hiw", "", 1, 2, 3, 3, String.valueOf(root.charAt(root.length() - 1)));
				vgIP.generateInfinitive("hiw", "", 1, 1, 3, 3, String.valueOf(root.charAt(root.length() - 1)));
				vgIP.generateFuture("aw,tiw,tiw,iiw,tiw,niw,tiw,tiw,iiw,tiw", "-,-,i,-,-,-,w,nh,w,nh", "", 1, 2, 2, 3);
				vgIP.generateImperative("hiw", "-,i,w,nh", "", 1, 2, 2, 3);
			}
			// פ' הפועל וע' הפועל לא מיוחדים - אבל צריך לבדוק את ל' הפועל (מקרים
			// מיוחדים נ ו-ת
		} else {
			vgIP.generateBareInfinitive("hi", "", 0, 2, 3, 3, String.valueOf(root.charAt(root.length() - 1)));
			vgIP.generateInfinitive("hi", "", 0, 2, 3, 3, String.valueOf(root.charAt(root.length() - 1)));
			vgIP.setSpelling(IRREGULAR_SPELLING);
			if (!vgIP.bareInfinitiveException) {
				vgIP.generateBareInfinitive("h", "", 0, 2, 3, 3, String.valueOf(root.charAt(root.length() - 1)));
				vgIP.generateInfinitive("h", "", 0, 2, 3, 3, String.valueOf(root.charAt(root.length() - 1)));
				vgIP.setSpelling(originalSpelling);
			}

			if (root.charAt(root.length() - 1) == 'n')
				vgIP.generatePast("n,n,n,n,n,n,n,n,n", "ti,t,t,-,h,w,tm,tn,w", "", 0, 3, 3, 3);
			else if (root.charAt(root.length() - 1) == 't')
				vgIP.generatePast("n,n,n,n,n,n,n,n,n", "i,-,-,-,h,nw,m,n,w", "", 0, 3, 3, 3);
			else
				vgIP.generatePast("n,n,n,n,n,n,n,n,n", "ti,t,t,-,h,nw,tm,tn,w", "", 0, 3, 3, 3);
			vgIP.setSpelling(IRREGULAR_SPELLING);
			if (root.charAt(root.length() - 1) == 'n')
				vgIP.generatePast("ni,ni,ni,ni,ni,ni,ni,ni,ni", "ti,t,t,-,h,w,tm,tn,w", "", 0, 3, 3, 3);
			else if (root.charAt(root.length() - 1) == 't')
				vgIP.generatePast("ni,ni,ni,ni,ni,ni,ni,ni,ni", "i,-,-,-,h,nw,m,n,w", "", 0, 3, 3, 3);
			else
				vgIP.generatePast("ni,ni,ni,ni,ni,ni,ni,ni,ni", "ti,t,t,-,h,nw,tm,tn,w", "", 0, 3, 3, 3);
			...
			if (root.charAt(root.length() - 1) == 'n') {
				vgIP.generateFuture("a,ti,ti,ii,ti,ni,ti,ti,ii,ti", "-,-,i,-,-,-,w,h,w,h", "", 0, 2, 2, 3);
			} else {
				vgIP.generateFuture("a,ti,ti,ii,ti,ni,ti,ti,ii,ti", "-,-,i,-,-,-,w,nh,w,nh", "", 0, 2, 2, 3);
			}
	...
	private void inflectPattern59() throws Exception {
		...
		if (root.endsWith("t")) {
			...
			vgIP.generateInfinitive("hi", "", 0, 2, 2, 3, "");
			vgIP.generatePast("", "iti,it,it,h,th,inw,itm,itn,w", "i,i,i,i,i,i,i,i,i", 0, 1, 1, 2);
			vgIP.generatePresent("", "h,it,im,wt", "i,i,i,i", 0, 1, 1, 2);
			vgIP.generateFuture("a,ti,ti,ii,ti,ni,ti,ti,ii,ti", "h,h,i,h,h,h,w,inh,w,inh", "", 0, 1, 1, 2);
	...
	private void inflectPattern60() throws Exception {
		...
		if (root.charAt(1) == 'w') {
			...
			vgIP.generatePast("n,n,n,n,n,n,n,n,n", "ti,t,t,h,th,nw,tm,tn,w", "wi,wi,wi,w,w,wi,wi,wi,-", 0, 2, 3, 3);
			vgIP.generatePresent("n,n,n,n", "wh,wit,wim,wt", "", 0, 1, 1, 2);
			vgIP.generateFuture("a,ti,ti,ii,ti,ni,ti,ti,ii,ti", "wh,wh,wi,wh,wh,wh,w,winh,w,winh", "", 0, 2, 3, 3);
			vgIP.generateImperative("h", "wh,wi,w,winh", "-,-,-,-", 0, 2, 3, 3);

			vgIP.setSpelling(IRREGULAR_SPELLING);
			vgIP.generatePast("n,n,n,n,n,n,n,n,n", "ti,t,t,h,th,nw,tm,tn,w", "i,i,i,-,-,i,i,i,-", 0, 2, 3, 3);
			vgIP.generatePresent("n,n,n,n", "h,it,im,wt", "", 0, 1, 1, 2);
			vgIP.generateFuture("a,ti,ti,ii,ti,ni,ti,ti,ii,ti", "h,h,i,h,h,h,w,inh,w,inh", "", 0, 2, 3, 3);
			...
			vgIP.generatePast("n,n,n,n,n,n,n,n,n", "ti,t,t,h,th,nw,tm,tn,w", "i,i,i,-,-,i,i,i,-", 0, 2, 3, 3);
			vgIP.generatePresent("n,n,n,n", "h,it,im,wt", "", 0, 1, 1, 2);
			vgIP.generateFuture("ai,ti,ti,ii,ti,ni,ti,ti,ii,ti", "h,h,i,h,h,h,w,inh,w,inh", "", 0, 2, 3, 3);
			vgIP.generateImperative("hi", "h,i,w,inh", "-,-,-,-", 0, 2, 3, 3);
		}
	...
	private void inflectPattern61() throws Exception {
		...
		vgIP.generatePast("n,n,n,n,n,n,n,n,n", "ti,t,t,-,h,nw,tm,tn,w", "w,w,w,-,-,w,w,w,-", 0, 3, 3, 3);
		...
		if (root.charAt(2) == 'n') {
			vgIP.generateFuture("a,ti,ti,ii,ti,ni,ti,ti,ii,ti", "-,-,i,-,-,-,w,h,w,h", "", 0, 3, 3, 3);
			vgIP.generateImperative("hi", "-,i,w,h", "", 0, 3, 3, 3);
		} else {
			vgIP.generateFuture("a,ti,ti,ii,ti,ni,ti,ti,ii,ti", "-,-,i,-,-,-,w,nh,w,nh", "", 0, 3, 3, 3);
	...
	private void inflectPattern62() throws Exception {
		...
		if (root.charAt(2) == 'n') {
			vgIP.generatePast("ni,ni,ni,ni,ni,ni,ni,ni,ni", "ti,t,t,-,h,w,tm,tn,w", "w,w,w,w,w,w,w,w,w", 0, 1, 2, 3);
		} else if (root.charAt(2) == 't') {
			vgIP.generatePast("ni,ni,ni,ni,ni,ni,ni,ni,ni", "i,-,-,-,h,nw,m,n,w", "w,w,w,w,w,w,w,w,w", 0, 1, 2, 3);
		} else {
			vgIP.generatePast("ni,ni,ni,ni,ni,ni,ni,ni,ni", "ti,t,t,-,h,nw,tm,tn,w", "w,w,w,w,w,w,w,w,w", 0, 1, 2, 3);
		}
	...
	private void inflectPattern63() throws Exception {
		...
		if (transliterated.endsWith("h")) {
			String baseForm = transliterated.substring(0, transliterated.length() - 1);
			vgIP.generatePastFromBaseForm(baseForm, "iti,it,it,h,th,inw,itm,itn,w");
		} else
			vgIP.generatePastFromBaseForm(transliterated, "ti,t,t,-,h,nw,tm,tn,w");
	}
	...
	public void generateInflects() throws Exception // TODO was protected
	{
		...
		try {
			...
			getException("remove");
			if (this.root.equals("") && !badVerbs.contains(this.id))
				badVerbs.add(this.id); // TODO delete
			if (badVerbs.contains(this.id))
				return; // TODO delete
