...
public class VerbGenIP implements VerbInterface {
	...
	public boolean replaceRemoveException(String GeneratedPGN, String tense,
			...
			List exceptionList, boolean beinoniConstruct, int action)
			throws Exception {
		boolean match = false;
		...
		if (exceptionList != null) {
			...
			for (int i = 0; i < size; i++) {
				...
				verbExceptionType.open(((Integer) exceptionList.get(i))
						.intValue());
				...
				if (exceptionPerson.equals("3")
						&& (tense.equals("beinoni") || tense
								.equals("beinoniPaul")))
					exceptionPerson = "any";

				boolean exceptioniBeinoniConstruct = verbExceptionType
						.isBeinoniConstruct();
				exceptionInflectBeinoniPossessive = verbExceptionType
				 ...
				 * exceptioniBeinoniConstruct); System.out.println("tense =" +
				 * tense); System.out.println("baseGender =" + baseGender);
				...
				if (exceptionTense.equals(tense)
						&& (exceptionGender.equals(baseGender)
								&& exceptionNumber.equals(baseNumber) && exceptionPerson
									.equals(basePerson))
					...
					if (action == 1) {
						...
						if (tense.equals("infinitive")) {
							...
							if (exceptionPGN.equals("unspecified")
								...
								participleType = "verb";
								populateDBTable();
							} else if (!exceptionPGN.equals("unspecified")
									|| beinoniConstruct) {
								participleType = "noun";
								populateDBTable();
	...
	public void AddException(List exceptionList) throws Exception {
		...
		for (int i = 0; i < size; i++) {
			...
			boolean exceptioniBeinoniDefiniteness = verbExceptionType
	...
	public void generateBareInfinitive(String prefix, String inside,
			int index1, int index2, int index3, int index4, String suffix)
			throws Exception {
		...
		if (inflectBareInfinitive) {
			...
			inflected = new StringBuffer().append(prefix)
					.append(root.substring(index1, index2)).append(inside)
	...
	public void generateInfinitive(String prefix, String inside, int index1,
		...
		if (this.isInflectInfinitive()) {
			...
			inflected = new StringBuffer().append("l").append(
					inflectedVerb);
		...
		setAttributes("infinitive", "verb", "unspecified", "unspecified",
				"unspecified", "unspecified", "unspecified", "unspecified",
				"possessive", "unspecified", "unspecified", "unspecified", "f");
	...
	public void generatePastFromBaseForm(String baseForm, String suffix)
			throws Exception {
		PGN = "unspecified";
		StringTokenizer stSuff = null;
		String lsuffix = "";
				...
				if (binyan.equals("Nif\\'al")) {
					if ((baseGender.equals("masculine")
							...
							|| (baseGender.equals("masculine and feminine")
									&& baseNumber.equals("plural") && basePerson
										.equals("3"))) {
	...
	public void generateBeinoniPassive(String passiveBase) throws Exception {
		if (valence.indexOf("WithoutPaul") == -1) {
			...
			while (stSuff.hasMoreTokens()) {
				...
				if (suffix.equals("-"))
					suffix = "";
				StringBuffer inflect = new StringBuffer().append(passiveBase)
						.append(suffix);
	...
	public void generateConstructAndPossessive(String base,
			boolean possessiveFlag) throws Exception {
		if (inflectBeinoniConstruct) {
			...
			while (stNumber4.hasMoreTokens()) {
				...
				StringBuffer inflected = new StringBuffer().append(base)
						.append(suff);
				inflectedVerb = inflected.toString();
	...
	public void generatePossessive(String base) throws Exception {
		...
		while (stPGN10.hasMoreTokens()) {
			...
			if (inflectedVerb.endsWith("www"))
				inflectedVerb = inflectedVerb.substring(0,
	...
	public boolean isInflectInfinitiveIndependent() {
		if (intInflectedPattern < 36
				|| (intInflectedPattern >= 42 && intInflectedPattern < 54)
