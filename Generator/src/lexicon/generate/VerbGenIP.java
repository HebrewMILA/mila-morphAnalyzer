...
public class VerbGenIP implements VerbInterface {
	...
	boolean inflectInfinitive = true; // 09/07/14 - Changes were made, inflect
	// only infinitive and 'l' + infinitive.
	boolean inflectBareInfinitive = true;
	boolean replaceRemoveInfinitive = false;
	boolean inflectInfinitiveIndependent = false; // 09/07/14 - Changes were
	// made. Only infinitive and
	// 'l'+infinitive should be
	// inflected. All binyanim
	// but 'pu'al' and 'huf'al'.
	...
	/**
	 * This methos handles filling the inflection record with values to be inserted
	 * to the database
	 * 
	 * @throws Exception
	 */
	 ...
	 * It checks whether there is a matching value for the current generated form
	 * <br>
	 ...
	 * @throws Exception
	 */
	public boolean replaceRemoveException(String GeneratedPGN, String tense, String baseGender, String baseNumber,
			String basePerson, List exceptionList, boolean beinoniConstruct, int action) throws Exception {
		boolean match = false;
		...
		if (exceptionList != null) {
			...
			for (int i = 0; i < size; i++) {
				 ...
				 * + " handling"); System.out.println("exceptionTense =" + exceptionTense);
				 ...
				 * exceptioniBeinoniConstruct); System.out.println("tense =" + tense);
				 ...
				 * System.out.println("exceptionInflectBeinoniPossessive  ="+
				 * exceptionInflectBeinoniPossessive);
				 */
				if (exceptionTense.equals(tense)
						&& (exceptionGender.equals(baseGender) && exceptionNumber.equals(baseNumber)
								&& exceptionPerson.equals(basePerson))
						&& (exceptionPGN.equals(GeneratedPGN)) && (beinoniConstruct == exceptioniBeinoniConstruct)) {
					...
					if (action == 1) {
						...
						if (tense.equals("infinitive")) {
							...
							if (exceptionPGN.equals("unspecified") && !beinoniConstruct && baseDefiniteness.equals("f")) {
								participleType = "noun";
								populateDBTable();
	...
	private void setAttributes(String tense, String pos, String PGN, String basePerson, String baseGender,
			String baseNumber, String construct, String accusativeSuffix, String suffixFunction, String suffixNumber,
			String suffixGender, String suffixPerson, String baseDefiniteness) {
		this.tense = tense;
		this.PGN = PGN;
		this.pos = pos;
	...
	public void generateBareInfinitive(String prefix, String inside, int index1, int index2, int index3, int index4,
		...
		if (inflectBareInfinitive) {
			...
			setAttributes("bareInfinitive", "verb", "unspecified", "unspecified", "unspecified", "unspecified",
					"unspecified", "unspecified", "unspecified", "unspecified", "unspecified", "unspecified", "f");
			// System.out.println();
			// System.out.println("generate bare infinitive");
			StringBuffer inflected = null;

			inflected = new StringBuffer().append(prefix).append(root.substring(index1, index2)).append(inside)
					.append(root.substring(index3, index4)).append(suffix);

			inflectedVerb = inflected.toString();
			surface = Translate.Eng2Heb(inflectedVerb);
			if (!replaceRemoveException("unspecified", tense, "unspecified", "unspecified", "unspecified",
					replaceExceptionList, false, REPLACE)
					&& !replaceRemoveException("unspecified", tense, "unspecified", "unspecified", "unspecified",
			...
			// System.out.println("(F) VerbGenIP: generateBareInfinitive() generate
			// infinitive without prefix l - for bkm prefixes");
		} else {
			StringBuffer inflected = new StringBuffer().append(prefix).append(root.substring(index1, index2))
					.append(inside).append(root.substring(index3, index4)).append(suffix);
	 ...
	 * @param index1
	 *           - substringing the root from index1 to index2 for concatenation of
	 *           the inside part
	 * @param index2
	 *           - substringing the root from index1 to index2 for concatenation of
	 *           the inside part
	 * @param index3
	 *           - substringing the root from index3 to index4 for concatenation of
	 *           the inside part
	 * @param index4
	 *           - substringing the root from index3 to index4 for concatenation of
	 *           the inside part
	...
	public void generateInfinitive(String prefix, String inside, int index1, int index2, int index3, int index4,
		...
		if (this.isInflectInfinitive()) {
			// System.out.println("generate infinitive, w/o 'l'");
			setAttributes("infinitive", "verb", "unspecified", "unspecified", "unspecified", "unspecified", "unspecified",
					"unspecified", "unspecified", "unspecified", "unspecified", "unspecified", "f");

			StringBuffer inflected = new StringBuffer().append(inflectedVerb);
			...
			inflected = new StringBuffer().append("l").append(inflectedVerb);
			...
			// Commented out by Slava on April 29th, 2014
			// Infinitive should only be inflected with 'l', not with bkm
			//
			...
			//
			// inflected = new
			// StringBuffer().append("b").append(inflectedVerb.substring(1));
			//
			// inflectedVerb = inflected.toString();
			// //System.out.println("(F)generateInfinitive inflectedVerb =" +
			// inflectedVerb);
			// surface = Translate.Eng2Heb(inflectedVerb);
			// //System.out.println("(F)generateInfinitive surface =" +
			// surface);
			// //System.out.println();
			//
			// if (!replaceRemoveException("unspecified", tense, "unspecified",
			// "unspecified", "unspecified", replaceExceptionList,
			// false,REPLACE)
			// && !replaceRemoveException("unspecified", tense,
			// "unspecified", "unspecified", "unspecified",
			// removeExceptionList, false, REMOVE))
			...
			//
			// inflected = new
			// StringBuffer().append("m").append(inflectedVerb.substring(1));
			//
			// inflectedVerb = inflected.toString();
			// //System.out.println("(F)generateInfinitive inflectedVerb =" +
			// inflectedVerb);
			...
			//
			// inflected = new
			// StringBuffer().append("k").append(inflectedVerb.substring(1));
			//
			// inflectedVerb = inflected.toString();
			// //System.out.println("(F)generateInfinitive inflectedVerb =" +
			// inflectedVerb);
		...
		if (binyan.equals("Pa\\'al") && !replaceRemoveInfinitive) {
			// System.out.println("generate infinitive without prefix l - for bkm
			// prefixes");
			StringBuffer inflected = new StringBuffer().append(prefix).append(root.substring(index1, index2))
					.append(inside).append(root.substring(index3, index4)).append(suffix);
		...
		setAttributes("infinitive", "verb", "unspecified", "unspecified", "unspecified", "unspecified", "unspecified",
				"unspecified", "possessive", "unspecified", "unspecified", "unspecified", "f");
	...
	public void generatePast(String prefix, String suffix, String inside, int index1, int index2, int index3, int index4)
		...
		if (inflectPast) {
			...
			while (stSuff.hasMoreTokens()) {
				...
				setAttributes("past", "verb", "unspecified", "unspecified", "unspecified", "unspecified", "unspecified",
						"unspecified", "unspecified", "unspecified", "unspecified", "unspecified", "f");
				StringBuffer inflected = new StringBuffer().append(lprefix).append(root.substring(index1, index2))
						.append(linside).append(root.substring(index3, index4)).append(lsuffix);
				inflectedVerb = inflected.toString();
				...
				if (!replaceRemoveException("unspecified", tense, baseGender, baseNumber, basePerson, replaceExceptionList,
						false, REPLACE)
						&& !replaceRemoveException("unspecified", tense, baseGender, baseNumber, basePerson,
								removeExceptionList, false, REMOVE))
					populateDBTable();
			}
		}
	...
	public void generatePastFromBaseForm(String baseForm, String suffix) throws Exception {
		...
		while (stSuff.hasMoreTokens()) {
			...
			setAttributes("past", "verb", "unspecified", "unspecified", "unspecified", "unspecified", "unspecified",
					"unspecified", "unspecified", "unspecified", "unspecified", "unspecified", "f");
			StringBuffer inflected = new StringBuffer().append(baseForm).append(lsuffix);
			inflectedVerb = inflected.toString();
			// System.out.println("inflectedVerb =" + inflectedVerb);
			surface = Translate.Eng2Heb(inflectedVerb);
			// System.out.println("surface =" + surface);
			...
			if (!replaceRemoveException("unspecified", tense, baseGender, baseNumber, basePerson, replaceExceptionList,
					false, REPLACE)
					&& !replaceRemoveException("unspecified", tense, baseGender, baseNumber, basePerson, removeExceptionList,
							false, REMOVE))
				populateDBTable();
		}
	}
	...
	public void generatePresent(String prefix, String suffix, String inside, int index1, int index2, int index3,
		...
		if (inflectBeinoni) {
			...
			while (stSuff.hasMoreTokens()) {
				...
				setAttributes("beinoni", "participle", "unspecified", basePerson, baseGender, baseNumber, "false",
						"unspecified", "unspecified", "unspecified", "unspecified", "unspecified", "tf");
				...
				if (!replaceRemoveException("unspecified", tense, baseGender, baseNumber, basePerson, replaceExceptionList,
						false, REPLACE)
						&& !replaceRemoveException(PGN, tense, baseGender, baseNumber, basePerson, removeExceptionList, false,
								REMOVE)) {
					PGN = "unspecified";
				...
				setAttributes("beinoni", "participle", "unspecified", basePerson, baseGender, baseNumber, "false",
						"unspecified", "unspecified", "unspecified", "unspecified", "unspecified", "tt");
				surface = Translate.Eng2Heb(inflectedVerb);
	...
	public void generateFuture(String prefix, String suffix, String inside, int index1, int index2, int index3,
		...
		if (inflectFuture) {
			...
			setAttributes("future", "verb", "unspecified", "any", "unspecified", "unspecified", "false", "unspecified",
					"unspecified", "unspecified", "unspecified", "unspecified", "f");
			while (stPre.hasMoreTokens()) {
				...
				StringBuffer inflected = new StringBuffer().append(lpreffix).append(root.substring(index1, index2))
						.append(linside).append(root.substring(index3, index4)).append(lsuffix);
				inflectedVerb = inflected.toString();
				// System.out.println("inflectedVerb =" + inflectedVerb);
				surface = Translate.Eng2Heb(inflectedVerb);
				...
				if (binyan.equals("Nif\\'al")) {
					if ((baseGender.equals("masculine") && baseNumber.equals("singular") && basePerson.equals("3"))
							|| (baseGender.equals("masculine and feminine") && baseNumber.equals("plural")
									&& basePerson.equals("3"))) {
						if (!replaceRemoveException("unspecified", tense, baseGender, baseNumber, basePerson,
								replaceExceptionList, false, REMOVE)
								&& !replaceRemoveException("unspecified", tense, baseGender, baseNumber, basePerson,
										replaceExceptionList, false, REPLACE)) {
							inflectedVerb = inflectedVerb.substring(1);
	...
	public void generateImperative(String prefix, String suffix, String inside, int index1, int index2, int index3,
		...
		if (inflectImperative) {
			...
			setAttributes("imperative", "verb", "unspecified", "2", "unspecified", "unspecified", "false", "unspecified",
					"unspecified", "unspecified", "unspecified", "unspecified", "f");
			while (stSuff.hasMoreTokens()) {
				if (stIn != null) {
					linside = stIn.nextToken();
	...
	public void generateBeinoniPassive(String passiveBase) throws Exception {
		if (valence.indexOf("WithoutPaul") == -1) {
			...
			while (stSuff.hasMoreTokens()) {
				setAttributes("beinoni", "passiveParticiple", "unspecified", "any", "unspecified", "unspecified", "false",
						"unspecified", "unspecified", "unspecified", "unspecified", "unspecified", "f");
				baseNumber = stNumber4.nextToken();
				baseGender = stGender4.nextToken();
				...
				inflectedVerb = "h" + inflectedVerb;
				setAttributes("beinoni", "passiveParticiple", "unspecified", "any", baseGender, baseNumber, "false",
						"unspecified", "unspecified", "unspecified", "unspecified", "unspecified", "tt");
				surface = Translate.Eng2Heb(inflectedVerb);
				...
				// System.out.println("h+ participle =" + inflectedVerb);
				setAttributes("beinoni", "passiveParticiple", "unspecified", basePerson, baseGender, baseNumber, "false",
						"unspecified", "unspecified", "unspecified", "unspecified", "unspecified", "f");
				inflectedVerb = inflect.toString();
				surface = Translate.Eng2Heb(inflectedVerb);
				...
				if (!constructFlag) {
					...
					else if (root.charAt(2) == 'a' && passiveBase.charAt(3) == 'a')
						base = root.substring(0, 2) + "w" + root.substring(2);
					else if (root.charAt(2) == 'a' && passiveBase.charAt(3) == 'i')
						base = root.substring(0, 2) + "wi";
					else
						base = root.substring(0, 2) + "w" + root.substring(2);
	 ...
	 *           - for Nifal,Pual,Hufal - false - because we will not generete the
	 *           possessive form
	 * @throws Exception
	 */
	public void generateConstructAndPossessive(String base, boolean possessiveFlag) throws Exception {
		if (inflectBeinoniConstruct) {
			...
			while (stNumber4.hasMoreTokens()) {
				setAttributes("beinoni", pos, "unspecified", basePerson, baseGender, baseNumber, "true", "unspecified",
						"unspecified", "unspecified", "unspecified", "unspecified", "f");
				baseNumber = stNumber4.nextToken();
				baseGender = stGender4.nextToken();
				basePerson = stPerson4.nextToken();
				...
				boolean rtRemove = replaceRemoveException("unspecified", tense, baseGender, baseNumber, basePerson,
						replaceExceptionList, true, REMOVE);
				boolean rtReplace = replaceRemoveException("unspecified", tense, baseGender, baseNumber, basePerson,
				...
				if (!rtRemove && !rtReplace) {
					...
					// - to do someday
				} else if (rtReplace && possessiveFlag && exceptionInflectBeinoniPossessive)
					generatePossessive(inflectedVerb);
			}
		}
	}
	...
	public void generateAccusativeNominative(String base) throws Exception {
		// 09/07/2014 - Alon says all verbs should be inflected with and without 'l'
		// 'bkm' shouldn't be inflected anymore as accusative.
		// this is static, thus, this flag is not necessary anymore
		// System.out.println();
		...
		setAttributes(tense, pos, "unspecified", basePerson, baseGender, baseNumber, "false", "unspecified",
				"accusative or nominative", "unspecified", "unspecified", "unspecified", "f");
		stPGN10 = new StringTokenizer(PGNTokens10, ",");
		...
		while (stPGN10.hasMoreTokens()) {
			...
			// 09/07/14 - generate inflectedInfinitiveIndependant to all who are
			// not Pa'ul/Huf'al.
			if (inflectInfinitiveb && this.isInflectInfinitiveIndependent()) {
				pos = "indInf";
				// System.out.println(inflectedVerb);
				surface = Translate.Eng2Heb(inflectedVerb);
				System.out.println("surface =" + surface);
			...
			if (this.isInflectInfinitive() && inflectInfinitivel) {
				...
				System.out.print("suff " + suffPossessive + " - ");
				if (suffPossessive.equals("i")) {
					inflectedVerb = "l" + base + "ni";
				}
				System.out.println(inflectedVerb);
				surface = Translate.Eng2Heb(inflectedVerb);
				System.out.println(" surface =" + surface);
	...
	/**
	 * @return Returns the inflectInfintivel.
	 */
	...
	/**
	 * @return Returns the inflectInfintiveb.
	 */
	...
	/**
	 * @param inflectInfintiveb
	 *           The inflectInfintiveb to set.
	 */
	 ...
	 */
	// 09/07/2014 - this is always true for every binyan but 'Pu'al' and
	// 'Huf'al'.
	public boolean isInflectInfinitiveIndependent() {
		if (intInflectedPattern < 36 || (intInflectedPattern >= 42 && intInflectedPattern < 54)
				|| intInflectedPattern > 57) {
			return true;
		}
		return false;
	}
	 ...
	 */
	// 09/07/2014 - this is not a flag anymore, it's static.
	// public void setInflectInfinitiveIndependent(boolean
	 ...
	 */
	// 09/07/14 - Alon says infinitives should always be inflected except for
	// 'Pu'al' and 'Huf'al'
