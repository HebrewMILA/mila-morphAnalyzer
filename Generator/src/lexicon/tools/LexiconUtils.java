...
public class LexiconUtils {
	protected static final String[] EXCEPTION_TYPES = {"adverb", "interjection", "interrogative", "noun", "preposition", "quantifier", "verb"};
	...
	/**
	 * Renders all the parameters from a ServletRequest object to a link or to hidden fields.
	 * The method can omit (skip) parameters from the output by using a list passed to it.
	 * <p>
	 ...
	 * @param omitList	A TreeSet (simple unordered bag) which the skipped names of 
	 * parameters were inserted into. 
	 * @param doHiddens	If set to <code>0</code>, the method would the result as queryString
	 * If set to <code>1</code>, the method would produce hidden
	 * If set to <code>2</code>, the method would produce the result as jsp:forward parameters
	 * fields. otherwise, it woudl create a link.
	 * @return
	 */
