...
public class NumeralExceptionTypeImpl implements
		lexicon.jaxb.NumeralExceptionType, com.sun.xml.bind.JAXBObject,
	...
	public lexicon.jaxb.impl.runtime.UnmarshallingEventHandler createUnmarshaller(
		...
		return new lexicon.jaxb.impl.NumeralExceptionTypeImpl.Unmarshaller(
				context);
	}
		...
		if (has_InflectConstruct) {
			...
			try {
				context.text(javax.xml.bind.DatatypeConverter
						.printBoolean(((boolean) _InflectConstruct)),
						"InflectConstruct");
			} catch (java.lang.Exception e) {
				lexicon.jaxb.impl.runtime.Util.handlePrintConversionException(
						this, e, context);
