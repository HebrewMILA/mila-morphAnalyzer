...
public class InterrogativeLexiconTypeImpl implements
		lexicon.jaxb.InterrogativeLexiconType, com.sun.xml.bind.JAXBObject,
	...
	public lexicon.jaxb.impl.runtime.UnmarshallingEventHandler createUnmarshaller(
		...
		return new lexicon.jaxb.impl.InterrogativeLexiconTypeImpl.Unmarshaller(
				context);
	}
	...
	public void serializeAttributes(
		...
		if (_InterrogativeType != null) {
			...
			try {
				context.text(((java.lang.String) _InterrogativeType),
						"InterrogativeType");
			} catch (java.lang.Exception e) {
				lexicon.jaxb.impl.runtime.Util.handlePrintConversionException(
						this, e, context);
	...
	public static class AddImpl extends
			lexicon.jaxb.impl.InterrogativeExceptionTypeImpl implements
			lexicon.jaxb.InterrogativeLexiconType.Add,
		...
		public lexicon.jaxb.impl.runtime.UnmarshallingEventHandler createUnmarshaller(
				lexicon.jaxb.impl.runtime.UnmarshallingContext context) {
			return new lexicon.jaxb.impl.InterrogativeLexiconTypeImpl.AddImpl.Unmarshaller(
					context);
		}
					...
					case 1:
						if (("dotted" == ___local) && ("" == ___uri)) {
							spawnHandlerFromEnterAttribute(
									(((lexicon.jaxb.impl.InterrogativeExceptionTypeImpl) lexicon.jaxb.impl.InterrogativeLexiconTypeImpl.AddImpl.this).new Unmarshaller(
	...
	public static class RemoveImpl extends
			lexicon.jaxb.impl.InterrogativeExceptionTypeImpl implements
			lexicon.jaxb.InterrogativeLexiconType.Remove,
			com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject,
			lexicon.jaxb.impl.runtime.UnmarshallableObject,
			lexicon.jaxb.impl.runtime.XMLSerializable,
			lexicon.jaxb.impl.runtime.ValidatableObject {
		...
		public lexicon.jaxb.impl.runtime.UnmarshallingEventHandler createUnmarshaller(
				lexicon.jaxb.impl.runtime.UnmarshallingContext context) {
			return new lexicon.jaxb.impl.InterrogativeLexiconTypeImpl.RemoveImpl.Unmarshaller(
					context);
		}
			...
			public void enterAttribute(java.lang.String ___uri,
				...
				outer: while (true) {
					...
					case 1:
						if (("dotted" == ___local) && ("" == ___uri)) {
							spawnHandlerFromEnterAttribute(
									(((lexicon.jaxb.impl.InterrogativeExceptionTypeImpl) lexicon.jaxb.impl.InterrogativeLexiconTypeImpl.RemoveImpl.this).new Unmarshaller(
											context)), 2, ___uri, ___local,
									___qname);
							return;
						}
	...
	public static class ReplaceImpl extends
			lexicon.jaxb.impl.InterrogativeExceptionTypeImpl implements
			lexicon.jaxb.InterrogativeLexiconType.Replace,
			com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject,
			lexicon.jaxb.impl.runtime.UnmarshallableObject,
			lexicon.jaxb.impl.runtime.XMLSerializable,
			lexicon.jaxb.impl.runtime.ValidatableObject {
		...
		public lexicon.jaxb.impl.runtime.UnmarshallingEventHandler createUnmarshaller(
				lexicon.jaxb.impl.runtime.UnmarshallingContext context) {
			return new lexicon.jaxb.impl.InterrogativeLexiconTypeImpl.ReplaceImpl.Unmarshaller(
					context);
		}
			...
			public void enterAttribute(java.lang.String ___uri,
				...
				outer: while (true) {
					...
					case 1:
						if (("dotted" == ___local) && ("" == ___uri)) {
							spawnHandlerFromEnterAttribute(
									(((lexicon.jaxb.impl.InterrogativeExceptionTypeImpl) lexicon.jaxb.impl.InterrogativeLexiconTypeImpl.ReplaceImpl.this).new Unmarshaller(
											context)), 2, ___uri, ___local,
									___qname);
							return;
						}
	...
	public class Unmarshaller extends
				...
				case 9:
					if (("add" == ___local) && ("" == ___uri)) {
						_getAddOrReplaceOrRemove()
								.add(((lexicon.jaxb.impl.InterrogativeLexiconTypeImpl.AddImpl) spawnChildFromEnterElement(
										(lexicon.jaxb.impl.InterrogativeLexiconTypeImpl.AddImpl.class),
										10, ___uri, ___local, ___qname, __atts)));
						return;
					}
					if (("replace" == ___local) && ("" == ___uri)) {
						_getAddOrReplaceOrRemove()
								.add(((lexicon.jaxb.impl.InterrogativeLexiconTypeImpl.ReplaceImpl) spawnChildFromEnterElement(
										(lexicon.jaxb.impl.InterrogativeLexiconTypeImpl.ReplaceImpl.class),
										10, ___uri, ___local, ___qname, __atts)));
						return;
					}
					if (("remove" == ___local) && ("" == ___uri)) {
						_getAddOrReplaceOrRemove()
								.add(((lexicon.jaxb.impl.InterrogativeLexiconTypeImpl.RemoveImpl) spawnChildFromEnterElement(
										(lexicon.jaxb.impl.InterrogativeLexiconTypeImpl.RemoveImpl.class),
										10, ___uri, ___local, ___qname, __atts)));
						return;
					}
					state = 10;
		...
		private void eatText2(final java.lang.String value)
				throws org.xml.sax.SAXException {
			try {
				_InterrogativeType = com.sun.xml.bind.WhiteSpaceProcessor
						.collapse(value);
			} catch (java.lang.Exception e) {
				handleParseConversionException(e);
			}
