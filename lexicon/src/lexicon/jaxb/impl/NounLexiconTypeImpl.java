...
public class NounLexiconTypeImpl implements lexicon.jaxb.NounLexiconType,
	...
	public void serializeAttributes(
		...
		if (has_Dual) {
			...
			try {
				context.text(javax.xml.bind.DatatypeConverter
						.printBoolean(((boolean) _Dual)), "Dual");
			} catch (java.lang.Exception e) {
				lexicon.jaxb.impl.runtime.Util.handlePrintConversionException(
						this, e, context);
			}
		...
		if (schemaFragment == null) {
			schemaFragment = com.sun.xml.bind.validator.SchemaDeserializer
					.deserialize(("\u00ac\u00ed\u0000\u0005sr\u0000\u001fcom.sun.msv.grammar.SequenceExp\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xr\u0000\u001dcom.su"
							...
							+ "\u0000~\u0000\u0007q\u0000~\u0000\u008cq\u0000~\u0000\u0015q\u0000~\u0000\fq\u0000~\u0000\u0011q\u0000~\u0000\u0090q\u0000~\u0000\u0013q\u0000~\u0000\bq\u0000~\u0000\u00e1q\u0000~\u0000 q\u0000~\u0000\u0005q\u0000~\u0000\u00aeq"
							+ "\u0000~\u0000nq\u0000~\u0000\u001fq\u0000~\u0000\u00ddq\u0000~\u0000\u00c6q\u0000~\u0000\u00baq\u0000~\u0000\u0010q\u0000~\u0000wq\u0000~\u0000\u0016q\u0000~\u0000\u0018q\u0000~\u0000\u0006q\u0000~\u0000\u00ceq\u0000~\u0000Gq"
							+ "\u0000~\u0000\u00beq\u0000~\u0000\u00caq\u0000~\u0000(q\u0000~\u0000;q\u0000~\u0000Bq\u0000~\u0000\u00c2q\u0000~\u0000\u000eq\u0000~\u0000\u001cq\u0000~\u0000\u0014q\u0000~\u0000\u0086q\u0000~\u0000\u00b2q\u0000~\u0000{q"
							+ "\u0000~\u0000!q\u0000~\u00009q\u0000~\u0000@q\u0000~\u0000\u0012q\u0000~\u0000\u001eq\u0000~\u0000\u000bq\u0000~\u0000\u0017q\u0000~\u0000\u00b6q\u0000~\u0000\u000fq\u0000~\u0000\u00f2q\u0000~\u0000)q\u0000~\u0000<q"
							+ "\u0000~\u0000Cq\u0000~\u0000\nq\u0000~\u0000\u0019q\u0000~\u0000\rq\u0000~\u0000\tq\u0000~\u0000\u00a1q\u0000~\u0000\u009dx"));
		}
	...
	public static class AddImpl extends lexicon.jaxb.impl.NounExceptionTypeImpl
		...
		public lexicon.jaxb.impl.runtime.UnmarshallingEventHandler createUnmarshaller(
				lexicon.jaxb.impl.runtime.UnmarshallingContext context) {
			return new lexicon.jaxb.impl.NounLexiconTypeImpl.AddImpl.Unmarshaller(
					context);
		}
					...
					case 1:
						if (("construct" == ___local) && ("" == ___uri)) {
							spawnHandlerFromEnterAttribute(
									(((lexicon.jaxb.impl.NounExceptionTypeImpl) lexicon.jaxb.impl.NounLexiconTypeImpl.AddImpl.this).new Unmarshaller(
	...
	public static class RemoveImpl extends
			...
			lexicon.jaxb.NounLexiconType.Remove, com.sun.xml.bind.RIElement,
			com.sun.xml.bind.JAXBObject,
			lexicon.jaxb.impl.runtime.UnmarshallableObject,
			lexicon.jaxb.impl.runtime.XMLSerializable,
			lexicon.jaxb.impl.runtime.ValidatableObject {
		...
		public lexicon.jaxb.impl.runtime.UnmarshallingEventHandler createUnmarshaller(
				lexicon.jaxb.impl.runtime.UnmarshallingContext context) {
			return new lexicon.jaxb.impl.NounLexiconTypeImpl.RemoveImpl.Unmarshaller(
					context);
		}
			...
			public void enterAttribute(java.lang.String ___uri,
				...
				outer: while (true) {
					...
					case 1:
						if (("construct" == ___local) && ("" == ___uri)) {
							spawnHandlerFromEnterAttribute(
									(((lexicon.jaxb.impl.NounExceptionTypeImpl) lexicon.jaxb.impl.NounLexiconTypeImpl.RemoveImpl.this).new Unmarshaller(
											context)), 2, ___uri, ___local,
									___qname);
							return;
						}
	...
	public static class ReplaceImpl extends
			lexicon.jaxb.impl.NounExceptionTypeImpl implements
			lexicon.jaxb.NounLexiconType.Replace, com.sun.xml.bind.RIElement,
			com.sun.xml.bind.JAXBObject,
			lexicon.jaxb.impl.runtime.UnmarshallableObject,
			lexicon.jaxb.impl.runtime.XMLSerializable,
			lexicon.jaxb.impl.runtime.ValidatableObject {
		...
		public lexicon.jaxb.impl.runtime.UnmarshallingEventHandler createUnmarshaller(
				lexicon.jaxb.impl.runtime.UnmarshallingContext context) {
			return new lexicon.jaxb.impl.NounLexiconTypeImpl.ReplaceImpl.Unmarshaller(
					context);
		}
			...
			public void enterAttribute(java.lang.String ___uri,
				...
				outer: while (true) {
					...
					case 1:
						if (("construct" == ___local) && ("" == ___uri)) {
							spawnHandlerFromEnterAttribute(
									(((lexicon.jaxb.impl.NounExceptionTypeImpl) lexicon.jaxb.impl.NounLexiconTypeImpl.ReplaceImpl.this).new Unmarshaller(
											context)), 2, ___uri, ___local,
									___qname);
							return;
						}
				...
				case 64:
					if (("add" == ___local) && ("" == ___uri)) {
						_getAddOrReplaceOrRemove()
								.add(((lexicon.jaxb.impl.NounLexiconTypeImpl.AddImpl) spawnChildFromEnterElement(
										(lexicon.jaxb.impl.NounLexiconTypeImpl.AddImpl.class),
										64, ___uri, ___local, ___qname, __atts)));
						return;
					}
					if (("replace" == ___local) && ("" == ___uri)) {
						_getAddOrReplaceOrRemove()
								.add(((lexicon.jaxb.impl.NounLexiconTypeImpl.ReplaceImpl) spawnChildFromEnterElement(
										(lexicon.jaxb.impl.NounLexiconTypeImpl.ReplaceImpl.class),
										64, ___uri, ___local, ___qname, __atts)));
						return;
					}
					if (("remove" == ___local) && ("" == ___uri)) {
						_getAddOrReplaceOrRemove()
								.add(((lexicon.jaxb.impl.NounLexiconTypeImpl.RemoveImpl) spawnChildFromEnterElement(
										(lexicon.jaxb.impl.NounLexiconTypeImpl.RemoveImpl.class),
										64, ___uri, ___local, ___qname, __atts)));
						return;
					}
