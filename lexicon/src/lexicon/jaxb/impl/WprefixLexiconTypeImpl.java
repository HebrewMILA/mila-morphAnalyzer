...
public class WprefixLexiconTypeImpl implements lexicon.jaxb.WprefixLexiconType,
	...
	public lexicon.jaxb.impl.runtime.UnmarshallingEventHandler createUnmarshaller(
		...
		return new lexicon.jaxb.impl.WprefixLexiconTypeImpl.Unmarshaller(
				context);
	}
	...
	public static class AddImpl extends
			lexicon.jaxb.impl.WprefixExceptionTypeImpl implements
			lexicon.jaxb.WprefixLexiconType.Add, com.sun.xml.bind.RIElement,
			com.sun.xml.bind.JAXBObject,
			lexicon.jaxb.impl.runtime.UnmarshallableObject,
			lexicon.jaxb.impl.runtime.XMLSerializable,
			lexicon.jaxb.impl.runtime.ValidatableObject {
		...
		public lexicon.jaxb.impl.runtime.UnmarshallingEventHandler createUnmarshaller(
				lexicon.jaxb.impl.runtime.UnmarshallingContext context) {
			return new lexicon.jaxb.impl.WprefixLexiconTypeImpl.AddImpl.Unmarshaller(
					context);
		}
					...
					case 1:
						if (("dotted" == ___local) && ("" == ___uri)) {
							spawnHandlerFromEnterAttribute(
									(((lexicon.jaxb.impl.WprefixExceptionTypeImpl) lexicon.jaxb.impl.WprefixLexiconTypeImpl.AddImpl.this).new Unmarshaller(
	...
	public static class RemoveImpl extends
			lexicon.jaxb.impl.WprefixExceptionTypeImpl implements
			lexicon.jaxb.WprefixLexiconType.Remove, com.sun.xml.bind.RIElement,
			com.sun.xml.bind.JAXBObject,
			lexicon.jaxb.impl.runtime.UnmarshallableObject,
			lexicon.jaxb.impl.runtime.XMLSerializable,
			lexicon.jaxb.impl.runtime.ValidatableObject {
		...
		public lexicon.jaxb.impl.runtime.UnmarshallingEventHandler createUnmarshaller(
				lexicon.jaxb.impl.runtime.UnmarshallingContext context) {
			return new lexicon.jaxb.impl.WprefixLexiconTypeImpl.RemoveImpl.Unmarshaller(
					context);
		}
			...
			public void enterAttribute(java.lang.String ___uri,
				...
				outer: while (true) {
					...
					case 1:
						if (("dotted" == ___local) && ("" == ___uri)) {
							spawnHandlerFromEnterAttribute(
									(((lexicon.jaxb.impl.WprefixExceptionTypeImpl) lexicon.jaxb.impl.WprefixLexiconTypeImpl.RemoveImpl.this).new Unmarshaller(
											context)), 2, ___uri, ___local,
									___qname);
							return;
						}
	...
	public static class ReplaceImpl extends
		...
		public lexicon.jaxb.impl.runtime.UnmarshallingEventHandler createUnmarshaller(
				lexicon.jaxb.impl.runtime.UnmarshallingContext context) {
			return new lexicon.jaxb.impl.WprefixLexiconTypeImpl.ReplaceImpl.Unmarshaller(
					context);
		}
			...
			public void enterAttribute(java.lang.String ___uri,
				...
				outer: while (true) {
					...
					case 1:
						if (("dotted" == ___local) && ("" == ___uri)) {
							spawnHandlerFromEnterAttribute(
									(((lexicon.jaxb.impl.WprefixExceptionTypeImpl) lexicon.jaxb.impl.WprefixLexiconTypeImpl.ReplaceImpl.this).new Unmarshaller(
											context)), 2, ___uri, ___local,
									___qname);
							return;
						}
				...
				case 10:
					if (("add" == ___local) && ("" == ___uri)) {
						_getAddOrReplaceOrRemove()
								.add(((lexicon.jaxb.impl.WprefixLexiconTypeImpl.AddImpl) spawnChildFromEnterElement(
										(lexicon.jaxb.impl.WprefixLexiconTypeImpl.AddImpl.class),
										10, ___uri, ___local, ___qname, __atts)));
						return;
					}
					if (("replace" == ___local) && ("" == ___uri)) {
						_getAddOrReplaceOrRemove()
								.add(((lexicon.jaxb.impl.WprefixLexiconTypeImpl.ReplaceImpl) spawnChildFromEnterElement(
										(lexicon.jaxb.impl.WprefixLexiconTypeImpl.ReplaceImpl.class),
										10, ___uri, ___local, ___qname, __atts)));
						return;
					}
					if (("remove" == ___local) && ("" == ___uri)) {
						_getAddOrReplaceOrRemove()
								.add(((lexicon.jaxb.impl.WprefixLexiconTypeImpl.RemoveImpl) spawnChildFromEnterElement(
										(lexicon.jaxb.impl.WprefixLexiconTypeImpl.RemoveImpl.class),
										10, ___uri, ___local, ___qname, __atts)));
						return;
					}
