...
public class TransliterationTypeImpl implements
		lexicon.jaxb.TransliterationType, com.sun.xml.bind.JAXBObject,
	...
	public lexicon.jaxb.impl.runtime.UnmarshallingEventHandler createUnmarshaller(
		...
		return new lexicon.jaxb.impl.TransliterationTypeImpl.Unmarshaller(
				context);
	}
	...
	public static class StringTypeImpl implements
		...
		public lexicon.jaxb.impl.runtime.UnmarshallingEventHandler createUnmarshaller(
				lexicon.jaxb.impl.runtime.UnmarshallingContext context) {
			return new lexicon.jaxb.impl.TransliterationTypeImpl.StringTypeImpl.Unmarshaller(
					context);
		}
		...
		public void enterAttribute(java.lang.String ___uri,
			...
			outer: while (true) {
				...
				case 7:
					if (("hebrew" == ___local) && ("" == ___uri)) {
						_getString()
								.add(((lexicon.jaxb.impl.TransliterationTypeImpl.StringTypeImpl) spawnChildFromEnterAttribute(
										(lexicon.jaxb.impl.TransliterationTypeImpl.StringTypeImpl.class),
