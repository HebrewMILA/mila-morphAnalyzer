...
public class AcronymLexiconTypeImpl implements lexicon.jaxb.AcronymLexiconType,
	...
	public lexicon.jaxb.impl.runtime.UnmarshallingEventHandler createUnmarshaller(
		...
		return new lexicon.jaxb.impl.AcronymLexiconTypeImpl.Unmarshaller(
				context);
	}
	...
	public void serializeAttributes(
		...
		if (_AdjectiveLexicalLink != null) {
			...
			try {
				context.text(((java.lang.String) _AdjectiveLexicalLink),
		...
		if (_ConjunctionType != null) {
			...
			try {
				context.text(((java.lang.String) _ConjunctionType),
						"ConjunctionType");
			} catch (java.lang.Exception e) {
				lexicon.jaxb.impl.runtime.Util.handlePrintConversionException(
						this, e, context);
		...
		if (has_GenerateAdjective) {
			...
			try {
				context.text(javax.xml.bind.DatatypeConverter
						.printBoolean(((boolean) _GenerateAdjective)),
						"GenerateAdjective");
			} catch (java.lang.Exception e) {
				lexicon.jaxb.impl.runtime.Util.handlePrintConversionException(
						this, e, context);
		...
		if (_IstLexicalLink != null) {
			...
			try {
				context.text(((java.lang.String) _IstLexicalLink),
						"IstLexicalLink");
			} catch (java.lang.Exception e) {
				lexicon.jaxb.impl.runtime.Util.handlePrintConversionException(
						this, e, context);
		...
		if (_NiqLexicalLink != null) {
			...
			try {
				context.text(((java.lang.String) _NiqLexicalLink),
						"NiqLexicalLink");
			} catch (java.lang.Exception e) {
				lexicon.jaxb.impl.runtime.Util.handlePrintConversionException(
						this, e, context);
		...
		if (_NoInvertedCommas != null) {
			...
			try {
				context.text(((java.lang.String) _NoInvertedCommas),
						"NoInvertedCommas");
			} catch (java.lang.Exception e) {
				lexicon.jaxb.impl.runtime.Util.handlePrintConversionException(
						this, e, context);
		...
		if (_ProperNameType != null) {
			...
			try {
				context.text(((java.lang.String) _ProperNameType),
						"ProperNameType");
			} catch (java.lang.Exception e) {
				lexicon.jaxb.impl.runtime.Util.handlePrintConversionException(
						this, e, context);
	...
	public static class AddImpl extends
			lexicon.jaxb.impl.AcronymExceptionTypeImpl implements
			lexicon.jaxb.AcronymLexiconType.Add, com.sun.xml.bind.RIElement,
			com.sun.xml.bind.JAXBObject,
			lexicon.jaxb.impl.runtime.UnmarshallableObject,
			lexicon.jaxb.impl.runtime.XMLSerializable,
			lexicon.jaxb.impl.runtime.ValidatableObject {
		...
		public lexicon.jaxb.impl.runtime.UnmarshallingEventHandler createUnmarshaller(
				lexicon.jaxb.impl.runtime.UnmarshallingContext context) {
			return new lexicon.jaxb.impl.AcronymLexiconTypeImpl.AddImpl.Unmarshaller(
					context);
		}
					...
					case 1:
						if (("conjunctionType" == ___local) && ("" == ___uri)) {
							spawnHandlerFromEnterAttribute(
									(((lexicon.jaxb.impl.AcronymExceptionTypeImpl) lexicon.jaxb.impl.AcronymLexiconTypeImpl.AddImpl.this).new Unmarshaller(
	...
	public static class RemoveImpl extends
			lexicon.jaxb.impl.AcronymExceptionTypeImpl implements
			lexicon.jaxb.AcronymLexiconType.Remove, com.sun.xml.bind.RIElement,
			com.sun.xml.bind.JAXBObject,
			lexicon.jaxb.impl.runtime.UnmarshallableObject,
			lexicon.jaxb.impl.runtime.XMLSerializable,
			lexicon.jaxb.impl.runtime.ValidatableObject {
		...
		public lexicon.jaxb.impl.runtime.UnmarshallingEventHandler createUnmarshaller(
				lexicon.jaxb.impl.runtime.UnmarshallingContext context) {
			return new lexicon.jaxb.impl.AcronymLexiconTypeImpl.RemoveImpl.Unmarshaller(
					context);
		}
			...
			public void enterAttribute(java.lang.String ___uri,
				...
				outer: while (true) {
					...
					case 1:
						if (("conjunctionType" == ___local) && ("" == ___uri)) {
							spawnHandlerFromEnterAttribute(
									(((lexicon.jaxb.impl.AcronymExceptionTypeImpl) lexicon.jaxb.impl.AcronymLexiconTypeImpl.RemoveImpl.this).new Unmarshaller(
											context)), 2, ___uri, ___local,
									___qname);
							return;
						}
	...
	public static class ReplaceImpl extends
		...
		public lexicon.jaxb.impl.runtime.UnmarshallingEventHandler createUnmarshaller(
				lexicon.jaxb.impl.runtime.UnmarshallingContext context) {
			return new lexicon.jaxb.impl.AcronymLexiconTypeImpl.ReplaceImpl.Unmarshaller(
					context);
		}
			...
			public void enterAttribute(java.lang.String ___uri,
				...
				outer: while (true) {
					...
					case 1:
						if (("conjunctionType" == ___local) && ("" == ___uri)) {
							spawnHandlerFromEnterAttribute(
									(((lexicon.jaxb.impl.AcronymExceptionTypeImpl) lexicon.jaxb.impl.AcronymLexiconTypeImpl.ReplaceImpl.this).new Unmarshaller(
											context)), 2, ___uri, ___local,
									___qname);
							return;
						}
				...
				case 49:
					if (("add" == ___local) && ("" == ___uri)) {
						_getAddOrReplaceOrRemove()
								.add(((lexicon.jaxb.impl.AcronymLexiconTypeImpl.AddImpl) spawnChildFromEnterElement(
										(lexicon.jaxb.impl.AcronymLexiconTypeImpl.AddImpl.class),
										49, ___uri, ___local, ___qname, __atts)));
						return;
					}
					if (("replace" == ___local) && ("" == ___uri)) {
						_getAddOrReplaceOrRemove()
								.add(((lexicon.jaxb.impl.AcronymLexiconTypeImpl.ReplaceImpl) spawnChildFromEnterElement(
										(lexicon.jaxb.impl.AcronymLexiconTypeImpl.ReplaceImpl.class),
										49, ___uri, ___local, ___qname, __atts)));
						return;
					}
					if (("remove" == ___local) && ("" == ___uri)) {
						_getAddOrReplaceOrRemove()
								.add(((lexicon.jaxb.impl.AcronymLexiconTypeImpl.RemoveImpl) spawnChildFromEnterElement(
										(lexicon.jaxb.impl.AcronymLexiconTypeImpl.RemoveImpl.class),
										49, ___uri, ___local, ___qname, __atts)));
						return;
					}
