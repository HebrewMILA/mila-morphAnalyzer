...
public class LexiconTypeImpl implements lexicon.jaxb.LexiconType,
			...
			outer: while (true) {
				...
				case 1:
					if (("name" == ___local) && ("" == ___uri)) {
						_Metadata = ((lexicon.jaxb.impl.MetadataTypeImpl) spawnChildFromEnterElement(
								(lexicon.jaxb.impl.MetadataTypeImpl.class), 2,
			...
			outer: while (true) {
				...
				case 4:
					if (("dotted" == ___local) && ("" == ___uri)) {
						_getItem()
								.add(((lexicon.jaxb.impl.ItemTypeImpl) spawnChildFromEnterAttribute(
										(lexicon.jaxb.impl.ItemTypeImpl.class),
										5, ___uri, ___local, ___qname)));
						return;
					}
