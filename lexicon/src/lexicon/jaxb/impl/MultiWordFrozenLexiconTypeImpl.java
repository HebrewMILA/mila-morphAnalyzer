...
public class MultiWordFrozenLexiconTypeImpl implements
		lexicon.jaxb.MultiWordFrozenLexiconType, com.sun.xml.bind.JAXBObject,
	...
	public lexicon.jaxb.impl.runtime.UnmarshallingEventHandler createUnmarshaller(
		...
		return new lexicon.jaxb.impl.MultiWordFrozenLexiconTypeImpl.Unmarshaller(
				context);
	}
	...
	public void serializeAttributes(
		...
		if (has_AcceptDefiniteness) {
			...
			try {
				context.text(javax.xml.bind.DatatypeConverter
						.printBoolean(((boolean) _AcceptDefiniteness)),
						"AcceptDefiniteness");
		...
		if (has_Base2) {
			...
			try {
				context.text(javax.xml.bind.DatatypeConverter
						.printBoolean(((boolean) _Base2)), "Base2");
			} catch (java.lang.Exception e) {
				lexicon.jaxb.impl.runtime.Util.handlePrintConversionException(
						this, e, context);
			}
		...
		if (has_Construct1) {
			...
			try {
				context.text(javax.xml.bind.DatatypeConverter
						.printBoolean(((boolean) _Construct1)), "Construct1");
			} catch (java.lang.Exception e) {
				lexicon.jaxb.impl.runtime.Util.handlePrintConversionException(
						this, e, context);
			}
		...
		if (has_Definiteness) {
			...
			try {
				context.text(javax.xml.bind.DatatypeConverter
						.printBoolean(((boolean) _Definiteness)),
						"Definiteness");
			} catch (java.lang.Exception e) {
				lexicon.jaxb.impl.runtime.Util.handlePrintConversionException(
						this, e, context);
		...
		if (has_Possessive2) {
			...
			try {
				context.text(javax.xml.bind.DatatypeConverter
						.printBoolean(((boolean) _Possessive2)), "Possessive2");
			} catch (java.lang.Exception e) {
				lexicon.jaxb.impl.runtime.Util.handlePrintConversionException(
						this, e, context);
			}
		...
		if (has_Prefix) {
			...
			try {
				context.text(javax.xml.bind.DatatypeConverter
						.printBoolean(((boolean) _Prefix)), "Prefix");
			} catch (java.lang.Exception e) {
				lexicon.jaxb.impl.runtime.Util.handlePrintConversionException(
						this, e, context);
			}
	...
	public static class AddImpl extends
			lexicon.jaxb.impl.MultiWordFrozenExceptionTypeImpl implements
		...
		public lexicon.jaxb.impl.runtime.UnmarshallingEventHandler createUnmarshaller(
				lexicon.jaxb.impl.runtime.UnmarshallingContext context) {
			return new lexicon.jaxb.impl.MultiWordFrozenLexiconTypeImpl.AddImpl.Unmarshaller(
					context);
		}
		...
		public class Unmarshaller extends
			...
			public void enterAttribute(java.lang.String ___uri,
				...
				outer: while (true) {
					switch (state) {
					case 1:
						if (("acceptDefiniteness" == ___local)
								&& ("" == ___uri)) {
							spawnHandlerFromEnterAttribute(
									(((lexicon.jaxb.impl.MultiWordFrozenExceptionTypeImpl) lexicon.jaxb.impl.MultiWordFrozenLexiconTypeImpl.AddImpl.this).new Unmarshaller(
	...
	public static class RemoveImpl extends
		...
		public lexicon.jaxb.impl.runtime.UnmarshallingEventHandler createUnmarshaller(
				lexicon.jaxb.impl.runtime.UnmarshallingContext context) {
			return new lexicon.jaxb.impl.MultiWordFrozenLexiconTypeImpl.RemoveImpl.Unmarshaller(
					context);
		}
				...
				outer: while (true) {
					...
					case 1:
						if (("acceptDefiniteness" == ___local)
								&& ("" == ___uri)) {
							spawnHandlerFromEnterAttribute(
									(((lexicon.jaxb.impl.MultiWordFrozenExceptionTypeImpl) lexicon.jaxb.impl.MultiWordFrozenLexiconTypeImpl.RemoveImpl.this).new Unmarshaller(
											context)), 2, ___uri, ___local,
									___qname);
							return;
						}
	...
	public static class ReplaceImpl extends
		...
		public lexicon.jaxb.impl.runtime.UnmarshallingEventHandler createUnmarshaller(
				lexicon.jaxb.impl.runtime.UnmarshallingContext context) {
			return new lexicon.jaxb.impl.MultiWordFrozenLexiconTypeImpl.ReplaceImpl.Unmarshaller(
					context);
		}
				...
				outer: while (true) {
					...
					case 1:
						if (("acceptDefiniteness" == ___local)
								&& ("" == ___uri)) {
							spawnHandlerFromEnterAttribute(
									(((lexicon.jaxb.impl.MultiWordFrozenExceptionTypeImpl) lexicon.jaxb.impl.MultiWordFrozenLexiconTypeImpl.ReplaceImpl.this).new Unmarshaller(
											context)), 2, ___uri, ___local,
									___qname);
							return;
						}
	...
	public class Unmarshaller extends
				...
				case 30:
					if (("add" == ___local) && ("" == ___uri)) {
						_getAddOrReplaceOrRemove()
								.add(((lexicon.jaxb.impl.MultiWordFrozenLexiconTypeImpl.AddImpl) spawnChildFromEnterElement(
										(lexicon.jaxb.impl.MultiWordFrozenLexiconTypeImpl.AddImpl.class),
										31, ___uri, ___local, ___qname, __atts)));
						return;
					}
					if (("replace" == ___local) && ("" == ___uri)) {
						_getAddOrReplaceOrRemove()
								.add(((lexicon.jaxb.impl.MultiWordFrozenLexiconTypeImpl.ReplaceImpl) spawnChildFromEnterElement(
										(lexicon.jaxb.impl.MultiWordFrozenLexiconTypeImpl.ReplaceImpl.class),
										31, ___uri, ___local, ___qname, __atts)));
						return;
					}
					if (("remove" == ___local) && ("" == ___uri)) {
						_getAddOrReplaceOrRemove()
								.add(((lexicon.jaxb.impl.MultiWordFrozenLexiconTypeImpl.RemoveImpl) spawnChildFromEnterElement(
										(lexicon.jaxb.impl.MultiWordFrozenLexiconTypeImpl.RemoveImpl.class),
										31, ___uri, ___local, ___qname, __atts)));
						return;
					}
					state = 31;
		...
		private void eatText2(final java.lang.String value)
				throws org.xml.sax.SAXException {
			try {
				_AcceptDefiniteness = javax.xml.bind.DatatypeConverter
						.parseBoolean(com.sun.xml.bind.WhiteSpaceProcessor
								.collapse(value));
				has_AcceptDefiniteness = true;
			} catch (java.lang.Exception e) {
		...
		private void eatText9(final java.lang.String value)
				throws org.xml.sax.SAXException {
			try {
				_Prefix = javax.xml.bind.DatatypeConverter
						.parseBoolean(com.sun.xml.bind.WhiteSpaceProcessor
								.collapse(value));
				has_Prefix = true;
			} catch (java.lang.Exception e) {
