...
public class LexiconImpl extends lexicon.jaxb.impl.LexiconTypeImpl implements
		lexicon.jaxb.Lexicon, com.sun.xml.bind.RIElement,
				...
				case 1:
					if (("metadata" == ___local) && ("" == ___uri)) {
						spawnHandlerFromEnterElement(
								(((lexicon.jaxb.impl.LexiconTypeImpl) lexicon.jaxb.impl.LexiconImpl.this).new Unmarshaller(
