...
public class QuantifierLexiconTypeImpl implements
		lexicon.jaxb.QuantifierLexiconType, com.sun.xml.bind.JAXBObject,
	...
	public lexicon.jaxb.impl.runtime.UnmarshallingEventHandler createUnmarshaller(
		...
		return new lexicon.jaxb.impl.QuantifierLexiconTypeImpl.Unmarshaller(
				context);
	}
		...
		if (schemaFragment == null) {
			schemaFragment = com.sun.xml.bind.validator.SchemaDeserializer
					.deserialize(("\u00ac\u00ed\u0000\u0005sr\u0000\u001fcom.sun.msv.grammar.SequenceExp\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xr\u0000\u001dcom.su"
							...
							+ "pq\u0000~\u0000\u000fq\u0000~\u0000`q\u0000~\u0000\u000eq\u0000~\u0000\u0007q\u0000~\u0000iq\u0000~\u0000\u0017q\u0000~\u0000*q\u0000~\u00001q\u0000~\u0000\u0005q\u0000~\u0000\u000bq\u0000~\u00006q\u0000~\u0000"
							+ "\u0010q\u0000~\u0000(q\u0000~\u0000/q\u0000~\u0000\u0006q\u0000~\u0000\rq\u0000~\u0000oq\u0000~\u0000\bq\u0000~\u0000\u0018q\u0000~\u0000+q\u0000~\u00002x"));
		}
	...
	public static class AddImpl extends
			lexicon.jaxb.impl.QuantifierExceptionTypeImpl implements
			lexicon.jaxb.QuantifierLexiconType.Add, com.sun.xml.bind.RIElement,
		...
		public lexicon.jaxb.impl.runtime.UnmarshallingEventHandler createUnmarshaller(
				lexicon.jaxb.impl.runtime.UnmarshallingContext context) {
			return new lexicon.jaxb.impl.QuantifierLexiconTypeImpl.AddImpl.Unmarshaller(
					context);
		}
			...
			if (schemaFragment == null) {
				schemaFragment = com.sun.xml.bind.validator.SchemaDeserializer
						.deserialize(("\u00ac\u00ed\u0000\u0005sr\u0000\'com.sun.msv.grammar.trex.ElementPattern\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001L\u0000"
								...
								+ "essionPool;xp\u0000\u0000\u0000\u0014\u0001pq\u0000~\u0000\u009eq\u0000~\u0000*q\u0000~\u0000\nq\u0000~\u0000\u000fq\u0000~\u0000\u0010q\u0000~\u0000Oq\u0000~\u0000Gq\u0000~\u0000\fq"
								+ "\u0000~\u0000\u0013q\u0000~\u0000\u0012q\u0000~\u0000\u0011q\u0000~\u0000\\q\u0000~\u0000\u000eq\u0000~\u0000\u0081q\u0000~\u0000\u008dq\u0000~\u0000eq\u0000~\u0000\tq\u0000~\u0000\u000bq\u0000~\u0000Kq\u0000~\u0000\rx"));
			}
			return new com.sun.msv.verifier.regexp.REDocumentDeclaration(
					schemaFragment);
		}
					...
					case 1:
						if (("acronym" == ___local) && ("" == ___uri)) {
							spawnHandlerFromEnterAttribute(
									(((lexicon.jaxb.impl.QuantifierExceptionTypeImpl) lexicon.jaxb.impl.QuantifierLexiconTypeImpl.AddImpl.this).new Unmarshaller(
	...
	public static class RemoveImpl extends
			lexicon.jaxb.impl.QuantifierExceptionTypeImpl implements
			lexicon.jaxb.QuantifierLexiconType.Remove,
		...
		public lexicon.jaxb.impl.runtime.UnmarshallingEventHandler createUnmarshaller(
				lexicon.jaxb.impl.runtime.UnmarshallingContext context) {
			return new lexicon.jaxb.impl.QuantifierLexiconTypeImpl.RemoveImpl.Unmarshaller(
					context);
		}
			...
			public void enterAttribute(java.lang.String ___uri,
				...
				outer: while (true) {
					...
					case 1:
						if (("acronym" == ___local) && ("" == ___uri)) {
							spawnHandlerFromEnterAttribute(
									(((lexicon.jaxb.impl.QuantifierExceptionTypeImpl) lexicon.jaxb.impl.QuantifierLexiconTypeImpl.RemoveImpl.this).new Unmarshaller(
											context)), 2, ___uri, ___local,
									___qname);
							return;
						}
	...
	public static class ReplaceImpl extends
			lexicon.jaxb.impl.QuantifierExceptionTypeImpl implements
			lexicon.jaxb.QuantifierLexiconType.Replace,
			com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject,
			lexicon.jaxb.impl.runtime.UnmarshallableObject,
			lexicon.jaxb.impl.runtime.XMLSerializable,
			lexicon.jaxb.impl.runtime.ValidatableObject {
		...
		public lexicon.jaxb.impl.runtime.UnmarshallingEventHandler createUnmarshaller(
				lexicon.jaxb.impl.runtime.UnmarshallingContext context) {
			return new lexicon.jaxb.impl.QuantifierLexiconTypeImpl.ReplaceImpl.Unmarshaller(
					context);
		}
			...
			public void enterAttribute(java.lang.String ___uri,
				...
				outer: while (true) {
					...
					case 1:
						if (("acronym" == ___local) && ("" == ___uri)) {
							spawnHandlerFromEnterAttribute(
									(((lexicon.jaxb.impl.QuantifierExceptionTypeImpl) lexicon.jaxb.impl.QuantifierLexiconTypeImpl.ReplaceImpl.this).new Unmarshaller(
											context)), 2, ___uri, ___local,
									___qname);
							return;
						}
				...
				case 13:
					if (("add" == ___local) && ("" == ___uri)) {
						_getAddOrReplaceOrRemove()
								.add(((lexicon.jaxb.impl.QuantifierLexiconTypeImpl.AddImpl) spawnChildFromEnterElement(
										(lexicon.jaxb.impl.QuantifierLexiconTypeImpl.AddImpl.class),
										13, ___uri, ___local, ___qname, __atts)));
						return;
					}
					if (("replace" == ___local) && ("" == ___uri)) {
						_getAddOrReplaceOrRemove()
								.add(((lexicon.jaxb.impl.QuantifierLexiconTypeImpl.ReplaceImpl) spawnChildFromEnterElement(
										(lexicon.jaxb.impl.QuantifierLexiconTypeImpl.ReplaceImpl.class),
										13, ___uri, ___local, ___qname, __atts)));
						return;
					}
					if (("remove" == ___local) && ("" == ___uri)) {
						_getAddOrReplaceOrRemove()
								.add(((lexicon.jaxb.impl.QuantifierLexiconTypeImpl.RemoveImpl) spawnChildFromEnterElement(
										(lexicon.jaxb.impl.QuantifierLexiconTypeImpl.RemoveImpl.class),
										13, ___uri, ___local, ___qname, __atts)));
						return;
					}
