...
public class MultiWordPrepositionLexiconTypeImpl implements
	...
	public lexicon.jaxb.impl.runtime.UnmarshallingEventHandler createUnmarshaller(
		...
		return new lexicon.jaxb.impl.MultiWordPrepositionLexiconTypeImpl.Unmarshaller(
				context);
	}
		...
		if (has_Base1) {
			...
			try {
				context.text(javax.xml.bind.DatatypeConverter
						.printBoolean(((boolean) _Base1)), "Base1");
