...
public class LSecurityException extends AException {
	 ...
	 * @param thePage	The page where the security problem occured
	 */
	public LSecurityException(String reason, HttpServletRequest req, boolean deniedAccess)	{
		super(reason);
		setServletRequest(req);
		return;
	}
	...
	public void setServletRequest(HttpServletRequest req)	{
		if (req != null)	{
			servletRequest = req;
			page = servletRequest.getServletPath();
		}		
	}
	
	/**
	 * Sets the name of the page
	 * @param thePage	THe name of the page where the security breach occured.
	 */
