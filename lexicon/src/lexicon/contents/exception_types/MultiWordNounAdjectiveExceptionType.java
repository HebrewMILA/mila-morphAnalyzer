...
public class MultiWordNounAdjectiveExceptionType extends Content implements lexicon.jaxb.MultiWordNounAdjectiveExceptionType 
	{
...
///-----------------------------------------------------------------------------------------------------------------------------------
	public String GetExceptionHtml()
	{
		...
		html += "<tr><td>צורה לא מנוקדת:</td>"
			+ "<td><input type='text' name='multiWordNounAdjective_exception_undotted' size=20 value='"+getUndotted().trim()+"'></td></tr>"
			+ "<tr><td>צורת תעתיק:</td>"
			+ "<td>"+getTransliterated() + "</td></tr>"
			+ "<tr><td>צורה מנוקדת:</td>"
			+ "<td><input type='text' name='multiWordNounAdjective_exception_dotted' size=20 value='"+getDotted().trim()+"'></td></tr>"
			+ "<tr><td>משלב:</td><td>"
