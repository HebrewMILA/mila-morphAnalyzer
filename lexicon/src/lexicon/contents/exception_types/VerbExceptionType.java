 ...
 * 
 */
public class VerbExceptionType extends Content implements
	...
	public String GetExceptionHtml() {
		...
		html += "<tr><td>צורה לא מנוקדת:</td>"
				+ "<td><input type='text' name='verb_exception_undotted' size=20 value='"
		...
		html += "<tr><td>צורה מנוקדת:</td>"
				+ "<td><input type='text' name='verb_exception_dotted' size=20 value='"
