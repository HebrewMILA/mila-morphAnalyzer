...
public class MultiWordNounExceptionType extends Content implements
	...
	public MultiWordNounExceptionType() {
		content = new lexicon.jaxb.impl.MultiWordNounExceptionTypeImpl();
		TABLE = "multiWordNoun_exception_type";
		IDNAME = "aid";
	}

	public lexicon.jaxb.impl.MultiWordNounExceptionTypeImpl getImpl() {
		return (lexicon.jaxb.impl.MultiWordNounExceptionTypeImpl) content;
	}
...
///-----------------------------------------------------------------------------------------------------------------------------------
	public String GetExceptionHtml()
	{
		...
		html = "<tr><td>פעולה:</td>"
			+ "<td><select name=\'multiWordNoun_exception_action\'>"
		...
		html += "<tr><td>צורה לא מנוקדת:</td>"
			+ "<td><input type='text' name='multiWordNoun_exception_undotted' size=20 value='"+getUndotted().trim()+"'></td></tr>"
			+ "<tr><td>צורת תעתיק:</td>"
			+ "<td>"+getTransliterated() + "</td></tr>"
			+ "<tr><td>צורה מנוקדת:</td>"
			+ "<td><input type='text' name='multiWordNoun_exception_dotted' size=20 value='"+getDotted().trim()+"'></td></tr>"
			+ "<tr><td>משלב:</td><td>"
		...
		html +="<tr><td>מין:</td>"
            ...
            + "</select></td></tr>";
		html +="<tr><td>מספר:</td>" +
			"<td><select name='multiWordNoun_exception_number'>" +
		...
		html +="<tr><td>צורן נקבה:</td>" +
			"<td><select name='multiWordNoun_exception_feminine'>" +
		...
		html +="<tr><td>צורן ריבוי:</td>" +
			"<td><select name='multiWordNoun_exception_plural'>" +
			...
			"</select></td></tr>";
		html +="<tr><td>יידוע:</td>" +
			"<td><select name='multiWordNoun_exception_definiteness'>" +
			...
			"<option value='internal and external' "+definiteness_both_sell+">ייצר יידוע פנימי וגם חיצוני</option>" +
			"<option value='none' "+definiteness_none_sell+">אל תייצר שום יידוע</option>" +
			"<option value='externallyDefinited' "+definiteness_externallyDefinited_sell+">קיימת הצורה החיצונית מיודעת בלבד</option>" +
			"</select></td></tr>";
		...
		html +="<tr><td>כינוי קניין חבור?</td>" +
			"<td><select name='multiWordNoun_exception_possessive'>" +
		...
		html +="<tr><td>האם לייצר קניין לצורת היחיד?</td>" +
			"<td><select name='multiWordNoun_exception_inflectPossessiveS'>" +
		...
		html +="<tr><td>האם לייצר קניין לצורת הרבים?</td>" +
			"<td><select name='multiWordNoun_exception_inflectPossessiveP'>" +
