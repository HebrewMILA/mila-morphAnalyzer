 ...
 *         Window - Preferences - Java - Code Style - Code Templates
 */
public class CopulaExceptionType extends Content implements
		lexicon.jaxb.CopulaExceptionType {
	...
	public String GetExceptionHtml() {
		...
		html += "<tr><td>צורה לא מנוקדת:</td>"
				+ "<td><input type='text' name='copula_exception_undotted' size=20 value='"
		...
		html += "<tr><td>צורה מנוקדת:</td>"
				+ "<td><input type='text' name='copula_exception_dotted' size=20 value='"
		...
		html += "<tr><td>זמן:</td>"
				...
				+ ">לא מוגדר</option>" + "<option value='past' "
				+ tense_past_sel + ">עבר</option>" + "<option value='beinoni' "
				+ tense_beinoni_sel + ">הווה</option>"
				+ "<option value='future' " + tense_future_sel
				+ ">עתיד</option>" + "<option value='imperative' "
				+ tense_imperative_sel + ">ציווי</option>"
				+ "<option value='infinitive' " + tense_infinitive_sel
				+ ">שם הפועל</option>" + "<option value='bareInfinitive' "
				+ tense_bareInfinitive_sel + ">מקור</option>"
				+ "</select></td></tr>";
		return html;
	}
}
