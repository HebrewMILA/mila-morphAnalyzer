 ...
 * 
 */
public class MultiWordVerbPhraseExceptionType extends Content implements
		lexicon.jaxb.MultiWordVerbPhraseExceptionType {
	protected lexicon.jaxb.MultiWordVerbPhraseExceptionType content;

	public MultiWordVerbPhraseExceptionType(
			lexicon.jaxb.MultiWordVerbPhraseExceptionType content) {
		this.content = content;
		TABLE = "multiWordVerbPhrase_exception_type";
		IDNAME = "aid";
	}

	public MultiWordVerbPhraseExceptionType() {
		content = new lexicon.jaxb.impl.MultiWordVerbPhraseExceptionTypeImpl();
		TABLE = "MultiWordVerbPhrase_exception_type";
		IDNAME = "aid";
	}

	public lexicon.jaxb.impl.MultiWordVerbPhraseExceptionTypeImpl getImpl() {
		return (lexicon.jaxb.impl.MultiWordVerbPhraseExceptionTypeImpl) content;
	}
	...
	public String GetExceptionHtml() {
		...
		html = "<tr><td>פעולה:</td>"
				+ "<td><select name=\'multiWordVerbPhrase_exception_action\'>"
		...
		html += "<tr><td>צורה לא מנוקדת:</td>"
				+ "<td><input type='text' name='multiWordVerbPhrase_exception_undotted' size=20 value='"
		...
		html += "<tr><td>צורה מנוקדת:</td>"
				+ "<td><input type='text' name='multiWordVerbPhrase_exception_dotted' size=20 value='"
				+ getDotted().trim() + "'></td></tr>"
				+ "<tr><td>משלב:</td><td>"
				+ "<select name='multiWordVerbPhrase_exception_register'>"
		...
		html += "<tr><td>כתיב:</td>"
				+ "<td><select name='multiWordVerbPhrase_exception_spelling'>"
		...
		html += "<tr><td>זמן:</td>"
				+ "<td><select name='multiWordVerbPhrase_exception_tense'>"
				+ "<option value='past' " + verb_past_sel + ">עבר</option>"
				+ "<option value='beinoni' " + verb_beinoni_sel
				+ ">בינוני</option>" + "<option value='future' "
				+ verb_future_sel + ">עתיד</option>"
				+ "<option value='imperative' " + verb_imperative_sel
				+ ">ציווי</option>"
				...
				// +
				"<option value='bareInfinitive' " + verb_bareInfinitive_sel
				+ ">מקור</option>" + "<option value='passiveParticiple' "
				+ verb_passiveParticiple_sel + ">בינוני פעול</option>"
				+ "</select></td></tr>";
		...
		html += "<tr><td>מין:</td>"
				+ "<td><select name='multiWordVerbPhrase_exception_gender'>"
		...
		html += "<tr><td>מספר:</td>"
				+ "<td><select name='multiWordVerbPhrase_exception_number'>"
		...
		html += "<tr><td>גוף:</td>"
				+ "<td><select name='multiWordVerbPhrase_exception_person'>"
		...
		html += "<tr><td>גוף/מין/מספר עבור שם פועל מוטה:</td>"
				+ "<td><select name='multiWordVerbPhrase_exception_pgn'>"
				+ "<option value='1p/M/Sg' "
				+ personGenderNumber_1p_M_Sg_sel
				+ ">גוף ראשון / זכר / יחיד</option>"
				+ "<option value='1p/F/Sg' <"
				+ personGenderNumber_1p_F_Sg_sel
				+ ">גוף ראשון / נקבה / יחיד</option>"
				...
				+ "<option value='2p/MF/Pl' "
				+ personGenderNumber_2p_MF_Pl_sel
				+ ">גוף שני / זכר וגם נקבה / רבים</option>"
		...
		html += "<tr><td>האם צורת בינוני נסמך?</td>"
				+ "<td><select name='multiWordVerbPhrase_exception_beinoniConstruct'> "
				+ "<option value='1' " + (isBeinoniConstruct ? "SELECTED" : "")
				+ ">כן</option>" + "<option value='0' "
				+ (isBeinoniConstruct ? "" : "SELECTED") + ">לא</option> "
				+ "</select></td></tr>";

		boolean isBeinoniDefiniteness = isBeinoniDefiniteness();
		html += "<tr><td> האם צורת בינוני שיש לייצר עבורה יידוע?</td>"
				+ "<td><select name='multiWordVerbPhrase_exception_beinoniDefiniteness'> "
				+ "<option value='1' "
				+ (isBeinoniDefiniteness ? "SELECTED" : "") + ">כן</option>"
				+ "<option value='0' "
				+ (isBeinoniDefiniteness ? "" : "SELECTED") + ">לא</option>"
				+ "</select></td></tr>";

		boolean isInflectBeinoniPossessive = isInflectBeinoniPossessive();
		html += "<tr><td>האם לייצר הטיות לצורת הבינוני?</td>"
				+ "<td><select name='multiWordVerbPhrase_exception_inflectBeinoniPossessive'>"
				+ "<option value='1' "
				+ (isInflectBeinoniPossessive ? "SELECTED" : "")
				+ ">כן</option>" + "<option value='0' "
				+ (isInflectBeinoniPossessive ? "" : "SELECTED")
