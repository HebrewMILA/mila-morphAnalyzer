 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class ExistentialExceptionType extends Content implements lexicon.jaxb.ExistentialExceptionType{
	protected lexicon.jaxb.ExistentialExceptionType content; 
	
	public ExistentialExceptionType(lexicon.jaxb.ExistentialExceptionType content) {
  ...
  ///-----------------------------------------------------------------------------------------------------------------------------------
	public String GetExceptionHtml()
	{
		...
		html += "<tr><td>צורה לא מנוקדת:</td>"
			+ "<td><input type='text' name='existential_exception_undotted' size=20 value='"+getUndotted().trim()+"'></td></tr>";
		...
		html += "<tr><td>צורה מנוקדת:</td>"
			+ "<td><input type='text' name='existential_exception_dotted' size=20 value='"+getDotted().trim()+"'></td></tr>"
			+ "<tr><td>משלב:</td><td>"
		...
		html +="<tr><td>זמן:</td>" +
			...
			"<option value='beinoni' "+tense_present_sel+">הווה</option>" +
