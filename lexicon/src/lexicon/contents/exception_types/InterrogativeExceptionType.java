 ...
 * 
 */
public class InterrogativeExceptionType extends Content implements
	...
	public InterrogativeExceptionType(
			lexicon.jaxb.InterrogativeExceptionType content) {
	...
	public String GetExceptionHtml() {
		...
		html += "<tr><td>צורה לא מנוקדת:</td>"
				+ "<td><input type='text' name='interrogative_exception_undotted' size=20 value='"
		...
		html += "<tr><td>צורה מנוקדת:</td>"
				+ "<td><input type='text' name='interrogative_exception_dotted' size=20 value='"
