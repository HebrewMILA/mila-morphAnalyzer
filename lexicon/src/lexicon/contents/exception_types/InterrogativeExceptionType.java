 ...
 * <p>The following schema fragment specifies the expected content contained within this java content object. (defined at file:/C:/hebrew_lexicon.xsd line 1101)
 * <p>
 * <pre>
...
public class InterrogativeExceptionType   extends Content implements lexicon.jaxb.InterrogativeExceptionType{
  ...
  ///-----------------------------------------------------------------------------------------------------------------------------------
	public String GetExceptionHtml()
	{
		...
		html = "<tr><td>פעולה:</td>"
			+ "<td><select name=\'interrogative_exception_action\'>"
		...
		html += "<tr><td>צורה לא מנוקדת:</td>"
			+ "<td><input type='text' name='interrogative_exception_undotted' size=20 value='"+getUndotted().trim()+"'></td></tr>";
		...
		html += "<tr><td>צורה מנוקדת:</td>"
			+ "<td><input type='text' name='interrogative_exception_dotted' size=20 value='"+getDotted().trim()+"'></td></tr>"
			+ "<tr><td>משלב:</td><td>"
			+ "<select name='interrogative_exception_register'>"
		...
		html += "<tr><td>כתיב:</td>"
			+ "<td><select name='interrogative_exception_spelling'>"
	...
	//  person Gender Number drop down
		...
		//String pgn = getPgn();
		String pgn = getPersonGenderNumber();
		...
		html +="<tr><td>נטיית שייכות חבורה:</td>" +
			"<td><select name='interrogative_exception_personGenderNumber'>" +
