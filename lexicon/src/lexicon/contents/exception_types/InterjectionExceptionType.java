 ...
 * this java content object. (defined at file:/C:/hebrew_lexicon.xsd line 1169)
 * <p>
 * 
 * <pre>
 ...
 * 
 */
public class InterjectionExceptionType extends Content implements
	...
	public InterjectionExceptionType(
			lexicon.jaxb.InterjectionExceptionType content) {
	...
	public String GetExceptionHtml() {
		...
		html = "<tr><td>פעולה:</td>"
				+ "<td><select name=\'interjection_exception_action\'>"
		...
		html += "<tr><td>צורה לא מנוקדת:</td>"
				+ "<td><input type='text' name='interjection_exception_undotted' size=20 value='"
		...
		html += "<tr><td>צורה מנוקדת:</td>"
				+ "<td><input type='text' name='interjection_exception_dotted' size=20 value='"
		...
		html += "<tr><td>כתיב:</td>"
				+ "<td><select name='interjection_exception_spelling'>"
		...
		else if (getPersonGenderNumber().equals("3p/F/Pl"))
			personGenderNumber_3p_F_Pl_sel = "SELECTED";
		else if (getPersonGenderNumber().equals("123p/M/Sg"))
			personGenderNumber_123p_M_Sg_sel = "SELECTED";
		else if (getPersonGenderNumber().equals("123p/F/Sg"))
			personGenderNumber_123p_F_Sg_sel = "SELECTED";
		else if (getPersonGenderNumber().equals("123p/M/Pl"))
			personGenderNumber_123p_M_Pl_sel = "SELECTED";
		else
			personGenderNumber_123p_F_Pl_sel = "SELECTED";

		html += "<tr><td>כינוי קניין חבור?</td>"
				+ "<td><select name='interjection_exception_personGenderNumber'>"
