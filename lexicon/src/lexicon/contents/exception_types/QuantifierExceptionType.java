  ...
  ///-----------------------------------------------------------------------------------------------------------------------------------
	public String GetExceptionHtml()
	{
		...
		html += "<tr><td>צורה לא מנוקדת:</td>"
			+ "<td><input type='text' name='quantifier_exception_undotted' size=20 value='"+getUndotted().trim()+"'></td></tr>";
		...
		html += "<tr><td>צורה מנוקדת:</td>"
			+ "<td><input type='text' name='quantifier_exception_dotted' size=20 value='"+getDotted().trim()+"'></td></tr>"
			+ "<tr><td>משלב:</td><td>"
	...
	//  person Gender Number drop down
		...
		html +="<tr><td>האם ראשי תיבות?</td>" +
			...
			"<option value='unspecified' "+acronym_unspecified_sel+">לא מוגדר</option>" +
			"<option value='true' "+acronym_true_sel+">כן</option>" +
			"<option value='false' "+acronym_false_sel+">לא</option>" +
			"</select></td></tr>";
