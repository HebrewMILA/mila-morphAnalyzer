 ...
 * <p>The following schema fragment specifies the expected content contained within this java content object. (defined at file:/C:/hebrew_lexicon.xsd line 816)
 * <p>
 * <pre>
 ...
 * 
 */
public class AdverbExceptionType  extends Content implements lexicon.jaxb.AdverbExceptionType{
	...
	*/
     ...
     *     {@link java.lang.String}
     */
    public java.lang.String getPossessiveSuffix() { return content.getPossessiveSuffix(); }
     ...
     *     {@link java.lang.String}
     */
    public void setPossessiveSuffix(java.lang.String value) { content.setPossessiveSuffix(value); }
  ...
  ///-----------------------------------------------------------------------------------------------------------------------------------
	public String GetExceptionHtml()
	{
		...
		html += "<tr><td>צורה לא מנוקדת:</td>"
			+ "<td><input type='text' name=adverb_exception_undotted' size=20 value='"+getUndotted().trim()+"'></td></tr>"
			+ "<tr><td>צורת תעתיק:</td>"
			+ "<td>"+getTransliterated() + "</td></tr>"
			+ "<tr><td>צורה מנוקדת:</td>"
			+ "<td><input type='text' name='adverb_exception_dotted' size=20 value='"+getDotted().trim()+"'></td></tr>"
			+ "<tr><td>משלב:</td><td>"
