 ...
 *         Window - Preferences - Java - Code Style - Code Templates
 */
public class ModalExceptionType extends Content implements
	...
	public String GetExceptionHtml() {
		...
		html += "<tr><td>צורה לא מנוקדת:</td>"
				+ "<td><input type='text' name='modal_exception_undotted' size=20 value='"
		...
		html += "<tr><td>צורה מנוקדת:</td>"
				+ "<td><input type='text' name='modal_exception_dotted' size=20 value='"
		...
		html += "<tr><td>זמן:</td>"
				...
				+ "<option value='beinoni' " + modal_beinoni_sel
				+ ">בינוני</option>" + "<option value='future' "
				+ modal_future_sel + ">עתיד</option>"
				+ "<option value='imperative' " + modal_imperative_sel
				+ ">ציווי</option>" + "<option value='infinitive' "
				+ modal_infinitive_sel + ">שם הפועל</option>"
				+ "<option value='unspecified' '" + modal_unspecified_sel
