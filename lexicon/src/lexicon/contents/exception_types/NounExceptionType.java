 ...
 * <p>The following schema fragment specifies the expected content contained within this java content object. (defined at file:/C:/hebrew_lexicon.xsd line 342)
 * <p>
 * <pre>
...
///-----------------------------------------------------------------------------------------------------------------------------------
	public String GetExceptionHtml()
	{
		...
		html += "<tr><td>צורה לא מנוקדת:</td>"
			+ "<td><input type='text' name='noun_exception_undotted' size=20 value='"+getUndotted().trim()+"'></td></tr>";
		...
		html += "<tr><td>צורה מנוקדת:</td>"
			+ "<td><input type='text' name='noun_exception_dotted' size=20 value='"+getDotted().trim()+"'></td></tr>"
			+ "<tr><td>משלב:</td><td>"
		...
		html +="<tr><td>האם לייצר קניין לצורת היחיד?</td>" +
			...
			"<option value='0' "+isInflectPossessiveS_no_sel+">לא</option>" +
			"<option value='1' "+isInflectPossessiveS_yes_sel+">כן</option>" +
			"</select></td></tr>";
		...
		html +="<tr><td>האם לייצר קניין לצורת הרבים?</td>" +
			...
			"<option value='0' "+isInflectPossessiveP_no_sel+">לא</option>" +
			"<option value='1' "+isInflectPossessiveP_yes_sel+">כן</option>" +
			"</select></td></tr>";
