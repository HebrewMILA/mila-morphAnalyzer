 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class NumeralExceptionType extends Content implements lexicon.jaxb.NumeralExceptionType{
  ...
  ///-----------------------------------------------------------------------------------------------------------------------------------
	public String GetExceptionHtml()
	{
		...
		html += "<tr><td>צורה לא מנוקדת:</td>"
			+ "<td><input type='text' name='numeral_exception_undotted' size=20 value='"+getUndotted().trim()+"'></td></tr>";
		...
		html += "<tr><td>צורה מנוקדת:</td>"
			+ "<td><input type='text' name='numeral_exception_dotted' size=20 value='"+getDotted().trim()+"'></td></tr>"
			+ "<tr><td>משלב:</td><td>"
		...
		html +="<tr><td>מין:</td>"
            ...
            + "<option value='irrelevant' "+irrelevant_sel+">לא רלוונטי</option>"
		...
		html +="<tr><td>האם מקבל ה' הידיעה?</td>" +
			...
			"<option value='optional' "+(definteness.equals("optional")? "SELECTED" : "")+">מותר</option>" +
			"<option value='prohibited' "+(definteness.equals("prohibited")? "SELECTED" : "")+">אסור</option>" +
			"<option value='required' "+(definteness.equals("required")? "SELECTED" : "")+">חובה</option>" +
			"</select></td></tr>";
	...
	//  person Gender Number drop down
		...
		html +="<tr><td>האם צורת נסמך?</td>" +
			...
			"<option value='false' "+ (construct.equals("false") ? "SELECTED" : "")+">לא</option>" +
			"<option value='true' "+ (construct.equals("true") ? "SELECTED" : "")+">כן</option>" +
			"<option value='unspecified' "+ (construct.equals("unspecified") ? "SELECTED" : "")+">לא מוגדר</option>" +
			"</select></td></tr>";
		...
		html +="<tr><td>האם ניתן לבצע נטיית סמיכות?</td>" +
			...
			"<option value='1' "+isInflectConstruct_yes_sel+" >כן</option>" +
			"<option value='0' "+isInflectConstruct_no_sel+">לא</option>" +
			"</select></td></tr>";
