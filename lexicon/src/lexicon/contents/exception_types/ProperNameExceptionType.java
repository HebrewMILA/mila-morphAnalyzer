 ...
 *         Window - Preferences - Java - Code Style - Code Templates
 */
public class ProperNameExceptionType extends Content implements
		lexicon.jaxb.ProperNameExceptionType {
	...
	public String GetExceptionHtml() {
		...
		html += "<tr><td>צורה לא מנוקדת:</td>"
				+ "<td><input type='text' name='properName_exception_undotted' size=20 value='"
		...
		html += "<tr><td>צורה מנוקדת:</td>"
				+ "<td><input type='text' name='properName_exception_dotted' size=20 value='"
		...
		html += "<tr><td>סוג:</td>"
				...
				+ "<option value='symbol' "
				+ type_symbol_sel
				+ ">שם של אות או תו</option>"
				+ "<!--option value='coin' "
				+ type_coin_sel
				+ ">שם של מטבע</option-->"
				+ "<option value='organization' "
				+ type_organization_sel
				+ ">שם של ארגון</option>"
				...
				+ "<option value='other' "
				+ type_other_sel
				+ ">אף אחד מהאפשרויות שלעיל</option>"
				+ "<option value='unspecified' "
				+ type_unspecified_sel
				+ ">הקטגוריה אינה ידועה</option>" + "</select></td></tr>";
		...
		html += "<tr><td>האם מקבל ה' הידיעה?</td>"
				...
				+ "<option value='optional' " + definiteness_optional_sel
				+ ">מותר</option>" + "<option value='prohibited' "
				+ definiteness_prohibited_sel + ">אסור</option>"
				+ "<option value='required' " + definiteness_required_sel
		...
		html += "<tr><td>האם מכיל ה' המגמה?</td>"
				...
				+ "<option value='unspecified' " + direction_unspecified_sel
				+ ">לא מוגדר</option>" + "<option value='true' "
				+ direction_true_sel + ">כן</option>"
				+ "<option value='false' " + direction_false_sel
				+ ">לא</option>" + "</select></td></tr>";
		return html;
	}
}
