...
public class AdjectiveExceptionType extends Content implements lexicon.jaxb.NounExceptionType{
...
//		int feedback = execute(sql);
	...
	*/
     ...
     *     {@link java.lang.String}
     */
    public java.lang.String getPossessive() { return content.getPossessive(); }
     ...
     *     {@link java.lang.String}
     */
    public void setPossessive(java.lang.String value) { content.setPossessive(value); }
     ...
     *     {@link java.lang.String}
     */
    public java.lang.String getPlural() { return content.getPlural(); }
     ...
     *     {@link java.lang.String}
     */
    public void setPlural(java.lang.String value) { content.setPlural(value); }
     ...
     *     {@link java.lang.String}
     */
    public java.lang.String getDual() { return content.getDual(); }
     ...
     *     {@link java.lang.String}
     */
    public void setDual(java.lang.String value) { content.setDual(value); }
    ...
    public boolean isInflectPossessiveS() { return content.isInflectPossessiveS(); }

    /**
     * Sets the value of the inflectConstruct property.
     * 
     */
    public void setInflectPossessiveS(boolean value) { content.setInflectPossessiveS(value); }
    ...
    public boolean isInflectPossessiveP() { return content.isInflectPossessiveP(); }

    /**
     * Sets the value of the inflectConstruct property.
     * 
     */
    public void setInflectPossessiveP(boolean value) { content.setInflectPossessiveP(value); }
  ...
  ///-----------------------------------------------------------------------------------------------------------------------------------
	public String GetExceptionHtml()
	{
		...
		html += "<tr><td>צורה לא מנוקדת:</td>"
			+ "<td><input type='text' name='adjective_exception_undotted' size=20 value='"+getUndotted().trim()+"'></td></tr>";
		...
		html += "<tr><td>צורה מנוקדת:</td>"
			+ "<td><input type='text' name='adjective_exception_dotted' size=20 value='"+getDotted().trim()+"'></td></tr>"
			+ "<tr><td>משלב:</td><td>"
		...
		html +="<tr><td>צורן נקבה:</td>" +
			...
			"<option value='unspecified' "+feminine_unspecified_sel+">לא מוגדר</option>" +
			"</select></td></tr>";
		...
		html +="<tr><td>צורן ריבוי:</td>" +
			...
			"<option value='m' "+plural_m_sel+">ם</option>" +
			"<option value='im' "+plural_im_sel+">ים</option>" +
			"<option value='iim' "+plural_iim_sel+">יים</option>" +
			"<option value='wt' "+plural_wt_sel+" >ות</option>" +
			"<option value='awt' "+plural_awt_sel+">אות</option>" +
			"<option value='iwt' "+plural_iwt_sel+">יות</option>" +
			"<option value='im and wt' "+plural_imandwt_sel+">ים וגם ות</option>" +
			"<option value='unspecified' "+plural_unspecified_sel+">לא מוגדר</option>" +
			"</select></td></tr>";
		...
		html +="<tr><td>האם צורת זוגי?</td>" +
			...
			"<option value='unspecified' "+dual_unspecified_sel+">לא מוגדר</option>" +
			"<option value='true' "+dual_true_sel+">כן</option>" +
			"<option value='false' "+dual_false_sel+">לא</option>" +
			"</select></td></tr>";
		...
		html +="<tr><td>האם צורת נסמך?</td>" +
			...
			"<option value='false' "+construct_false_sell+">לא</option>" +
			"<option value='true' "+construct_true_sell+">כן</option>" +
			"<option value='unspecified' "+construct_unspecified_sell+">לא מוגדר</option>" +
			"</select></td></tr>";
		...
		html +="<tr><td>האם לייצר הטיית נסמך ליחיד?</td>" +
			...
			"<option value='1' "+isInflectConstructS_yes_sel+" >כן</option>" +
			"<option value='0' "+isInflectConstructS_no_sel+">לא</option>" +
			"</select></td></tr>";
		...
		html +="<tr><td>האם לייצר הטיית נסמך לרבים?</td>" +
			...
			"<option value='1' "+isInflectConstructP_yes_sel+" >כן</option>" +
			"<option value='0' "+isInflectConstructP_no_sel+">לא</option>" +
			"</select></td></tr>";
