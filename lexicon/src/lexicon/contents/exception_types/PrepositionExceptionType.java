 ...
 * <p>The following schema fragment specifies the expected content contained within this java content object. (defined at file:/C:/hebrew_lexicon.xsd line 958)
 * <p>
 * <pre>
 ...
 * 
 */
public class PrepositionExceptionType   extends Content implements lexicon.jaxb.PrepositionExceptionType{
	protected lexicon.jaxb.PrepositionExceptionType content; 
	
	public PrepositionExceptionType(lexicon.jaxb.PrepositionExceptionType content) {
  ...
  ///-----------------------------------------------------------------------------------------------------------------------------------
	public String GetExceptionHtml()
	{
		...
		html += "<tr><td>צורה לא מנוקדת:</td>"
			+ "<td><input type='text' name='preposition_exception_undotted' size=20 value='"+getUndotted().trim()+"'></td></tr>";
		...
		html += "<tr><td>צורה מנוקדת:</td>"
			+ "<td><input type='text' name='preposition_exception_dotted' size=20 value='"+getDotted().trim()+"'></td></tr>"
			+ "<tr><td>משלב:</td><td>"
