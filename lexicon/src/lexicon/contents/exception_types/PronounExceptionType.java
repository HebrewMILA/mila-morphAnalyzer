 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class PronounExceptionType extends Content implements lexicon.jaxb.PronounExceptionType{
	...
	*/
	...
	public String GetExceptionHtml()
	{
		...
		html += "<tr><td>צורה לא מנוקדת:</td>"
			+ "<td><input type='text' name='pronoun_exception_undotted' size=20 value='"+getUndotted().trim()+"'></td></tr>";
		...
		html += "<tr><td>צורה מנוקדת:</td>"
			+ "<td><input type='text' name='pronoun_exception_dotted' size=20 value='"+getDotted().trim()+"'></td></tr>"
			+ "<tr><td>משלב:</td><td>"
