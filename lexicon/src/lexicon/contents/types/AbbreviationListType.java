...
public class AbbreviationListType extends Connected{
	...
	List<Integer> id_list = new ArrayList<Integer>(); // defines a growable array for the list of abbreviation
...
//--------------------------------------------------------------------------------------------------------
	...
	public void setId(int _id) 
	{
		...
		if (id >= 0)
		{
				...
				while (rs.next())  
					{
						...
						System.out.println("Adding list item with id = " + curr_id);
			...
			/*for (int id : id_list)
			{
			    abbreviation.Load(id);   // loads an abbreviation
			    htmlLinkList += "<a>"+abbreviation.GetSurface()+"</a><br/>";
			}*/	
		}
	}
	//--------------------------------------------------------------------------------------------------------
