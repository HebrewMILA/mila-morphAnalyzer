...
public class AbbreviationType extends Connected {
	...
	public int Add() {
		...
		{
			System.out
					.println("Adding Abbreviation failed - there is no item id");
			return -1;
		}
		String query = "INSERT into abbreviation VALUES (null," + item_id
				+ ",'" + surface + "','" + definiteness + "')";
	...
	// -----------------------------------------------------------------------------------------------------
	public void setDefinitenessDual() { // both internal and external
		definiteness = "dual";
	}
