...
public class User extends Content {
	...
	*/
	...
	/**
	 * A login method that validates that a user exsist in the system and has a matching password.
	 * If the user has the password, the method opens the user's record.
	 * @param		tryUsername - The username of the user.
	 * @param		tryPassword - The password of the user.
	...
	/**
	 * A login method that validates that a user exsist in the system and has a matching password.
	 * If the user has the password, the method does not open the user's record.
	 * @param		tryUsername - The username of the user.
	 * @param		tryPassword - The password of the user.
	 * @return	    The id of the user, or 0 if the validation wasn't succesfull.
	 * @see validateAndOpen
	 * @version 1.2 validation has 2 options, only to validate or to validate and open the User
	 * @auther spektory
	 */
