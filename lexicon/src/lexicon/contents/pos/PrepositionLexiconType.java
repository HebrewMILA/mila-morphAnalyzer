 ...
 * 
 */
public class PrepositionLexiconType extends Content implements
		lexicon.jaxb.PrepositionLexiconType {
	...
	public int addActions(int id) {
		...
		for (int i = 0; i < getAddOrReplaceOrRemove().size(); i++) {
			PrepositionExceptionType exceptionType = new PrepositionExceptionType(
					(lexicon.jaxb.PrepositionExceptionType) getAddOrReplaceOrRemove()
							.get(i));
			exceptionType
	 ...
	 * 
	 */
	public class Add extends PrepositionExceptionType implements
	 ...
	 * 
	 */
	public class Remove extends PrepositionExceptionType implements
	 ...
	 * 
	 */
	public class Replace extends PrepositionExceptionType implements
