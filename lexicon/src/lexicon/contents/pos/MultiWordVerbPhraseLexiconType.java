...
public class MultiWordVerbPhraseLexiconType extends Content implements lexicon.jaxb.MultiWordVerbPhraseLexiconType
{
	lexicon.jaxb.MultiWordVerbPhraseLexiconType content;
	
	public MultiWordVerbPhraseLexiconType(lexicon.jaxb.MultiWordVerbPhraseLexiconType content) 
	{
	...
	*/
	...
	protected int addActions(int id) 
	{
		...
		for (int i=0; i< getAddOrReplaceOrRemove().size(); i++) {
			MultiWordVerbPhraseExceptionType exceptionType = new MultiWordVerbPhraseExceptionType((lexicon.jaxb.MultiWordVerbPhraseExceptionType)getAddOrReplaceOrRemove().get(i));
	...
	{
		return removeContents("multiWordVerbPhrase_exception_type", "id", "aid", id); 
	}
	...
	{
		List actions = getContents("multiWordVerbPhrase_exception_type", "id", id);
    ...
    public class Add extends MultiWordVerbPhraseExceptionType implements lexicon.jaxb.MultiWordVerbPhraseLexiconType.Add
    {
    	public Add() 
    	{
    		super ();
     ...
     * 
     */
    public class Remove extends MultiWordVerbPhraseExceptionType implements lexicon.jaxb.MultiWordVerbPhraseLexiconType.Remove 
    {
     ...
     * 
     */
    public class Replace extends MultiWordVerbPhraseExceptionType implements lexicon.jaxb.MultiWordVerbPhraseLexiconType.Replace 
    {
