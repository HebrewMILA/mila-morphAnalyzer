 ...
 *         Window - Preferences - Java - Code Style - Code Templates
 */
public class WprefixLexiconType extends Content implements
		lexicon.jaxb.WprefixLexiconType {
	...
	protected int addActions(int id) {
		...
		for (int i = 0; i < getAddOrReplaceOrRemove().size(); i++) {
			WprefixExceptionType exceptionType = new WprefixExceptionType(
					(lexicon.jaxb.WprefixExceptionType) getAddOrReplaceOrRemove()
							.get(i));
			exceptionType
	...
	public class Add extends WprefixExceptionType implements
			lexicon.jaxb.WprefixLexiconType.Add {
	...
	public class Remove extends WprefixExceptionType implements
			lexicon.jaxb.WprefixLexiconType.Remove {
	...
	public class Replace extends WprefixExceptionType implements
			lexicon.jaxb.WprefixLexiconType.Replace {
