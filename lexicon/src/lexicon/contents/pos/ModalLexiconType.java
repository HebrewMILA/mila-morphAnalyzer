 ...
 * 
 */
public class ModalLexiconType extends Content implements
		lexicon.jaxb.ModalLexiconType {
	...
	protected int addActions(int id) {
		...
		for (int i = 0; i < getAddOrReplaceOrRemove().size(); i++) {
			ModalExceptionType exceptionType = new ModalExceptionType(
					(lexicon.jaxb.ModalExceptionType) getAddOrReplaceOrRemove()
							.get(i));
			exceptionType
	...
	public class Add extends ModalExceptionType implements
			lexicon.jaxb.ModalLexiconType.Add {
	...
	public class Remove extends ModalExceptionType implements
			lexicon.jaxb.ModalLexiconType.Remove {
	...
	public class Replace extends ModalExceptionType implements
			lexicon.jaxb.ModalLexiconType.Replace {
