 ...
 *         Window - Preferences - Java - Code Style - Code Templates
 */
public class CopulaLexiconType extends Content implements
		lexicon.jaxb.CopulaLexiconType {
	...
	protected int addActions(int id) {
		...
		for (int i = 0; i < getAddOrReplaceOrRemove().size(); i++) {
			CopulaExceptionType exceptionType = new CopulaExceptionType(
					(lexicon.jaxb.CopulaExceptionType) getAddOrReplaceOrRemove()
							.get(i));
			exceptionType
	...
	public class Add extends CopulaExceptionType implements
			lexicon.jaxb.CopulaLexiconType.Add {
		public Add() {
			super();
	...
	public class Remove extends CopulaExceptionType implements
			lexicon.jaxb.CopulaLexiconType.Remove {
	...
	public class Replace extends CopulaExceptionType implements
			lexicon.jaxb.CopulaLexiconType.Replace {
