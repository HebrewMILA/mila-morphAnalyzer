 ...
 * this java content object. (defined at file:/C:/hebrew_lexicon.xsd line 976)
 * <p>
 * 
 * <pre>
 ...
 * 
 */
public class InterrogativeLexiconType extends Content implements
		lexicon.jaxb.InterrogativeLexiconType {
	...
	protected int addActions(int id) {
		...
		for (int i = 0; i < getAddOrReplaceOrRemove().size(); i++) {
			InterrogativeExceptionType exceptionType = new InterrogativeExceptionType(
					(lexicon.jaxb.InterrogativeExceptionType) getAddOrReplaceOrRemove()
							.get(i));
			exceptionType
	 ...
	 * 
	 */
	public class Add extends InterrogativeExceptionType implements
	 ...
	 * 
	 */
	public class Remove extends InterrogativeExceptionType implements
	 ...
	 * 
	 */
	public class Replace extends InterrogativeExceptionType implements
