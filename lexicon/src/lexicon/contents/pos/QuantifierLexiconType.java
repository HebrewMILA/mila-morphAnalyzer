 ...
 *       &lt;attribute name="type" type="{}QuantifierType" default="unspecified" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
 * 
 */
public class QuantifierLexiconType extends Content implements
		lexicon.jaxb.QuantifierLexiconType {
	...
	protected int addActions(int id) {
		...
		for (int i = 0; i < getAddOrReplaceOrRemove().size(); i++) {
			QuantifierExceptionType exceptionType = new QuantifierExceptionType(
					(lexicon.jaxb.QuantifierExceptionType) getAddOrReplaceOrRemove()
							.get(i));
			exceptionType
	 ...
	 * 
	 */
	public class Add extends QuantifierExceptionType implements
			lexicon.jaxb.QuantifierLexiconType.Add {
		public Add() {
			super();
	 ...
	 * 
	 */
	public class Remove extends QuantifierExceptionType implements
	 ...
	 * 
	 */
	public class Replace extends QuantifierExceptionType implements
