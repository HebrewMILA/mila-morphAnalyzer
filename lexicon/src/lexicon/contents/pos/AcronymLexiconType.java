 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class AcronymLexiconType extends Content implements lexicon.jaxb.AcronymLexiconType{
	...
	*/
	...
	protected int addActions(int id) {
		...
		for (int i=0; i< getAddOrReplaceOrRemove().size(); i++) {
			AcronymExceptionType exceptionType = new AcronymExceptionType((lexicon.jaxb.impl.AcronymExceptionTypeImpl)getAddOrReplaceOrRemove().get(i));
     ...
     *     {@link java.lang.String}
     */
    public void setMeaning(java.lang.String value) { content.setMeaning(value); }
	...
	public java.lang.String getNiqLexicalLink() { return content.getNiqLexicalLink(); }
	public void setNiqLexicalLink(java.lang.String value) { content.setNiqLexicalLink(value); }
	
	public java.lang.String getIstLexicalLink() { return content.getIstLexicalLink(); }
	public void setIstLexicalLink(java.lang.String value) { content.setIstLexicalLink(value); }
	
	public java.lang.String getAdjectiveLexicalLink() { return content.getAdjectiveLexicalLink(); }
	public void setAdjectiveLexicalLink(java.lang.String value) { content.setAdjectiveLexicalLink(value); }
...
public java.util.List getAddOrReplaceOrRemove() {
 ...
 public class Add extends AcronymExceptionType implements lexicon.jaxb.AcronymLexiconType.Add{
 ...
 public class Remove extends AcronymExceptionType implements lexicon.jaxb.AcronymLexiconType.Remove  {
 ...
 public class Replace extends AcronymExceptionType implements lexicon.jaxb.AcronymLexiconType.Replace {
