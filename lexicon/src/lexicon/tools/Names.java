...
public class Names {
	...
	private static void initPos() {
		...
		pos.put("verb", "פועל");
		pos.put("existential", "כמת ישיי");
		pos.put("impersonal", "חסר גוף ומשקל");
		pos.put("wPrefix", "תחילית");
		pos.put("modal", "מודאל");
		pos.put("copula", "אוגד");
		pos.put("numeral", "שם מספר");
		pos.put("title", "תואר");
		pos.put("acronym", "ראשי תיבות");
		pos.put("multiWordFrozen", "ביטוי קפוא");
		pos.put("multiWordPreposition", "ביטוי נוטה");
		pos.put("multiWordNoun", "ביטוי נסמך סומך");
		pos.put("multiWordNounAdjective", "צרוף שם ותוארו");
		pos.put("multiWordVerbPhrase", "ביטוי פועלי");
	}
