...
public class CaptchasDotNet {
	final static String ALPHABET_RECOMMENDED = "abcdefghkmnopqrstuvwxyz";
	// Default-Values from image and audio implementation
	final static String ALPHABET_DEFAULT = "abcdefghijklmnopqrstuvwxyz";
	final static int LETTERS_DEFAULT = 6;
	final static int WIDTH_DEFAULT = 240;
	final static int HEIGHT_DEFAULT = 80;
	...
	// Session handling
	private final HttpSession httpSess;
	// The current random
	...
	public String imageUrl() {
		...
		if (captchaRandom.equals("") || captchaRandom.equals("used")) {
	 ...
	 */
	public String image() {
		return "<a href=\"http://captchas.net\"><img style=\"border: none; vertical-align: bottom\" "
				+ "id=\"captchas.net\" src=\""
				+ imageUrl()
				+ "\" "
				+ "width=\""
